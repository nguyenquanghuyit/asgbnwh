...
$id=$_REQUEST["id"];
$str="SELECT a.TruckNo,a.DriverName,DATE_FORMAT(a.CreateDate,'%Y-%m-%d') as DateOut FROM vwrouteout a WHERE a.ID_Route=".$id;
...
<![endif]-->
<style id="BBBGFOXCONN_16942_Styles"><!--table
...
<table border=0 cellpadding=0 cellspacing=0 width=663 class=xl6816942
 style='border-collapse:collapse;table-layout:fixed;width:499pt'>
 <col class=xl6816942 width=57 style='mso-width-source:userset;mso-width-alt:
 2084;width:43pt'>
 <col class=xl6816942 width=100 style='mso-width-source:userset;mso-width-alt:
 3657;width:75pt'>
 <col class=xl6816942 width=85 span=4 style='mso-width-source:userset;
 mso-width-alt:3108;width:64pt'>
 <col class=xl6816942 width=166 style='mso-width-source:userset;mso-width-alt:
 6070;width:125pt'>
...
">
  ...
  <td class=xl6616942 width=100 style='width:75pt'></td>
  <td colspan=4 rowspan=3 class=xl9816942 width=340 style='width:256pt'>BIÊN
  B&#7842;N BÀN GIAO<br>
    HÀNG XU&#7844;T FOXCONN</td>
  <td class=xl6716942 width=166 style='width:125pt'>BM.06.QT.PVHF</td>
 </tr>
 ...
 <tr height=25 style='height:18.75pt'>
  <td height=25 class=xl6516942 style='height:18.75pt'></td>
  <td class=xl6616942></td>
  <td class=xl6916942 width=85 style='width:64pt'></td>
  <td class=xl6916942 width=85 style='width:64pt'></td>
  <td class=xl6916942 width=85 style='width:64pt'></td>
  <td class=xl6916942 width=85 style='width:64pt'></td>
 ...
 <tr height=21 style='height:15.75pt'>
  ...
  <td class=xl7116942>Mã biên b&#7843;n<span style='display:none'>:</span></td>
  <td class=xl7216942><?php 
  $strOrder="SELECT v.ID_Route FROM vwrouteout v WHERE DATE_FORMAT(v.CreateDate,'%Y-%m-%d') =DATE_FORMAT('".$DateOut."','%Y-%m-%d')";
  $tblOrder=mysqli_query($cnn,$strOrder);
  $soTT=1;
 ...
 <tr height=21 style='height:15.75pt'>
  ...
  <td class=xl7316942><input type="text" size="5" value="" placeholder="mm:ss" style="border: 0px"></td>
 ...
 <tr height=42 style='mso-height-source:userset;height:31.5pt'>
  ...
  <td class=xl8116942 width=100 style='border-left:none;width:75pt'>Code</td>
  <td class=xl8116942 width=85 style='border-left:none;width:64pt'>Pallet</td>
  <td class=xl8116942 width=85 style='border-left:none;width:64pt'>Box</td>
  <td class=xl8116942 width=85 style='border-left:none;width:64pt'>Qty/box</td>
  <td class=xl8116942 width=85 style='border-left:none;width:64pt'>Total qty</td>
  <td class=xl8116942 width=166 style='border-left:none;width:125pt'>Ghi chú</td>
 </tr>
 <?php
	...
	$totalqty=0;
	$totalPl=0;
	//$n=mysqli_num_rows($dtCode);	
	for($stt=1;$stt<26;$stt++)
	{
		$rowCode=mysqli_fetch_assoc($dtCode);		
...
?>	
 <tr height=26 style='mso-height-source:userset;height:19.5pt'>
  ...
  <td class=xl8416942 style='border-left:none'><?php 
		...
		echo $myPackNo;
		?></td>
  <td class=xl8516942 style='border-left:none'><?php if(strlen($box)>0)
  { 
  echo number_format($box);
  }?></td>
  <td class=xl8516942 style='border-left:none'><?php echo $qty?></td>
  <td class=xl9916942 style='border-left:none'><span
  style='mso-spacerun:yes'>          </span><?php echo $PCS?> </td>
 ...
 <tr height=20 style='height:15.0pt'>
  <td colspan=2 height=20 class=xl9516942 style='height:15.0pt'>Nhân viên giao
  hàng ASGBN</td>
  <td class=xl9316942></td>
  <td class=xl9316942></td>
  <td class=xl9316942></td>
  <td colspan=2 class=xl9516942><span style='mso-spacerun:yes'>   </span>Nhân
