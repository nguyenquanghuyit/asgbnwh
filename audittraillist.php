...
faudittraillistsrch.validate = function(fobj) {
...
// Form_CustomValidate event
faudittraillistsrch.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
// Use JavaScript validation or not
faudittraillistsrch.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php
if ($SearchError == "")
	$audittrail_list->LoadAdvancedSearch(); // Load advanced search

// Render for search
$audittrail->RowType = ROWTYPE_SEARCH;
...
<?php if ($audittrail->datetime->Visible) { // datetime ?>
	<div id="xsc_datetime" class="ew-cell form-group">
		<label for="x_datetime" class="ew-search-caption ew-label"><?php echo $audittrail->datetime->caption() ?></label>
		<span class="ew-search-operator"><?php echo $Language->phrase("BETWEEN") ?><input type="hidden" name="z_datetime" id="z_datetime" value="BETWEEN"></span>
		<span class="ew-search-field">
<input type="text" data-table="audittrail" data-field="x_datetime" data-format="11" name="x_datetime" id="x_datetime" placeholder="<?php echo HtmlEncode($audittrail->datetime->getPlaceHolder()) ?>" value="<?php echo $audittrail->datetime->EditValue ?>"<?php echo $audittrail->datetime->editAttributes() ?>>
...
<?php } ?>
		...
		<span class="ew-search-cond btw1_datetime"><label><?php echo $Language->Phrase("AND") ?></label></span>
		<span class="ew-search-field btw1_datetime">
<input type="text" data-table="audittrail" data-field="x_datetime" data-format="11" name="y_datetime" id="y_datetime" placeholder="<?php echo HtmlEncode($audittrail->datetime->getPlaceHolder()) ?>" value="<?php echo $audittrail->datetime->EditValue2 ?>"<?php echo $audittrail->datetime->editAttributes() ?>>
<?php if (!$audittrail->datetime->ReadOnly && !$audittrail->datetime->Disabled && !isset($audittrail->datetime->EditAttrs["readonly"]) && !isset($audittrail->datetime->EditAttrs["disabled"])) { ?>
<script>
...
<?php if ($audittrail->id->Visible) { // id ?>
	<?php if ($audittrail->sortUrl($audittrail->id) == "") { ?>
		<th data-name="id" class="<?php echo $audittrail->id->headerCellClass() ?>" style="white-space: nowrap;"><div id="elh_audittrail_id" class="audittrail_id"><div class="ew-table-header-caption"><?php echo $audittrail->id->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="id" class="<?php echo $audittrail->id->headerCellClass() ?>" style="white-space: nowrap;"><div class="ew-pointer" onclick="ew.sort(event,'<?php echo $audittrail->SortUrl($audittrail->id) ?>',2);"><div id="elh_audittrail_id" class="audittrail_id">
...
<?php if ($audittrail->datetime->Visible) { // datetime ?>
	<?php if ($audittrail->sortUrl($audittrail->datetime) == "") { ?>
		<th data-name="datetime" class="<?php echo $audittrail->datetime->headerCellClass() ?>" style="white-space: nowrap;"><div id="elh_audittrail_datetime" class="audittrail_datetime"><div class="ew-table-header-caption"><?php echo $audittrail->datetime->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="datetime" class="<?php echo $audittrail->datetime->headerCellClass() ?>" style="white-space: nowrap;"><div class="ew-pointer" onclick="ew.sort(event,'<?php echo $audittrail->SortUrl($audittrail->datetime) ?>',2);"><div id="elh_audittrail_datetime" class="audittrail_datetime">
...
<?php if ($audittrail->script->Visible) { // script ?>
	<?php if ($audittrail->sortUrl($audittrail->script) == "") { ?>
		<th data-name="script" class="<?php echo $audittrail->script->headerCellClass() ?>" style="white-space: nowrap;"><div id="elh_audittrail_script" class="audittrail_script"><div class="ew-table-header-caption"><?php echo $audittrail->script->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="script" class="<?php echo $audittrail->script->headerCellClass() ?>" style="white-space: nowrap;"><div class="ew-pointer" onclick="ew.sort(event,'<?php echo $audittrail->SortUrl($audittrail->script) ?>',2);"><div id="elh_audittrail_script" class="audittrail_script">
...
<?php if ($audittrail->user->Visible) { // user ?>
	<?php if ($audittrail->sortUrl($audittrail->user) == "") { ?>
		<th data-name="user" class="<?php echo $audittrail->user->headerCellClass() ?>" style="white-space: nowrap;"><div id="elh_audittrail_user" class="audittrail_user"><div class="ew-table-header-caption"><?php echo $audittrail->user->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="user" class="<?php echo $audittrail->user->headerCellClass() ?>" style="white-space: nowrap;"><div class="ew-pointer" onclick="ew.sort(event,'<?php echo $audittrail->SortUrl($audittrail->user) ?>',2);"><div id="elh_audittrail_user" class="audittrail_user">
...
<?php if ($audittrail->_action->Visible) { // action ?>
	<?php if ($audittrail->sortUrl($audittrail->_action) == "") { ?>
		<th data-name="_action" class="<?php echo $audittrail->_action->headerCellClass() ?>" style="white-space: nowrap;"><div id="elh_audittrail__action" class="audittrail__action"><div class="ew-table-header-caption"><?php echo $audittrail->_action->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="_action" class="<?php echo $audittrail->_action->headerCellClass() ?>" style="white-space: nowrap;"><div class="ew-pointer" onclick="ew.sort(event,'<?php echo $audittrail->SortUrl($audittrail->_action) ?>',2);"><div id="elh_audittrail__action" class="audittrail__action">
...
<?php if ($audittrail->_table->Visible) { // table ?>
	<?php if ($audittrail->sortUrl($audittrail->_table) == "") { ?>
		<th data-name="_table" class="<?php echo $audittrail->_table->headerCellClass() ?>" style="white-space: nowrap;"><div id="elh_audittrail__table" class="audittrail__table"><div class="ew-table-header-caption"><?php echo $audittrail->_table->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="_table" class="<?php echo $audittrail->_table->headerCellClass() ?>" style="white-space: nowrap;"><div class="ew-pointer" onclick="ew.sort(event,'<?php echo $audittrail->SortUrl($audittrail->_table) ?>',2);"><div id="elh_audittrail__table" class="audittrail__table">
...
<?php if ($audittrail->field->Visible) { // field ?>
	<?php if ($audittrail->sortUrl($audittrail->field) == "") { ?>
		<th data-name="field" class="<?php echo $audittrail->field->headerCellClass() ?>" style="white-space: nowrap;"><div id="elh_audittrail_field" class="audittrail_field"><div class="ew-table-header-caption"><?php echo $audittrail->field->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="field" class="<?php echo $audittrail->field->headerCellClass() ?>" style="white-space: nowrap;"><div class="ew-pointer" onclick="ew.sort(event,'<?php echo $audittrail->SortUrl($audittrail->field) ?>',2);"><div id="elh_audittrail_field" class="audittrail_field">
