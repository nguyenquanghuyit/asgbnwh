...
class audittrail extends DbTable
{
	...
	public function __construct()
	{
		...
		// datetime
		$this->datetime = new DbField('audittrail', 'audittrail', 'x_datetime', 'datetime', '`datetime`', CastDateFieldForLike('`datetime`', 11, "DB"), 135, 11, FALSE, '`datetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// action
		$this->_action = new DbField('audittrail', 'audittrail', 'x__action', 'action', '`action`', '`action`', 200, -1, FALSE, '`action`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlOrderBy <> "") ? $this->SqlOrderBy : "`datetime` DESC,`action` ASC";
	}
	...
	public function renderEditRow()
	{
		...
		$this->datetime->EditValue = FormatDateTime($this->datetime->CurrentValue, 11);
