...
/**
 * Table class for foxconninventory
 */
class foxconninventory extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'foxconninventory';
		$this->TableName = 'foxconninventory';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`foxconninventory`";
		$this->Dbid = 'DB';
		...
		// Code
		$this->Code = new DbField('foxconninventory', 'foxconninventory', 'x_Code', 'Code', '`Code`', '`Code`', 200, -1, FALSE, '`Code`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ProductName
		$this->ProductName = new DbField('foxconninventory', 'foxconninventory', 'x_ProductName', 'ProductName', '`ProductName`', '`ProductName`', 200, -1, FALSE, '`ProductName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ProductName->Sortable = TRUE; // Allow sort
		$this->fields['ProductName'] = &$this->ProductName;

		// VnName
		$this->VnName = new DbField('foxconninventory', 'foxconninventory', 'x_VnName', 'VnName', '`VnName`', '`VnName`', 200, -1, FALSE, '`VnName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->VnName->Sortable = TRUE; // Allow sort
		$this->fields['VnName'] = &$this->VnName;

		// Model
		$this->Model = new DbField('foxconninventory', 'foxconninventory', 'x_Model', 'Model', '`Model`', '`Model`', 200, -1, FALSE, '`Model`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Model->Sortable = TRUE; // Allow sort
		$this->fields['Model'] = &$this->Model;

		// PCS_IN
		$this->PCS_IN = new DbField('foxconninventory', 'foxconninventory', 'x_PCS_IN', 'PCS_IN', '`PCS_IN`', '`PCS_IN`', 131, -1, FALSE, '`PCS_IN`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PCS_OUT
		$this->PCS_OUT = new DbField('foxconninventory', 'foxconninventory', 'x_PCS_OUT', 'PCS_OUT', '`PCS_OUT`', '`PCS_OUT`', 131, -1, FALSE, '`PCS_OUT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PCS
		$this->PCS = new DbField('foxconninventory', 'foxconninventory', 'x_PCS', 'PCS', '`PCS`', '`PCS`', 131, -1, FALSE, '`PCS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`foxconninventory`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "foxconninventorylist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "foxconninventoryview.php")
			return $Language->phrase("View");
		elseif ($pageName == "foxconninventoryedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "foxconninventoryadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("foxconninventoryview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("foxconninventoryview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "foxconninventoryadd.php?" . $this->getUrlParm($parm);
		else
			$url = "foxconninventoryadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("foxconninventoryedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("foxconninventoryadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("foxconninventorydelete.php", $this->getUrlParm());
	}
