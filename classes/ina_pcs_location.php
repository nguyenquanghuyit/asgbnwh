...
/**
 * Table class for ina_pcs_location
 */
class ina_pcs_location extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'ina_pcs_location';
		$this->TableName = 'ina_pcs_location';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`ina_pcs_location`";
		$this->Dbid = 'DB';
		...
		// Location
		$this->Location = new DbField('ina_pcs_location', 'ina_pcs_location', 'x_Location', 'Location', '`Location`', '`Location`', 200, -1, FALSE, '`Location`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Location->Sortable = TRUE; // Allow sort
		$this->fields['Location'] = &$this->Location;

		// Code
		$this->Code = new DbField('ina_pcs_location', 'ina_pcs_location', 'x_Code', 'Code', '`Code`', '`Code`', 200, -1, FALSE, '`Code`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Code->Sortable = TRUE; // Allow sort
		$this->fields['Code'] = &$this->Code;

		// ProductName
		$this->ProductName = new DbField('ina_pcs_location', 'ina_pcs_location', 'x_ProductName', 'ProductName', '`ProductName`', '`ProductName`', 200, -1, FALSE, '`ProductName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ProductName->Sortable = TRUE; // Allow sort
		$this->fields['ProductName'] = &$this->ProductName;

		// Model
		$this->Model = new DbField('ina_pcs_location', 'ina_pcs_location', 'x_Model', 'Model', '`Model`', '`Model`', 200, -1, FALSE, '`Model`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Model->Sortable = TRUE; // Allow sort
		$this->fields['Model'] = &$this->Model;

		// PCS
		$this->PCS = new DbField('ina_pcs_location', 'ina_pcs_location', 'x_PCS', 'PCS', '`PCS`', '`PCS`', 131, -1, FALSE, '`PCS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`ina_pcs_location`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "ina_pcs_locationlist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "ina_pcs_locationview.php")
			return $Language->phrase("View");
		elseif ($pageName == "ina_pcs_locationedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "ina_pcs_locationadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("ina_pcs_locationview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("ina_pcs_locationview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "ina_pcs_locationadd.php?" . $this->getUrlParm($parm);
		else
			$url = "ina_pcs_locationadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("ina_pcs_locationedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("ina_pcs_locationadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("ina_pcs_locationdelete.php", $this->getUrlParm());
	}
