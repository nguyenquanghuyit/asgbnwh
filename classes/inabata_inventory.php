...
/**
 * Table class for inabata_inventory
 */
class inabata_inventory extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'inabata_inventory';
		$this->TableName = 'inabata_inventory';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`inabata_inventory`";
		$this->Dbid = 'DB';
		...
		// Code
		$this->Code = new DbField('inabata_inventory', 'inabata_inventory', 'x_Code', 'Code', '`Code`', '`Code`', 200, -1, FALSE, '`Code`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ProductName
		$this->ProductName = new DbField('inabata_inventory', 'inabata_inventory', 'x_ProductName', 'ProductName', '`ProductName`', '`ProductName`', 200, -1, FALSE, '`ProductName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ProductName->Sortable = TRUE; // Allow sort
		$this->fields['ProductName'] = &$this->ProductName;

		// VnName
		$this->VnName = new DbField('inabata_inventory', 'inabata_inventory', 'x_VnName', 'VnName', '`VnName`', '`VnName`', 200, -1, FALSE, '`VnName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->VnName->Sortable = TRUE; // Allow sort
		$this->fields['VnName'] = &$this->VnName;

		// Model
		$this->Model = new DbField('inabata_inventory', 'inabata_inventory', 'x_Model', 'Model', '`Model`', '`Model`', 200, -1, FALSE, '`Model`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Model->Sortable = TRUE; // Allow sort
		$this->fields['Model'] = &$this->Model;

		// PCS_IN
		$this->PCS_IN = new DbField('inabata_inventory', 'inabata_inventory', 'x_PCS_IN', 'PCS_IN', '`PCS_IN`', '`PCS_IN`', 131, -1, FALSE, '`PCS_IN`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PCS_OUT
		$this->PCS_OUT = new DbField('inabata_inventory', 'inabata_inventory', 'x_PCS_OUT', 'PCS_OUT', '`PCS_OUT`', '`PCS_OUT`', 131, -1, FALSE, '`PCS_OUT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PCS
		$this->PCS = new DbField('inabata_inventory', 'inabata_inventory', 'x_PCS', 'PCS', '`PCS`', '`PCS`', 131, -1, FALSE, '`PCS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`inabata_inventory`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "inabata_inventorylist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "inabata_inventoryview.php")
			return $Language->phrase("View");
		elseif ($pageName == "inabata_inventoryedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "inabata_inventoryadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("inabata_inventoryview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("inabata_inventoryview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "inabata_inventoryadd.php?" . $this->getUrlParm($parm);
		else
			$url = "inabata_inventoryadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("inabata_inventoryedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("inabata_inventoryadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("inabata_inventorydelete.php", $this->getUrlParm());
	}
