...
/**
 * Table class for mitsu_pcs_location
 */
class mitsu_pcs_location extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'mitsu_pcs_location';
		$this->TableName = 'mitsu_pcs_location';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`mitsu_pcs_location`";
		$this->Dbid = 'DB';
		...
		// Location
		$this->Location = new DbField('mitsu_pcs_location', 'mitsu_pcs_location', 'x_Location', 'Location', '`Location`', '`Location`', 200, -1, FALSE, '`Location`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Location->Sortable = TRUE; // Allow sort
		$this->fields['Location'] = &$this->Location;

		// Code
		$this->Code = new DbField('mitsu_pcs_location', 'mitsu_pcs_location', 'x_Code', 'Code', '`Code`', '`Code`', 200, -1, FALSE, '`Code`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Code->Sortable = TRUE; // Allow sort
		$this->fields['Code'] = &$this->Code;

		// ProductName
		$this->ProductName = new DbField('mitsu_pcs_location', 'mitsu_pcs_location', 'x_ProductName', 'ProductName', '`ProductName`', '`ProductName`', 200, -1, FALSE, '`ProductName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ProductName->Sortable = TRUE; // Allow sort
		$this->fields['ProductName'] = &$this->ProductName;

		// Model
		$this->Model = new DbField('mitsu_pcs_location', 'mitsu_pcs_location', 'x_Model', 'Model', '`Model`', '`Model`', 200, -1, FALSE, '`Model`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Model->Sortable = TRUE; // Allow sort
		$this->fields['Model'] = &$this->Model;

		// PCS
		$this->PCS = new DbField('mitsu_pcs_location', 'mitsu_pcs_location', 'x_PCS', 'PCS', '`PCS`', '`PCS`', 131, -1, FALSE, '`PCS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`mitsu_pcs_location`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "mitsu_pcs_locationlist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "mitsu_pcs_locationview.php")
			return $Language->phrase("View");
		elseif ($pageName == "mitsu_pcs_locationedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "mitsu_pcs_locationadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("mitsu_pcs_locationview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("mitsu_pcs_locationview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "mitsu_pcs_locationadd.php?" . $this->getUrlParm($parm);
		else
			$url = "mitsu_pcs_locationadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("mitsu_pcs_locationedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("mitsu_pcs_locationadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("mitsu_pcs_locationdelete.php", $this->getUrlParm());
	}
