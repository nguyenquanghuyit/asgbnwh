...
/**
 * Table class for mitsubishi_inventory
 */
class mitsubishi_inventory extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'mitsubishi_inventory';
		$this->TableName = 'mitsubishi_inventory';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`mitsubishi_inventory`";
		$this->Dbid = 'DB';
		...
		// Code
		$this->Code = new DbField('mitsubishi_inventory', 'mitsubishi_inventory', 'x_Code', 'Code', '`Code`', '`Code`', 200, -1, FALSE, '`Code`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ProductName
		$this->ProductName = new DbField('mitsubishi_inventory', 'mitsubishi_inventory', 'x_ProductName', 'ProductName', '`ProductName`', '`ProductName`', 200, -1, FALSE, '`ProductName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ProductName->Sortable = TRUE; // Allow sort
		$this->fields['ProductName'] = &$this->ProductName;

		// VnName
		$this->VnName = new DbField('mitsubishi_inventory', 'mitsubishi_inventory', 'x_VnName', 'VnName', '`VnName`', '`VnName`', 200, -1, FALSE, '`VnName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->VnName->Sortable = TRUE; // Allow sort
		$this->fields['VnName'] = &$this->VnName;

		// Model
		$this->Model = new DbField('mitsubishi_inventory', 'mitsubishi_inventory', 'x_Model', 'Model', '`Model`', '`Model`', 200, -1, FALSE, '`Model`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Model->Sortable = TRUE; // Allow sort
		$this->fields['Model'] = &$this->Model;

		// PCS_IN
		$this->PCS_IN = new DbField('mitsubishi_inventory', 'mitsubishi_inventory', 'x_PCS_IN', 'PCS_IN', '`PCS_IN`', '`PCS_IN`', 131, -1, FALSE, '`PCS_IN`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PCS_OUT
		$this->PCS_OUT = new DbField('mitsubishi_inventory', 'mitsubishi_inventory', 'x_PCS_OUT', 'PCS_OUT', '`PCS_OUT`', '`PCS_OUT`', 131, -1, FALSE, '`PCS_OUT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PCS
		$this->PCS = new DbField('mitsubishi_inventory', 'mitsubishi_inventory', 'x_PCS', 'PCS', '`PCS`', '`PCS`', 131, -1, FALSE, '`PCS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`mitsubishi_inventory`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "mitsubishi_inventorylist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "mitsubishi_inventoryview.php")
			return $Language->phrase("View");
		elseif ($pageName == "mitsubishi_inventoryedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "mitsubishi_inventoryadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("mitsubishi_inventoryview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("mitsubishi_inventoryview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "mitsubishi_inventoryadd.php?" . $this->getUrlParm($parm);
		else
			$url = "mitsubishi_inventoryadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("mitsubishi_inventoryedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("mitsubishi_inventoryadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("mitsubishi_inventorydelete.php", $this->getUrlParm());
	}
