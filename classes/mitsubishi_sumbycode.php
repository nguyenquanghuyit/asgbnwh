...
/**
 * Table class for mitsubishi_sumbycode
 */
class mitsubishi_sumbycode extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'mitsubishi_sumbycode';
		$this->TableName = 'mitsubishi_sumbycode';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`mitsubishi_sumbycode`";
		$this->Dbid = 'DB';
		...
		// Code
		$this->Code = new DbField('mitsubishi_sumbycode', 'mitsubishi_sumbycode', 'x_Code', 'Code', '`Code`', '`Code`', 200, -1, FALSE, '`Code`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Code->Sortable = TRUE; // Allow sort
		$this->fields['Code'] = &$this->Code;

		// ProductName
		$this->ProductName = new DbField('mitsubishi_sumbycode', 'mitsubishi_sumbycode', 'x_ProductName', 'ProductName', '`ProductName`', '`ProductName`', 200, -1, FALSE, '`ProductName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ProductName->Sortable = TRUE; // Allow sort
		$this->fields['ProductName'] = &$this->ProductName;

		// Model
		$this->Model = new DbField('mitsubishi_sumbycode', 'mitsubishi_sumbycode', 'x_Model', 'Model', '`Model`', '`Model`', 200, -1, FALSE, '`Model`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Model->Sortable = TRUE; // Allow sort
		$this->fields['Model'] = &$this->Model;

		// SUM(ts.PCS)
		$this->SUM28ts_PCS29 = new DbField('mitsubishi_sumbycode', 'mitsubishi_sumbycode', 'x_SUM28ts_PCS29', 'SUM(ts.PCS)', '`SUM(ts.PCS)`', '`SUM(ts.PCS)`', 131, -1, FALSE, '`SUM(ts.PCS)`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Pallet
		$this->Pallet = new DbField('mitsubishi_sumbycode', 'mitsubishi_sumbycode', 'x_Pallet', 'Pallet', '`Pallet`', '`Pallet`', 3, -1, FALSE, '`Pallet`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->Pallet->Lookup = new Lookup('Pallet', 'mitsubishi_sumbycode', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
		$this->Pallet->OptionCount = 2;
		$this->Pallet->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['Pallet'] = &$this->Pallet;

		// TypeName
		$this->TypeName = new DbField('mitsubishi_sumbycode', 'mitsubishi_sumbycode', 'x_TypeName', 'TypeName', '`TypeName`', '`TypeName`', 200, -1, FALSE, '`TypeName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`mitsubishi_sumbycode`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "mitsubishi_sumbycodelist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "mitsubishi_sumbycodeview.php")
			return $Language->phrase("View");
		elseif ($pageName == "mitsubishi_sumbycodeedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "mitsubishi_sumbycodeadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("mitsubishi_sumbycodeview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("mitsubishi_sumbycodeview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "mitsubishi_sumbycodeadd.php?" . $this->getUrlParm($parm);
		else
			$url = "mitsubishi_sumbycodeadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("mitsubishi_sumbycodeedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("mitsubishi_sumbycodeadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("mitsubishi_sumbycodedelete.php", $this->getUrlParm());
	}
