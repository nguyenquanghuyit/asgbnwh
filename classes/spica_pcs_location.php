...
/**
 * Table class for spica_pcs_location
 */
class spica_pcs_location extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'spica_pcs_location';
		$this->TableName = 'spica_pcs_location';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`spica_pcs_location`";
		$this->Dbid = 'DB';
		...
		// Location
		$this->Location = new DbField('spica_pcs_location', 'spica_pcs_location', 'x_Location', 'Location', '`Location`', '`Location`', 200, -1, FALSE, '`Location`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Location->Sortable = TRUE; // Allow sort
		$this->fields['Location'] = &$this->Location;

		// Code
		$this->Code = new DbField('spica_pcs_location', 'spica_pcs_location', 'x_Code', 'Code', '`Code`', '`Code`', 200, -1, FALSE, '`Code`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Code->Sortable = TRUE; // Allow sort
		$this->fields['Code'] = &$this->Code;

		// ProductName
		$this->ProductName = new DbField('spica_pcs_location', 'spica_pcs_location', 'x_ProductName', 'ProductName', '`ProductName`', '`ProductName`', 200, -1, FALSE, '`ProductName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ProductName->Sortable = TRUE; // Allow sort
		$this->fields['ProductName'] = &$this->ProductName;

		// Model
		$this->Model = new DbField('spica_pcs_location', 'spica_pcs_location', 'x_Model', 'Model', '`Model`', '`Model`', 200, -1, FALSE, '`Model`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Model->Sortable = TRUE; // Allow sort
		$this->fields['Model'] = &$this->Model;

		// PCS
		$this->PCS = new DbField('spica_pcs_location', 'spica_pcs_location', 'x_PCS', 'PCS', '`PCS`', '`PCS`', 131, -1, FALSE, '`PCS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`spica_pcs_location`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "spica_pcs_locationlist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "spica_pcs_locationview.php")
			return $Language->phrase("View");
		elseif ($pageName == "spica_pcs_locationedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "spica_pcs_locationadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("spica_pcs_locationview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("spica_pcs_locationview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "spica_pcs_locationadd.php?" . $this->getUrlParm($parm);
		else
			$url = "spica_pcs_locationadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("spica_pcs_locationedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("spica_pcs_locationadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("spica_pcs_locationdelete.php", $this->getUrlParm());
	}
