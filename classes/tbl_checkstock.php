...
/**
 * Table class for tbl_checkstock
 */
class tbl_checkstock extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'tbl_checkstock';
		$this->TableName = 'tbl_checkstock';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`tbl_checkstock`";
		$this->Dbid = 'DB';
		...
		// ID
		$this->ID = new DbField('tbl_checkstock', 'tbl_checkstock', 'x_ID', 'ID', '`ID`', '`ID`', 3, -1, FALSE, '`ID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// tenDotKiemKho
		$this->tenDotKiemKho = new DbField('tbl_checkstock', 'tbl_checkstock', 'x_tenDotKiemKho', 'tenDotKiemKho', '`tenDotKiemKho`', '`tenDotKiemKho`', 200, -1, FALSE, '`tenDotKiemKho`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->tenDotKiemKho->Sortable = TRUE; // Allow sort
		$this->fields['tenDotKiemKho'] = &$this->tenDotKiemKho;

		// NoiDung
		$this->NoiDung = new DbField('tbl_checkstock', 'tbl_checkstock', 'x_NoiDung', 'NoiDung', '`NoiDung`', '`NoiDung`', 200, -1, FALSE, '`NoiDung`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NoiDung->Sortable = TRUE; // Allow sort
		$this->fields['NoiDung'] = &$this->NoiDung;

		// UserCreate
		$this->UserCreate = new DbField('tbl_checkstock', 'tbl_checkstock', 'x_UserCreate', 'UserCreate', '`UserCreate`', '`UserCreate`', 200, -1, FALSE, '`UserCreate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->UserCreate->Sortable = TRUE; // Allow sort
		$this->fields['UserCreate'] = &$this->UserCreate;

		// DatetimeCreate
		$this->DatetimeCreate = new DbField('tbl_checkstock', 'tbl_checkstock', 'x_DatetimeCreate', 'DatetimeCreate', '`DatetimeCreate`', CastDateFieldForLike('`DatetimeCreate`', 7, "DB"), 135, 7, FALSE, '`DatetimeCreate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DatetimeCreate->Sortable = TRUE; // Allow sort
		$this->DatetimeCreate->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_SEPARATOR"], $Language->phrase("IncorrectDateDMY"));
		$this->fields['DatetimeCreate'] = &$this->DatetimeCreate;

		// UserUpdate
		$this->UserUpdate = new DbField('tbl_checkstock', 'tbl_checkstock', 'x_UserUpdate', 'UserUpdate', '`UserUpdate`', '`UserUpdate`', 200, -1, FALSE, '`UserUpdate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->UserUpdate->Sortable = TRUE; // Allow sort
		$this->fields['UserUpdate'] = &$this->UserUpdate;

		// DatetimeUpdate
		$this->DatetimeUpdate = new DbField('tbl_checkstock', 'tbl_checkstock', 'x_DatetimeUpdate', 'DatetimeUpdate', '`DatetimeUpdate`', CastDateFieldForLike('`DatetimeUpdate`', 7, "DB"), 135, 7, FALSE, '`DatetimeUpdate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DatetimeUpdate->Sortable = TRUE; // Allow sort
		$this->DatetimeUpdate->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_SEPARATOR"], $Language->phrase("IncorrectDateDMY"));
	...
	public function getDetailUrl()
	{
		...
		// Detail url
		$detailUrl = "";
		if ($this->getCurrentDetailTable() == "tbl_checkstockdetail") {
			$detailUrl = $GLOBALS["tbl_checkstockdetail"]->getListUrl() . "?" . TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$detailUrl .= "&fk_ID=" . urlencode($this->ID->CurrentValue);
		}
		if ($detailUrl == "")
			$detailUrl = "tbl_checkstocklist.php";
		return $detailUrl;
	}
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`tbl_checkstock`";
	}
	...
	{
		return ($this->SqlOrderBy <> "") ? $this->SqlOrderBy : "`DatetimeCreate` DESC";
	}
	...
	protected function loadDbValues(&$rs)
	{
		...
		$this->tenDotKiemKho->DbValue = $row['tenDotKiemKho'];
		$this->NoiDung->DbValue = $row['NoiDung'];
	...
	{
		global $Language;
		if ($pageName == "tbl_checkstockview.php")
			return $Language->phrase("View");
		elseif ($pageName == "tbl_checkstockedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "tbl_checkstockadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("tbl_checkstockview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("tbl_checkstockview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "tbl_checkstockadd.php?" . $this->getUrlParm($parm);
		else
			$url = "tbl_checkstockadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("tbl_checkstockedit.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("tbl_checkstockedit.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
		return $this->addMasterUrl($url);
	}
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("tbl_checkstockadd.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("tbl_checkstockadd.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("tbl_checkstockdelete.php", $this->getUrlParm());
	}
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->tenDotKiemKho->setDbValue($rs->fields('tenDotKiemKho'));
		$this->NoiDung->setDbValue($rs->fields('NoiDung'));
	...
	public function renderEditRow()
	{
		...
		if (REMOVE_XSS)
			$this->tenDotKiemKho->CurrentValue = HtmlDecode($this->tenDotKiemKho->CurrentValue);
		$this->tenDotKiemKho->EditValue = $this->tenDotKiemKho->CurrentValue;
		...
		if (REMOVE_XSS)
			$this->NoiDung->CurrentValue = HtmlDecode($this->NoiDung->CurrentValue);
		$this->NoiDung->EditValue = $this->NoiDung->CurrentValue;
		...
		$this->DatetimeCreate->EditValue = FormatDateTime($this->DatetimeCreate->CurrentValue, 7);
		...
		$this->DatetimeUpdate->EditValue = FormatDateTime($this->DatetimeUpdate->CurrentValue, 7);
		...
		if (!$doc->ExportCustom) {
			...
			if ($doc->Horizontal) { // Horizontal format, write header
				...
				if ($exportPageType == "view") {
					$doc->exportCaption($this->tenDotKiemKho);
					$doc->exportCaption($this->NoiDung);
					$doc->exportCaption($this->UserCreate);
					$doc->exportCaption($this->DatetimeCreate);
					$doc->exportCaption($this->UserUpdate);
					$doc->exportCaption($this->DatetimeUpdate);
				} else {
					$doc->exportCaption($this->tenDotKiemKho);
					$doc->exportCaption($this->NoiDung);
					$doc->exportCaption($this->UserCreate);
		...
		while (!$recordset->EOF && $recCnt < $stopRec) {
			...
			if ($recCnt >= $startRec) {
				...
				if (!$doc->ExportCustom) {
					...
					if ($exportPageType == "view") {
						$doc->exportField($this->tenDotKiemKho);
						$doc->exportField($this->NoiDung);
						$doc->exportField($this->UserCreate);
						$doc->exportField($this->DatetimeCreate);
						$doc->exportField($this->UserUpdate);
						$doc->exportField($this->DatetimeUpdate);
					} else {
						$doc->exportField($this->tenDotKiemKho);
						$doc->exportField($this->NoiDung);
						$doc->exportField($this->UserCreate);
