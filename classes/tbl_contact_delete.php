 ...
 * Page class
 */
class tbl_contact_delete extends tbl_contact
{
	...
	// Page object name
	public $PageObjName = "tbl_contact_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("tbl_contactlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("tbl_contactlist.php"); // Return to list
			}
		}
	}
