 ...
 * Page class
 */
class tbl_guider_grid extends tbl_guider
{
	...
	// Page object name
	public $PageObjName = "tbl_guider_grid";

	// Grid form hidden field names
	public $FormName = "ftbl_guidergrid";
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	protected function loadFormValues()
	{
		...
		$this->PCS_Request->setOldValue($CurrentForm->getValue("o_PCS_Request"));
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "vwmasterguide") {
			$this->OrderNo->Visible = FALSE;
			if ($GLOBALS["vwmasterguide"]->EventCancelled)
