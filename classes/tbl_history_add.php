 ...
 * Page class
 */
class tbl_history_add extends tbl_history
{
	...
	// Page object name
	public $PageObjName = "tbl_history_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("ID_His") !== NULL) {
				...
				$this->setKey("ID_His", $this->ID_His->CurrentValue); // Set up key
			} else {
				$this->setKey("ID_His", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("tbl_historylist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					if (GetPageName($returnUrl) == "tbl_historylist.php")
						$returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
					elseif (GetPageName($returnUrl) == "tbl_historyview.php")
