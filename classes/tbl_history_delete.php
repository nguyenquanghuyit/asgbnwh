 ...
 * Page class
 */
class tbl_history_delete extends tbl_history
{
	...
	// Page object name
	public $PageObjName = "tbl_history_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("tbl_historylist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("tbl_historylist.php"); // Return to list
			}
		}
	}
