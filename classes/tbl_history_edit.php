 ...
 * Page class
 */
class tbl_history_edit extends tbl_history
{
	...
	// Page object name
	public $PageObjName = "tbl_history_edit";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			// Load key from Form
			if ($CurrentForm->hasValue("x_ID_His")) {
				$this->ID_His->setFormValue($CurrentForm->getValue("x_ID_His"));
			}
		} else {
