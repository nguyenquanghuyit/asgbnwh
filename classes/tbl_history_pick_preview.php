 ...
 * Page class
 */
class tbl_history_pick_preview extends tbl_history_pick
{
	...
	// Page object name
	public $PageObjName = "tbl_history_pick_preview";
	...
	public function run()
	{
		...
		if (!$validRequest) {
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'tbl_history_pick');
			if ($Security->isLoggedIn())
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("tbl_history_picklist.php"), "", $this->TableVar, TRUE);
		$pageId = "preview";
