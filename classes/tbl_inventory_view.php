 ...
 * Page class
 */
class tbl_inventory_view extends tbl_inventory
{
	...
	// Page object name
	public $PageObjName = "tbl_inventory_view";
	...
	public function __construct()
	{
		...
		if (Get("ID_Delivery") !== NULL) {
			$this->RecKey["ID_Delivery"] = Get("ID_Delivery");
			$keyUrl .= "&amp;ID_Delivery=" . urlencode($this->RecKey["ID_Delivery"]);
		}
	...
	public function run()
	{
		...
		if (Get("ID_Delivery") !== NULL) {
			if ($ExportFileName <> "")
				$ExportFileName .= "_";
			$ExportFileName .= Get("ID_Delivery");
		}
		...
		$this->ID_Delivery->setVisibility();
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("ID_Delivery") !== NULL) {
				...
				$this->RecKey["ID_Delivery"] = $this->ID_Delivery->QueryStringValue;
			} elseif (IsApi() && Key(0) != NULL) {
				$this->ID_Delivery->setQueryStringValue(Key(0));
				$this->RecKey["ID_Delivery"] = $this->ID_Delivery->QueryStringValue;
			} elseif (Post("ID_Delivery") !== NULL) {
				$this->ID_Delivery->setFormValue(Post("ID_Delivery"));
				$this->RecKey["ID_Delivery"] = $this->ID_Delivery->FormValue;
			} elseif (IsApi() && Route(2) != NULL) {
				$this->ID_Delivery->setFormValue(Route(2));
				$this->RecKey["ID_Delivery"] = $this->ID_Delivery->FormValue;
			} else {
				$returnUrl = "tbl_inventorylist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "tbl_inventorylist.php"; // No matching record, return to list
					}
			}
			...
			$returnUrl = "tbl_inventorylist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"ew.export(document.ftbl_inventoryview,'" . $this->ExportExcelUrl . "','excel',true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"ew.export(document.ftbl_inventoryview,'" . $this->ExportWordUrl . "','word',true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"ew.export(document.ftbl_inventoryview,'" . $this->ExportPdfUrl . "','pdf',true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
