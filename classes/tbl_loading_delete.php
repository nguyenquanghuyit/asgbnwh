 ...
 * Page class
 */
class tbl_loading_delete extends tbl_loading
{
	...
	// Page object name
	public $PageObjName = "tbl_loading_delete";
	...
	public function run()
	{
		...
		if (!$validRequest) {
			...
			if (!$Security->canDelete()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("tbl_loadinglist.php"));
				else
		...
		if ($filter == "") {
			$this->terminate("tbl_loadinglist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("tbl_loadinglist.php"); // Return to list
			}
		}
	}
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("tbl_loadinglist.php"), "", $this->TableVar, TRUE);
		$pageId = "delete";
