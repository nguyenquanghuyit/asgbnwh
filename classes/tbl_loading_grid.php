 ...
 * Page class
 */
class tbl_loading_grid extends tbl_loading
{
	...
	// Page object name
	public $PageObjName = "tbl_loading_grid";

	// Grid form hidden field names
	public $FormName = "ftbl_loadinggrid";
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
		...
		for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
			...
			if (!$this->emptyRow()) {
				...
				if ($gridInsert) {
					...
					$key .= $this->ID_Loading->CurrentValue;
	...
	protected function loadOldRecord()
	{
		...
		if ($cnt >= 1) {
			if (strval($arKeys[0]) <> "")
				$this->ID_Loading->CurrentValue = strval($arKeys[0]); // ID_Loading
			else
				$validKey = FALSE;
		} else {
			$validKey = FALSE;
