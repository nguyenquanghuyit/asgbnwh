 ...
 * Page class
 */
class tbl_location_add extends tbl_location
{
	...
	// Page object name
	public $PageObjName = "tbl_location_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("ID_Location") !== NULL) {
				...
				$this->setKey("ID_Location", $this->ID_Location->CurrentValue); // Set up key
			} else {
				$this->setKey("ID_Location", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("tbl_locationlist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					if (GetPageName($returnUrl) == "tbl_locationlist.php")
						$returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
					elseif (GetPageName($returnUrl) == "tbl_locationview.php")
