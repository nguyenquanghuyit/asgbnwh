 ...
 * Page class
 */
class tbl_location_delete extends tbl_location
{
	...
	// Page object name
	public $PageObjName = "tbl_location_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("tbl_locationlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("tbl_locationlist.php"); // Return to list
			}
		}
	}
