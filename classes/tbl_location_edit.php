 ...
 * Page class
 */
class tbl_location_edit extends tbl_location
{
	...
	// Page object name
	public $PageObjName = "tbl_location_edit";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			// Load key from Form
			if ($CurrentForm->hasValue("x_ID_Location")) {
				$this->ID_Location->setFormValue($CurrentForm->getValue("x_ID_Location"));
			}
		} else {
