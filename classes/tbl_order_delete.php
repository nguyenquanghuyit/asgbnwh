 ...
 * Page class
 */
class tbl_order_delete extends tbl_order
{
	...
	// Page object name
	public $PageObjName = "tbl_order_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("tbl_orderlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("tbl_orderlist.php"); // Return to list
			}
		}
	}
