 ...
 * Page class
 */
class tbl_order_po_inv_view extends tbl_order_po_inv
{
	...
	// Page object name
	public $PageObjName = "tbl_order_po_inv_view";
	...
	public function __construct()
	{
		...
		if (Get("ID_PoInv") !== NULL) {
			$this->RecKey["ID_PoInv"] = Get("ID_PoInv");
			$keyUrl .= "&amp;ID_PoInv=" . urlencode($this->RecKey["ID_PoInv"]);
		}
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("ID_PoInv") !== NULL) {
				...
				$this->RecKey["ID_PoInv"] = $this->ID_PoInv->QueryStringValue;
			} elseif (IsApi() && Key(0) != NULL) {
				$this->ID_PoInv->setQueryStringValue(Key(0));
				$this->RecKey["ID_PoInv"] = $this->ID_PoInv->QueryStringValue;
			} elseif (Post("ID_PoInv") !== NULL) {
				$this->ID_PoInv->setFormValue(Post("ID_PoInv"));
				$this->RecKey["ID_PoInv"] = $this->ID_PoInv->FormValue;
			} elseif (IsApi() && Route(2) != NULL) {
				$this->ID_PoInv->setFormValue(Route(2));
				$this->RecKey["ID_PoInv"] = $this->ID_PoInv->FormValue;
			} else {
				$returnUrl = "tbl_order_po_invlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "tbl_order_po_invlist.php"; // No matching record, return to list
					}
			}
			...
			$returnUrl = "tbl_order_po_invlist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"ew.export(document.ftbl_order_po_invview,'" . $this->ExportExcelUrl . "','excel',true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"ew.export(document.ftbl_order_po_invview,'" . $this->ExportWordUrl . "','word',true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"ew.export(document.ftbl_order_po_invview,'" . $this->ExportPdfUrl . "','pdf',true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
