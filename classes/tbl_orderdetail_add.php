 ...
 * Page class
 */
class tbl_orderdetail_add extends tbl_orderdetail
{
	...
	// Page object name
	public $PageObjName = "tbl_orderdetail_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("ID_Detail") !== NULL) {
				...
				$this->setKey("ID_Detail", $this->ID_Detail->CurrentValue); // Set up key
			} else {
				$this->setKey("ID_Detail", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("tbl_orderdetaillist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					if (GetPageName($returnUrl) == "tbl_orderdetaillist.php")
						$returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
					elseif (GetPageName($returnUrl) == "tbl_orderdetailview.php")
