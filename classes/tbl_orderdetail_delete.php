 ...
 * Page class
 */
class tbl_orderdetail_delete extends tbl_orderdetail
{
	...
	// Page object name
	public $PageObjName = "tbl_orderdetail_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("tbl_orderdetaillist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("tbl_orderdetaillist.php"); // Return to list
			}
		}
	}
