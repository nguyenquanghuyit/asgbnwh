 ...
 * Page class
 */
class tbl_orderdetail_preview extends tbl_orderdetail
{
	...
	// Page object name
	public $PageObjName = "tbl_orderdetail_preview";
	...
	public function run()
	{
		...
		if (!$validRequest) {
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'tbl_orderdetail');
			if ($Security->isLoggedIn())
