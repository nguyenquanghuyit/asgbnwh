...
/**
 * Table class for tbl_orderguide
 */
class tbl_orderguide extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'tbl_orderguide';
		$this->TableName = 'tbl_orderguide';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`tbl_orderguide`";
		$this->Dbid = 'DB';
		...
		// ID_Guide
		$this->ID_Guide = new DbField('tbl_orderguide', 'tbl_orderguide', 'x_ID_Guide', 'ID_Guide', '`ID_Guide`', '`ID_Guide`', 3, -1, FALSE, '`ID_Guide`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->ID_Guide->IsAutoIncrement = TRUE; // Autoincrement field
		$this->ID_Guide->IsPrimaryKey = TRUE; // Primary key field
		$this->ID_Guide->Sortable = FALSE; // Allow sort
		$this->ID_Guide->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['ID_Guide'] = &$this->ID_Guide;

		// ID_Order
		$this->ID_Order = new DbField('tbl_orderguide', 'tbl_orderguide', 'x_ID_Order', 'ID_Order', '`ID_Order`', '`ID_Order`', 3, -1, FALSE, '`ID_Order`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Code
		$this->Code = new DbField('tbl_orderguide', 'tbl_orderguide', 'x_Code', 'Code', '`Code`', '`Code`', 200, -1, FALSE, '`Code`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Code->Sortable = TRUE; // Allow sort
		$this->fields['Code'] = &$this->Code;

		// ProductName
		$this->ProductName = new DbField('tbl_orderguide', 'tbl_orderguide', 'x_ProductName', 'ProductName', '`ProductName`', '`ProductName`', 200, -1, FALSE, '`ProductName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ProductName->Sortable = TRUE; // Allow sort
		$this->fields['ProductName'] = &$this->ProductName;

		// PCS_In
		$this->PCS_In = new DbField('tbl_orderguide', 'tbl_orderguide', 'x_PCS_In', 'PCS_In', '`PCS_In`', '`PCS_In`', 3, -1, FALSE, '`PCS_In`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PCS
		$this->PCS = new DbField('tbl_orderguide', 'tbl_orderguide', 'x_PCS', 'PCS', '`PCS`', '`PCS`', 3, -1, FALSE, '`PCS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PCS->Sortable = TRUE; // Allow sort
		$this->PCS->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['PCS'] = &$this->PCS;

		// Qty
		$this->Qty = new DbField('tbl_orderguide', 'tbl_orderguide', 'x_Qty', 'Qty', '`Qty`', '`Qty`', 3, -1, FALSE, '`Qty`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Qty->Sortable = TRUE; // Allow sort
		$this->Qty->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['Qty'] = &$this->Qty;

		// Box
		$this->Box = new DbField('tbl_orderguide', 'tbl_orderguide', 'x_Box', 'Box', '`Box`', '`Box`', 3, -1, FALSE, '`Box`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Box->Sortable = TRUE; // Allow sort
		$this->Box->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['Box'] = &$this->Box;

		// ID_Location
		$this->ID_Location = new DbField('tbl_orderguide', 'tbl_orderguide', 'x_ID_Location', 'ID_Location', '`ID_Location`', '`ID_Location`', 3, -1, FALSE, '`EV__ID_Location`', TRUE, TRUE, TRUE, 'FORMATTED TEXT', 'TEXT');
		...
		// PalletID
		$this->PalletID = new DbField('tbl_orderguide', 'tbl_orderguide', 'x_PalletID', 'PalletID', '`PalletID`', '`PalletID`', 200, -1, FALSE, '`PalletID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PalletID->Sortable = TRUE; // Allow sort
		$this->fields['PalletID'] = &$this->PalletID;

		// MFG
		$this->MFG = new DbField('tbl_orderguide', 'tbl_orderguide', 'x_MFG', 'MFG', '`MFG`', CastDateFieldForLike('`MFG`', 7, "DB"), 133, 7, FALSE, '`MFG`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DateIn
		$this->DateIn = new DbField('tbl_orderguide', 'tbl_orderguide', 'x_DateIn', 'DateIn', '`DateIn`', CastDateFieldForLike('`DateIn`', 11, "DB"), 135, 11, FALSE, '`DateIn`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Note_PickUp
		$this->Note_PickUp = new DbField('tbl_orderguide', 'tbl_orderguide', 'x_Note_PickUp', 'Note_PickUp', '`Note_PickUp`', '`Note_PickUp`', 200, -1, FALSE, '`Note_PickUp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Note_PickUp->Sortable = FALSE; // Allow sort
		$this->fields['Note_PickUp'] = &$this->Note_PickUp;

		// CreateUser
		$this->CreateUser = new DbField('tbl_orderguide', 'tbl_orderguide', 'x_CreateUser', 'CreateUser', '`CreateUser`', '`CreateUser`', 200, -1, FALSE, '`CreateUser`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CreateUser->Sortable = FALSE; // Allow sort
		$this->fields['CreateUser'] = &$this->CreateUser;

		// CreateDate
		$this->CreateDate = new DbField('tbl_orderguide', 'tbl_orderguide', 'x_CreateDate', 'CreateDate', '`CreateDate`', CastDateFieldForLike('`CreateDate`', 11, "DB"), 135, 11, FALSE, '`CreateDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// UpdateUser
		$this->UpdateUser = new DbField('tbl_orderguide', 'tbl_orderguide', 'x_UpdateUser', 'UpdateUser', '`UpdateUser`', '`UpdateUser`', 200, -1, FALSE, '`UpdateUser`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->UpdateUser->Sortable = TRUE; // Allow sort
		$this->fields['UpdateUser'] = &$this->UpdateUser;

		// UpdateDate
		$this->UpdateDate = new DbField('tbl_orderguide', 'tbl_orderguide', 'x_UpdateDate', 'UpdateDate', '`UpdateDate`', CastDateFieldForLike('`UpdateDate`', 0, "DB"), 135, 0, FALSE, '`UpdateDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Note_PalletID
		$this->Note_PalletID = new DbField('tbl_orderguide', 'tbl_orderguide', 'x_Note_PalletID', 'Note_PalletID', '`Note_PalletID`', '`Note_PalletID`', 200, -1, FALSE, '`Note_PalletID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Note_PalletID->Sortable = FALSE; // Allow sort
		$this->fields['Note_PalletID'] = &$this->Note_PalletID;

		// PCS_Loaded
		$this->PCS_Loaded = new DbField('tbl_orderguide', 'tbl_orderguide', 'x_PCS_Loaded', 'PCS_Loaded', '`PCS_Loaded`', '`PCS_Loaded`', 3, -1, FALSE, '`PCS_Loaded`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PCS_Loaded->Sortable = FALSE; // Allow sort
		$this->PCS_Loaded->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['PCS_Loaded'] = &$this->PCS_Loaded;
	}
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`tbl_orderguide`";
	}
	...
	public function getSqlSelectList() // Select for List page
	{
		$select = "";
		$select = "SELECT * FROM (" .
			"SELECT *, (SELECT `Location` FROM `tbl_location` `TMP_LOOKUPTABLE` WHERE `TMP_LOOKUPTABLE`.`ID_Location` = `tbl_orderguide`.`ID_Location` LIMIT 1) AS `EV__ID_Location` FROM `tbl_orderguide`" .
			") `TMP_TABLE`";
	...
	{
		return ($this->SqlOrderBy <> "") ? $this->SqlOrderBy : "`ID_Order` ASC";
	}
	...
	protected function loadDbValues(&$rs)
	{
		...
		$this->Note_PickUp->DbValue = $row['Note_PickUp'];
		...
		$this->PCS_Loaded->DbValue = $row['PCS_Loaded'];
	}
	...
	{
		global $Language;
		if ($pageName == "tbl_orderguideview.php")
			return $Language->phrase("View");
		elseif ($pageName == "tbl_orderguideedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "tbl_orderguideadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("tbl_orderguideview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("tbl_orderguideview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "tbl_orderguideadd.php?" . $this->getUrlParm($parm);
		else
			$url = "tbl_orderguideadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("tbl_orderguideedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("tbl_orderguideadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("tbl_orderguidedelete.php", $this->getUrlParm());
	}
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->Note_PickUp->setDbValue($rs->fields('Note_PickUp'));
		...
		$this->PCS_Loaded->setDbValue($rs->fields('PCS_Loaded'));
	}
	...
	public function renderListRow()
	{
		...
		// Note_PickUp
		$this->Note_PickUp->ViewValue = $this->Note_PickUp->CurrentValue;
		$this->Note_PickUp->ViewCustomAttributes = "";
		...
		// PCS_Loaded
		$this->PCS_Loaded->ViewValue = $this->PCS_Loaded->CurrentValue;
		$this->PCS_Loaded->ViewValue = FormatNumber($this->PCS_Loaded->ViewValue, 0, -2, -2, -2);
		$this->PCS_Loaded->ViewCustomAttributes = "";
		...
		// Note_PickUp
		$this->Note_PickUp->LinkCustomAttributes = "";
		$this->Note_PickUp->HrefValue = "";
		$this->Note_PickUp->TooltipValue = "";
		...
		// PCS_Loaded
		$this->PCS_Loaded->LinkCustomAttributes = "";
		$this->PCS_Loaded->HrefValue = "";
		$this->PCS_Loaded->TooltipValue = "";
	...
	public function renderEditRow()
	{
		...
		// Note_PickUp
		$this->Note_PickUp->EditAttrs["class"] = "form-control";
		$this->Note_PickUp->EditCustomAttributes = "";
		if (REMOVE_XSS)
			$this->Note_PickUp->CurrentValue = HtmlDecode($this->Note_PickUp->CurrentValue);
		$this->Note_PickUp->EditValue = $this->Note_PickUp->CurrentValue;
		$this->Note_PickUp->PlaceHolder = RemoveHtml($this->Note_PickUp->caption());
		...
		// PCS_Loaded
		$this->PCS_Loaded->EditAttrs["class"] = "form-control";
		$this->PCS_Loaded->EditCustomAttributes = "";
		$this->PCS_Loaded->EditValue = $this->PCS_Loaded->CurrentValue;
		$this->PCS_Loaded->PlaceHolder = RemoveHtml($this->PCS_Loaded->caption());
