 ...
 * Page class
 */
class tbl_orderguide_add extends tbl_orderguide
{
	...
	// Page object name
	public $PageObjName = "tbl_orderguide_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("ID_Guide") !== NULL) {
				...
				$this->setKey("ID_Guide", $this->ID_Guide->CurrentValue); // Set up key
			} else {
				$this->setKey("ID_Guide", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "tbl_orderguideview.php")
	...
	protected function addRow($rsold = NULL)
	{
		...
		// Note_PickUp
		$this->Note_PickUp->setDbValueDef($rsnew, $this->Note_PickUp->CurrentValue, NULL, FALSE);
