 ...
 * Page class
 */
class tbl_orderguide_delete extends tbl_orderguide
{
	...
	// Page object name
	public $PageObjName = "tbl_orderguide_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("tbl_orderguidelist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("tbl_orderguidelist.php"); // Return to list
			}
		}
	}
