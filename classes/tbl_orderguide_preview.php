 ...
 * Page class
 */
class tbl_orderguide_preview extends tbl_orderguide
{
	...
	// Page object name
	public $PageObjName = "tbl_orderguide_preview";
	...
	public function run()
	{
		...
		if (!$validRequest) {
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'tbl_orderguide');
			if ($Security->isLoggedIn())
