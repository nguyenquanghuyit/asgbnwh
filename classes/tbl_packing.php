...
/**
 * Table class for tbl_packing
 */
class tbl_packing extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'tbl_packing';
		$this->TableName = 'tbl_packing';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`tbl_packing`";
		$this->Dbid = 'DB';
		...
		// Id_packing
		$this->Id_packing = new DbField('tbl_packing', 'tbl_packing', 'x_Id_packing', 'Id_packing', '`Id_packing`', '`Id_packing`', 20, -1, FALSE, '`Id_packing`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// Id_order
		$this->Id_order = new DbField('tbl_packing', 'tbl_packing', 'x_Id_order', 'Id_order', '`Id_order`', '`Id_order`', 3, -1, FALSE, '`Id_order`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Id_order->Sortable = TRUE; // Allow sort
		$this->Id_order->Lookup = new Lookup('Id_order', 'vworder_packing', FALSE, 'ID_Order', ["CusomterOrderNo","","",""], [], [], [], [], [], [], '', '');
		$this->Id_order->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['Id_order'] = &$this->Id_order;

		// CreateUser
		$this->CreateUser = new DbField('tbl_packing', 'tbl_packing', 'x_CreateUser', 'CreateUser', '`CreateUser`', '`CreateUser`', 200, -1, FALSE, '`CreateUser`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CreateUser->Sortable = TRUE; // Allow sort
		$this->fields['CreateUser'] = &$this->CreateUser;

		// CreateDate
		$this->CreateDate = new DbField('tbl_packing', 'tbl_packing', 'x_CreateDate', 'CreateDate', '`CreateDate`', CastDateFieldForLike('`CreateDate`', 7, "DB"), 135, 7, FALSE, '`CreateDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// UpdateUser
		$this->UpdateUser = new DbField('tbl_packing', 'tbl_packing', 'x_UpdateUser', 'UpdateUser', '`UpdateUser`', '`UpdateUser`', 200, -1, FALSE, '`UpdateUser`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->UpdateUser->Sortable = FALSE; // Allow sort
		$this->fields['UpdateUser'] = &$this->UpdateUser;

		// UpdateDate
		$this->UpdateDate = new DbField('tbl_packing', 'tbl_packing', 'x_UpdateDate', 'UpdateDate', '`UpdateDate`', CastDateFieldForLike('`UpdateDate`', 0, "DB"), 135, 0, FALSE, '`UpdateDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`tbl_packing`";
	}
	...
	{
		return ($this->SqlOrderBy <> "") ? $this->SqlOrderBy : "`CreateDate` DESC,`Id_order` ASC";
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "tbl_packingedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "tbl_packingadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("tbl_packingview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("tbl_packingview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "tbl_packingadd.php?" . $this->getUrlParm($parm);
		else
			$url = "tbl_packingadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("tbl_packingedit.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("tbl_packingedit.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
		return $this->addMasterUrl($url);
	}
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("tbl_packingadd.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("tbl_packingadd.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("tbl_packingdelete.php", $this->getUrlParm());
	}
