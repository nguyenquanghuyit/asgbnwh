 ...
 * Page class
 */
class tbl_pallet_add extends tbl_pallet
{
	...
	// Page object name
	public $PageObjName = "tbl_pallet_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "tbl_palletview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->ExistStatus->CurrentValue = 1;
		...
		$this->PenddingStatus->CurrentValue = 1;
		$this->UserFinishPendding->CurrentValue = CurrentUserName();
		$this->DateTimeFinishPedding->CurrentValue = CurrentDateTime();
		...
		$this->ID_Code->CurrentValue = NULL;
		$this->ID_Code->OldValue = $this->ID_Code->CurrentValue;
	}
	...
	protected function newRow()
	{
		...
		$row['ExistStatus'] = $this->ExistStatus->CurrentValue;
		...
		$row['PenddingStatus'] = $this->PenddingStatus->CurrentValue;
		$row['UserFinishPendding'] = $this->UserFinishPendding->CurrentValue;
		$row['DateTimeFinishPedding'] = $this->DateTimeFinishPedding->CurrentValue;
		$row['UpdateUser'] = $this->UpdateUser->CurrentValue;
		$row['UpdateDate'] = $this->UpdateDate->CurrentValue;
		$row['Status'] = $this->Status->CurrentValue;
		$row['ID_Code'] = $this->ID_Code->CurrentValue;
		return $row;
	}
	...
	protected function addRow($rsold = NULL)
	{
		...
		// ID_Route
		$this->ID_Route->setDbValueDef($rsnew, $this->ID_Route->CurrentValue, 0, FALSE);
		...
		// ExistStatus
		$this->ExistStatus->setDbValueDef($rsnew, $this->ExistStatus->CurrentValue, 0, strval($this->ExistStatus->CurrentValue) == "");
		...
		// PenddingStatus
		$this->PenddingStatus->setDbValueDef($rsnew, $this->PenddingStatus->CurrentValue, 0, FALSE);
