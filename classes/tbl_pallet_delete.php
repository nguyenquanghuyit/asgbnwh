 ...
 * Page class
 */
class tbl_pallet_delete extends tbl_pallet
{
	...
	// Page object name
	public $PageObjName = "tbl_pallet_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("tbl_palletlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("tbl_palletlist.php"); // Return to list
			}
		}
	}
