 ...
 * Page class
 */
class tbl_pallet_list extends tbl_pallet
{
	...
	// Page object name
	public $PageObjName = "tbl_pallet_list";

	// Grid form hidden field names
	public $FormName = "ftbl_palletlist";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "tbl_palletadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "tbl_palletdelete.php";
		$this->MultiUpdateUrl = "tbl_palletupdate.php";
		...
		$this->FilterOptions->TagClassName = "ew-filter-option ftbl_palletlistsrch";
	...
	protected function hideFieldsForAddEdit()
	{
		...
		if ($this->isAddOrEdit())
			$this->UserFinishPendding->Visible = FALSE;
		if ($this->isAddOrEdit())
			$this->DateTimeFinishPedding->Visible = FALSE;
	}
	...
	public function getFilterList()
	{
		...
		$filterList = "";
		$savedFilterList = "";
		$filterList = Concat($filterList, $this->ID_Route->AdvancedSearch->toJson(), ","); // Field ID_Route
		...
		$filterList = Concat($filterList, $this->ExistStatus->AdvancedSearch->toJson(), ","); // Field ExistStatus
		...
		$filterList = Concat($filterList, $this->PenddingStatus->AdvancedSearch->toJson(), ","); // Field PenddingStatus
		$filterList = Concat($filterList, $this->UserFinishPendding->AdvancedSearch->toJson(), ","); // Field UserFinishPendding
		$filterList = Concat($filterList, $this->DateTimeFinishPedding->AdvancedSearch->toJson(), ","); // Field DateTimeFinishPedding
		if ($this->BasicSearch->Keyword <> "") {
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "ftbl_palletlistsrch", $filters);
	...
	protected function restoreFilterList()
	{
		...
		// Field ID_Route
		$this->ID_Route->AdvancedSearch->SearchValue = @$filter["x_ID_Route"];
		$this->ID_Route->AdvancedSearch->SearchOperator = @$filter["z_ID_Route"];
		$this->ID_Route->AdvancedSearch->SearchCondition = @$filter["v_ID_Route"];
		$this->ID_Route->AdvancedSearch->SearchValue2 = @$filter["y_ID_Route"];
		$this->ID_Route->AdvancedSearch->SearchOperator2 = @$filter["w_ID_Route"];
		$this->ID_Route->AdvancedSearch->save();
		...
		// Field ExistStatus
		$this->ExistStatus->AdvancedSearch->SearchValue = @$filter["x_ExistStatus"];
		$this->ExistStatus->AdvancedSearch->SearchOperator = @$filter["z_ExistStatus"];
		$this->ExistStatus->AdvancedSearch->SearchCondition = @$filter["v_ExistStatus"];
		$this->ExistStatus->AdvancedSearch->SearchValue2 = @$filter["y_ExistStatus"];
		$this->ExistStatus->AdvancedSearch->SearchOperator2 = @$filter["w_ExistStatus"];
		$this->ExistStatus->AdvancedSearch->save();
		...
		// Field PenddingStatus
		$this->PenddingStatus->AdvancedSearch->SearchValue = @$filter["x_PenddingStatus"];
		$this->PenddingStatus->AdvancedSearch->SearchOperator = @$filter["z_PenddingStatus"];
		$this->PenddingStatus->AdvancedSearch->SearchCondition = @$filter["v_PenddingStatus"];
		$this->PenddingStatus->AdvancedSearch->SearchValue2 = @$filter["y_PenddingStatus"];
		$this->PenddingStatus->AdvancedSearch->SearchOperator2 = @$filter["w_PenddingStatus"];
		$this->PenddingStatus->AdvancedSearch->save();

		// Field UserFinishPendding
		$this->UserFinishPendding->AdvancedSearch->SearchValue = @$filter["x_UserFinishPendding"];
		$this->UserFinishPendding->AdvancedSearch->SearchOperator = @$filter["z_UserFinishPendding"];
		$this->UserFinishPendding->AdvancedSearch->SearchCondition = @$filter["v_UserFinishPendding"];
		$this->UserFinishPendding->AdvancedSearch->SearchValue2 = @$filter["y_UserFinishPendding"];
		$this->UserFinishPendding->AdvancedSearch->SearchOperator2 = @$filter["w_UserFinishPendding"];
		$this->UserFinishPendding->AdvancedSearch->save();

		// Field DateTimeFinishPedding
		$this->DateTimeFinishPedding->AdvancedSearch->SearchValue = @$filter["x_DateTimeFinishPedding"];
		$this->DateTimeFinishPedding->AdvancedSearch->SearchOperator = @$filter["z_DateTimeFinishPedding"];
		$this->DateTimeFinishPedding->AdvancedSearch->SearchCondition = @$filter["v_DateTimeFinishPedding"];
		$this->DateTimeFinishPedding->AdvancedSearch->SearchValue2 = @$filter["y_DateTimeFinishPedding"];
		$this->DateTimeFinishPedding->AdvancedSearch->SearchOperator2 = @$filter["w_DateTimeFinishPedding"];
		$this->DateTimeFinishPedding->AdvancedSearch->save();
	...
	protected function advancedSearchWhere($default = FALSE)
	{
		...
		if (!$Security->canSearch())
			return "";
		$this->buildSearchSql($where, $this->ID_Route, $default, FALSE); // ID_Route
		...
		$this->buildSearchSql($where, $this->ExistStatus, $default, FALSE); // ExistStatus
		...
		$this->buildSearchSql($where, $this->PenddingStatus, $default, FALSE); // PenddingStatus
		$this->buildSearchSql($where, $this->UserFinishPendding, $default, FALSE); // UserFinishPendding
		$this->buildSearchSql($where, $this->DateTimeFinishPedding, $default, FALSE); // DateTimeFinishPedding
		...
		if (!$default && $this->Command == "search") {
			$this->ID_Route->AdvancedSearch->save(); // ID_Route
			...
			$this->ExistStatus->AdvancedSearch->save(); // ExistStatus
			$this->CreateUser->AdvancedSearch->save(); // CreateUser
			$this->CreateDate->AdvancedSearch->save(); // CreateDate
			$this->PenddingStatus->AdvancedSearch->save(); // PenddingStatus
			$this->UserFinishPendding->AdvancedSearch->save(); // UserFinishPendding
			$this->DateTimeFinishPedding->AdvancedSearch->save(); // DateTimeFinishPedding
		}
		return $where;
	}
	...
	protected function basicSearchSql($arKeywords, $type)
	{
		...
		$this->buildBasicSearchSql($where, $this->ExistStatus, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->PenddingStatus, $arKeywords, $type);
		return $where;
	}
	...
	protected function checkSearchParms()
	{
		...
		if ($this->BasicSearch->issetSession())
			return TRUE;
		if ($this->ID_Route->AdvancedSearch->issetSession())
			return TRUE;
		...
		if ($this->PCS->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->ExistStatus->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->CreateUser->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->CreateDate->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->PenddingStatus->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->UserFinishPendding->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->DateTimeFinishPedding->AdvancedSearch->issetSession())
			return TRUE;
		return FALSE;
	}
	...
	{
		$this->ID_Route->AdvancedSearch->unsetSession();
		...
		$this->ExistStatus->AdvancedSearch->unsetSession();
		$this->CreateUser->AdvancedSearch->unsetSession();
		$this->CreateDate->AdvancedSearch->unsetSession();
		$this->PenddingStatus->AdvancedSearch->unsetSession();
		$this->UserFinishPendding->AdvancedSearch->unsetSession();
		$this->DateTimeFinishPedding->AdvancedSearch->unsetSession();
	}
	...
	protected function restoreSearchParms()
	{
		...
		$this->ID_Route->AdvancedSearch->load();
		...
		$this->ExistStatus->AdvancedSearch->load();
		$this->CreateUser->AdvancedSearch->load();
		$this->CreateDate->AdvancedSearch->load();
		$this->PenddingStatus->AdvancedSearch->load();
		$this->UserFinishPendding->AdvancedSearch->load();
		$this->DateTimeFinishPedding->AdvancedSearch->load();
	}
	...
	protected function setupSortOrder()
	{
		...
		if (Get("order") !== NULL) {
			...
			$this->updateSort($this->ExistStatus, $ctrl); // ExistStatus
			$this->updateSort($this->CreateUser, $ctrl); // CreateUser
			$this->updateSort($this->CreateDate, $ctrl); // CreateDate
			$this->updateSort($this->PenddingStatus, $ctrl); // PenddingStatus
			$this->updateSort($this->UserFinishPendding, $ctrl); // UserFinishPendding
			$this->updateSort($this->DateTimeFinishPedding, $ctrl); // DateTimeFinishPedding
	...
	protected function resetCmd()
	{
		...
		if (substr($this->Command,0,5) == "reset") {
			...
			if ($this->Command == "resetsort") {
				...
				$this->PCS->setSort("");
				$this->ExistStatus->setSort("");
				$this->CreateUser->setSort("");
				$this->CreateDate->setSort("");
				$this->PenddingStatus->setSort("");
				$this->UserFinishPendding->setSort("");
				$this->DateTimeFinishPedding->setSort("");
			}
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-action ew-multi-delete\" title=\"" . HtmlTitle($Language->phrase("DeleteSelectedLink")) . "\" data-caption=\"" . HtmlTitle($Language->phrase("DeleteSelectedLink")) . "\" href=\"\" onclick=\"ew.submitAction(event,{f:document.ftbl_palletlist,url:'" . $this->MultiDeleteUrl . "',data:{action:'show'}});return false;\">" . $Language->phrase("DeleteSelectedLink") . "</a>";
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"ftbl_palletlistsrch\" href=\"#\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"ftbl_palletlistsrch\" href=\"#\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"\" onclick=\"ew.submitAction(event,jQuery.extend({f:document.ftbl_palletlist}," . $listaction->toJson(TRUE) . "));return false;\">" . $icon . "</a>";
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"ftbl_palletlistsrch\">" . $Language->phrase("SearchLink") . "</button>";
		$item->Visible = TRUE;
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-highlight active\" title=\"" . $Language->phrase("Highlight") . "\" data-caption=\"" . $Language->phrase("Highlight") . "\" data-toggle=\"button\" data-form=\"ftbl_palletlistsrch\" data-name=\"" . $this->highlightName() . "\">" . $Language->phrase("HighlightBtn") . "</button>";
	...
	protected function loadSearchValues()
	{
		...
		if (!$this->isAddOrEdit())
			$this->ID_Route->AdvancedSearch->setSearchValue(Get("x_ID_Route", Get("ID_Route", "")));
		if ($this->ID_Route->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->ID_Route->AdvancedSearch->setSearchOperator(Get("z_ID_Route", ""));
		...
		// ExistStatus
		if (!$this->isAddOrEdit())
			$this->ExistStatus->AdvancedSearch->setSearchValue(Get("x_ExistStatus", Get("ExistStatus", "")));
		if ($this->ExistStatus->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->ExistStatus->AdvancedSearch->setSearchOperator(Get("z_ExistStatus", ""));
		...
		// PenddingStatus
		if (!$this->isAddOrEdit())
			$this->PenddingStatus->AdvancedSearch->setSearchValue(Get("x_PenddingStatus", Get("PenddingStatus", "")));
		if ($this->PenddingStatus->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->PenddingStatus->AdvancedSearch->setSearchOperator(Get("z_PenddingStatus", ""));

		// UserFinishPendding
		if (!$this->isAddOrEdit())
			$this->UserFinishPendding->AdvancedSearch->setSearchValue(Get("x_UserFinishPendding", Get("UserFinishPendding", "")));
		if ($this->UserFinishPendding->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->UserFinishPendding->AdvancedSearch->setSearchOperator(Get("z_UserFinishPendding", ""));

		// DateTimeFinishPedding
		if (!$this->isAddOrEdit())
			$this->DateTimeFinishPedding->AdvancedSearch->setSearchValue(Get("x_DateTimeFinishPedding", Get("DateTimeFinishPedding", "")));
		if ($this->DateTimeFinishPedding->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->DateTimeFinishPedding->AdvancedSearch->setSearchOperator(Get("z_DateTimeFinishPedding", ""));
	}
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			$curVal = trim(strval($this->Id_Type->AdvancedSearch->SearchValue));
			if ($curVal <> "")
				$this->Id_Type->AdvancedSearch->ViewValue = $this->Id_Type->lookupCacheOption($curVal);
			else
				$this->Id_Type->AdvancedSearch->ViewValue = $this->Id_Type->Lookup !== NULL && is_array($this->Id_Type->Lookup->Options) ? $curVal : NULL;
			if ($this->Id_Type->AdvancedSearch->ViewValue !== NULL) { // Load from cache
				$this->Id_Type->EditValue = array_values($this->Id_Type->Lookup->Options);
			} else { // Lookup from database
				if ($curVal == "") {
					$filterWrk = "0=1";
				} else {
					$filterWrk = "`IdType`" . SearchString("=", $this->Id_Type->AdvancedSearch->SearchValue, DATATYPE_STRING, "");
				}
			...
			// UserFinishPendding
			$this->UserFinishPendding->EditAttrs["class"] = "form-control";
			$this->UserFinishPendding->EditCustomAttributes = "";
			if (REMOVE_XSS)
				$this->UserFinishPendding->AdvancedSearch->SearchValue = HtmlDecode($this->UserFinishPendding->AdvancedSearch->SearchValue);
			$this->UserFinishPendding->EditValue = HtmlEncode($this->UserFinishPendding->AdvancedSearch->SearchValue);
			$this->UserFinishPendding->PlaceHolder = RemoveHtml($this->UserFinishPendding->caption());

			// DateTimeFinishPedding
			$this->DateTimeFinishPedding->EditAttrs["class"] = "form-control";
			$this->DateTimeFinishPedding->EditCustomAttributes = "";
			$this->DateTimeFinishPedding->EditValue = HtmlEncode(FormatDateTime(UnFormatDateTime($this->DateTimeFinishPedding->AdvancedSearch->SearchValue, 11), 11));
			$this->DateTimeFinishPedding->PlaceHolder = RemoveHtml($this->DateTimeFinishPedding->caption());
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\" ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"ew.export(document.ftbl_palletlist,'" . CurrentPageName() . "','excel',true,true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"javascript:void(0);\" class=\" ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"ew.export(document.ftbl_palletlist,'" . CurrentPageName() . "','excel',false,true);\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\" ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"ew.export(document.ftbl_palletlist,'" . CurrentPageName() . "','word',true,true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"javascript:void(0);\" class=\" ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"ew.export(document.ftbl_palletlist,'" . CurrentPageName() . "','word',false,true);\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\" ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"ew.export(document.ftbl_palletlist,'" . CurrentPageName() . "','pdf',true,true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
				return "<a href=\"javascript:void(0);\" class=\" ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"ew.export(document.ftbl_palletlist,'" . CurrentPageName() . "','pdf',false,true);\">" . $Language->phrase("ExportToPDF") . "</a>";
		} elseif (SameText($type, "html")) {
			return "<a href=\"javascript:void(0);\" class=\" ew-html\" title=\"" . HtmlEncode($Language->phrase("ExportToHtmlText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToHtmlText")) . "\" onclick=\"ew.export(document.ftbl_palletlist,'" . CurrentPageName() . "','html',false,true);\">" . $Language->phrase("ExportToHtml") . "</a>";
		} elseif (SameText($type, "xml")) {
			return "<a href=\"javascript:void(0);\" class=\" ew-xml\" title=\"" . HtmlEncode($Language->phrase("ExportToXmlText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToXmlText")) . "\" onclick=\"ew.export(document.ftbl_palletlist,'" . CurrentPageName() . "','xml',false,true);\">" . $Language->phrase("ExportToXml") . "</a>";
		} elseif (SameText($type, "csv")) {
			return "<a href=\"javascript:void(0);\" class=\" ew-csv\" title=\"" . HtmlEncode($Language->phrase("ExportToCsvText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToCsvText")) . "\" onclick=\"ew.export(document.ftbl_palletlist,'" . CurrentPageName() . "','csv',false,true);\">" . $Language->phrase("ExportToCsv") . "</a>";
		} elseif (SameText($type, "print")) {
			return "<a href=\"javascript:void(0);\" class=\" ew-print\" title=\"" . HtmlEncode($Language->phrase("PrinterFriendlyText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("PrinterFriendlyText")) . "\" onclick=\"ew.export(document.ftbl_palletlist,'" . CurrentPageName() . "','print',false,true);\">" . $Language->phrase("PrinterFriendly") . "</a>";
		}
	}
	...
	protected function setupExportOptions()
	{
		...
		$url = "";
		$item->Body = "<button id=\"emf_tbl_pallet\" class=\"ew-export-link ew-email\" title=\"" . $Language->phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->phrase("ExportToEmailText") . "\" onclick=\"ew.emailDialogShow({lnk:'emf_tbl_pallet',hdr:ew.language.phrase('ExportToEmailText'),f:document.ftbl_palletlist,sel:true" . $url . "});\">" . $Language->phrase("ExportToEmail") . "</button>";
		$item->Visible = FALSE;
