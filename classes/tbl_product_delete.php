 ...
 * Page class
 */
class tbl_product_delete extends tbl_product
{
	...
	// Page object name
	public $PageObjName = "tbl_product_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("tbl_productlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("tbl_productlist.php"); // Return to list
			}
		}
	}
