 ...
 * Page class
 */
class tbl_product_edit extends tbl_product
{
	...
	// Page object name
	public $PageObjName = "tbl_product_edit";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			// Load key from Form
			if ($CurrentForm->hasValue("x_Code")) {
				$this->Code->setFormValue($CurrentForm->getValue("x_Code"));
			}
		} else {
