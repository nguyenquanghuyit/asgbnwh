 ...
 * Page class
 */
class tbl_product_view extends tbl_product
{
	...
	// Page object name
	public $PageObjName = "tbl_product_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("Code") !== NULL) {
				...
				$this->Code->setQueryStringValue(Key(0));
				$this->RecKey["Code"] = $this->Code->QueryStringValue;
			} elseif (Post("Code") !== NULL) {
				$this->Code->setFormValue(Post("Code"));
				$this->RecKey["Code"] = $this->Code->FormValue;
			} elseif (IsApi() && Route(2) != NULL) {
				$this->Code->setFormValue(Route(2));
				$this->RecKey["Code"] = $this->Code->FormValue;
			} else {
				$returnUrl = "tbl_productlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "tbl_productlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "tbl_productlist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
