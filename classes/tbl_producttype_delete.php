 ...
 * Page class
 */
class tbl_producttype_delete extends tbl_producttype
{
	...
	// Page object name
	public $PageObjName = "tbl_producttype_delete";
	...
	public function run()
	{
		...
		if (!$validRequest) {
			...
			if (!$Security->canDelete()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("tbl_producttypelist.php"));
				else
		...
		if ($filter == "") {
			$this->terminate("tbl_producttypelist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("tbl_producttypelist.php"); // Return to list
			}
		}
	}
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("tbl_producttypelist.php"), "", $this->TableVar, TRUE);
		$pageId = "delete";
