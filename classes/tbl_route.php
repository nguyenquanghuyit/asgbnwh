...
/**
 * Table class for tbl_route
 */
class tbl_route extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'tbl_route';
		$this->TableName = 'tbl_route';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`tbl_route`";
		$this->Dbid = 'DB';
		...
		// ID_Route
		$this->ID_Route = new DbField('tbl_route', 'tbl_route', 'x_ID_Route', 'ID_Route', '`ID_Route`', '`ID_Route`', 3, -1, FALSE, '`ID_Route`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// RouteName
		$this->RouteName = new DbField('tbl_route', 'tbl_route', 'x_RouteName', 'RouteName', '`RouteName`', '`RouteName`', 200, -1, FALSE, '`RouteName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->RouteName->Required = TRUE; // Required field
		...
		$this->RouteName->Lookup = new Lookup('RouteName', 'tbl_route', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
		$this->RouteName->OptionCount = 1;
		$this->fields['RouteName'] = &$this->RouteName;

		// TruckNo
		$this->TruckNo = new DbField('tbl_route', 'tbl_route', 'x_TruckNo', 'TruckNo', '`TruckNo`', '`TruckNo`', 200, -1, FALSE, '`TruckNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TruckNo->Sortable = TRUE; // Allow sort
		$this->fields['TruckNo'] = &$this->TruckNo;

		// DriverName
		$this->DriverName = new DbField('tbl_route', 'tbl_route', 'x_DriverName', 'DriverName', '`DriverName`', '`DriverName`', 200, -1, FALSE, '`DriverName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DriverName->Sortable = TRUE; // Allow sort
		$this->fields['DriverName'] = &$this->DriverName;

		// DriverMobile
		$this->DriverMobile = new DbField('tbl_route', 'tbl_route', 'x_DriverMobile', 'DriverMobile', '`DriverMobile`', '`DriverMobile`', 200, -1, FALSE, '`DriverMobile`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DriverMobile->Sortable = TRUE; // Allow sort
		$this->fields['DriverMobile'] = &$this->DriverMobile;

		// InvoiceNo
		$this->InvoiceNo = new DbField('tbl_route', 'tbl_route', 'x_InvoiceNo', 'InvoiceNo', '`InvoiceNo`', '`InvoiceNo`', 200, -1, FALSE, '`InvoiceNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->InvoiceNo->Sortable = TRUE; // Allow sort
		$this->fields['InvoiceNo'] = &$this->InvoiceNo;

		// InvoiceDate
		$this->InvoiceDate = new DbField('tbl_route', 'tbl_route', 'x_InvoiceDate', 'InvoiceDate', '`InvoiceDate`', CastDateFieldForLike('`InvoiceDate`', 7, "DB"), 135, 7, FALSE, '`InvoiceDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CreateUser
		$this->CreateUser = new DbField('tbl_route', 'tbl_route', 'x_CreateUser', 'CreateUser', '`CreateUser`', '`CreateUser`', 200, -1, FALSE, '`CreateUser`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CreateUser->Sortable = TRUE; // Allow sort
		$this->fields['CreateUser'] = &$this->CreateUser;

		// CreateDate
		$this->CreateDate = new DbField('tbl_route', 'tbl_route', 'x_CreateDate', 'CreateDate', '`CreateDate`', CastDateFieldForLike('`CreateDate`', 11, "DB"), 135, 11, FALSE, '`CreateDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// UpdateUser
		$this->UpdateUser = new DbField('tbl_route', 'tbl_route', 'x_UpdateUser', 'UpdateUser', '`UpdateUser`', '`UpdateUser`', 200, -1, FALSE, '`UpdateUser`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->UpdateUser->Sortable = FALSE; // Allow sort
		$this->fields['UpdateUser'] = &$this->UpdateUser;

		// UpdateDate
		$this->UpdateDate = new DbField('tbl_route', 'tbl_route', 'x_UpdateDate', 'UpdateDate', '`UpdateDate`', CastDateFieldForLike('`UpdateDate`', 0, "DB"), 135, 0, FALSE, '`UpdateDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// InOrOut
		$this->InOrOut = new DbField('tbl_route', 'tbl_route', 'x_InOrOut', 'InOrOut', '`InOrOut`', '`InOrOut`', 200, -1, FALSE, '`InOrOut`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->InOrOut->Sortable = FALSE; // Allow sort
		$this->fields['InOrOut'] = &$this->InOrOut;

		// FinishUnload
		$this->FinishUnload = new DbField('tbl_route', 'tbl_route', 'x_FinishUnload', 'FinishUnload', '`FinishUnload`', '`FinishUnload`', 16, -1, FALSE, '`FinishUnload`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->FinishUnload->Sortable = TRUE; // Allow sort
		...
		$this->FinishUnload->Lookup = new Lookup('FinishUnload', 'tbl_route', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
		...
		// SealNo
		$this->SealNo = new DbField('tbl_route', 'tbl_route', 'x_SealNo', 'SealNo', '`SealNo`', '`SealNo`', 200, -1, FALSE, '`SealNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SealNo->Sortable = TRUE; // Allow sort
		$this->fields['SealNo'] = &$this->SealNo;

		// DepartureTime
		$this->DepartureTime = new DbField('tbl_route', 'tbl_route', 'x_DepartureTime', 'DepartureTime', '`DepartureTime`', CastDateFieldForLike('`DepartureTime`', 0, "DB"), 135, 0, FALSE, '`DepartureTime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DepartureTime->Sortable = FALSE; // Allow sort
		$this->DepartureTime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['DepartureTime'] = &$this->DepartureTime;

		// FinishLoading
		$this->FinishLoading = new DbField('tbl_route', 'tbl_route', 'x_FinishLoading', 'FinishLoading', '`FinishLoading`', '`FinishLoading`', 16, -1, FALSE, '`FinishLoading`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->FinishLoading->Sortable = FALSE; // Allow sort
		$this->FinishLoading->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['FinishLoading'] = &$this->FinishLoading;

		// AttachFile
		$this->AttachFile = new DbField('tbl_route', 'tbl_route', 'x_AttachFile', 'AttachFile', '`AttachFile`', '`AttachFile`', 200, -1, TRUE, '`AttachFile`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->AttachFile->Sortable = TRUE; // Allow sort
		$this->fields['AttachFile'] = &$this->AttachFile;

		// LoadingID
		$this->LoadingID = new DbField('tbl_route', 'tbl_route', 'x_LoadingID', 'LoadingID', '`LoadingID`', '`LoadingID`', 200, -1, FALSE, '`LoadingID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->LoadingID->Sortable = TRUE; // Allow sort
		$this->fields['LoadingID'] = &$this->LoadingID;

		// Id_Type
		$this->Id_Type = new DbField('tbl_route', 'tbl_route', 'x_Id_Type', 'Id_Type', '`Id_Type`', '`Id_Type`', 200, -1, FALSE, '`Id_Type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getDetailUrl()
	{
		...
		// Detail url
		$detailUrl = "";
		if ($this->getCurrentDetailTable() == "vwRouteUnload") {
			$detailUrl = $GLOBALS["vwRouteUnload"]->getListUrl() . "?" . TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$detailUrl .= "&fk_ID_Route=" . urlencode($this->ID_Route->CurrentValue);
		}
		if ($detailUrl == "")
			$detailUrl = "tbl_routelist.php";
		return $detailUrl;
	}
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`tbl_route`";
	}
	...
	protected function loadDbValues(&$rs)
	{
		...
		$this->FinishLoading->DbValue = $row['FinishLoading'];
		$this->AttachFile->Upload->DbValue = $row['AttachFile'];
		$this->LoadingID->DbValue = $row['LoadingID'];
	...
	public function deleteUploadedFiles($row)
	{
		...
		$oldFiles = EmptyValue($row['AttachFile']) ? [] : [$row['AttachFile']];
		foreach ($oldFiles as $oldFile) {
			if (file_exists($this->AttachFile->oldPhysicalUploadPath() . $oldFile))
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "tbl_routeedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "tbl_routeadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("tbl_routeview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("tbl_routeview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "tbl_routeadd.php?" . $this->getUrlParm($parm);
		else
			$url = "tbl_routeadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("tbl_routeedit.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("tbl_routeedit.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
		return $this->addMasterUrl($url);
	}
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("tbl_routeadd.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("tbl_routeadd.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("tbl_routedelete.php", $this->getUrlParm());
	}
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->FinishLoading->setDbValue($rs->fields('FinishLoading'));
		$this->AttachFile->Upload->DbValue = $rs->fields('AttachFile');
		$this->LoadingID->setDbValue($rs->fields('LoadingID'));
	...
	public function renderListRow()
	{
		...
		$this->DepartureTime->ViewValue = FormatDateTime($this->DepartureTime->ViewValue, 0);
		$this->DepartureTime->ViewCustomAttributes = "";

		// FinishLoading
		$this->FinishLoading->ViewValue = $this->FinishLoading->CurrentValue;
		$this->FinishLoading->ViewValue = FormatNumber($this->FinishLoading->ViewValue, 0, -2, -2, -2);
		$this->FinishLoading->ViewCustomAttributes = "";
		...
		// FinishLoading
		$this->FinishLoading->LinkCustomAttributes = "";
		$this->FinishLoading->HrefValue = "";
		$this->FinishLoading->TooltipValue = "";
	...
	public function renderEditRow()
	{
		...
		// DepartureTime
		$this->DepartureTime->EditAttrs["class"] = "form-control";
		$this->DepartureTime->EditCustomAttributes = "";
		$this->DepartureTime->EditValue = FormatDateTime($this->DepartureTime->CurrentValue, 8);
		$this->DepartureTime->PlaceHolder = RemoveHtml($this->DepartureTime->caption());

		// FinishLoading
		$this->FinishLoading->EditAttrs["class"] = "form-control";
		$this->FinishLoading->EditCustomAttributes = "";
		$this->FinishLoading->EditValue = $this->FinishLoading->CurrentValue;
		$this->FinishLoading->PlaceHolder = RemoveHtml($this->FinishLoading->caption());
		...
		$this->LoadingID->EditValue = $this->LoadingID->CurrentValue;
		...
		if (!$doc->ExportCustom) {
			...
			if ($doc->Horizontal) { // Horizontal format, write header
				...
				if ($exportPageType == "view") {
					...
					$doc->exportCaption($this->FinishUnload);
					$doc->exportCaption($this->SealNo);
					$doc->exportCaption($this->AttachFile);
					$doc->exportCaption($this->LoadingID);
			...
			if ($recCnt >= $startRec) {
				...
				if (!$doc->ExportCustom) {
					...
					if ($exportPageType == "view") {
						...
						$doc->exportField($this->FinishUnload);
						$doc->exportField($this->SealNo);
						$doc->exportField($this->AttachFile);
						$doc->exportField($this->LoadingID);
	...
	public function getFileData($fldparm, $key, $resize, $width = THUMBNAIL_DEFAULT_WIDTH, $height = THUMBNAIL_DEFAULT_HEIGHT)
	{
		...
		$fileNameFld = "";
		$fileTypeFld = "";
		if ($fldparm == 'AttachFile') {
			$fldName = "AttachFile";
			$fileNameFld = "AttachFile";
		} else {
		...
		if (count($ar) == 1) {
			$this->ID_Route->CurrentValue = $ar[0];
		} else {
