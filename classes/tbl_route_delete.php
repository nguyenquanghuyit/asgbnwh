 ...
 * Page class
 */
class tbl_route_delete extends tbl_route
{
	...
	// Page object name
	public $PageObjName = "tbl_route_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("tbl_routelist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("tbl_routelist.php"); // Return to list
			}
		}
	}
