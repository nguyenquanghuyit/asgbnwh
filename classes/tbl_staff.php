...
/**
 * Table class for tbl_staff
 */
class tbl_staff extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'tbl_staff';
		$this->TableName = 'tbl_staff';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`tbl_staff`";
		$this->Dbid = 'DB';
		...
		// Ma_NV
		$this->Ma_NV = new DbField('tbl_staff', 'tbl_staff', 'x_Ma_NV', 'Ma_NV', '`Ma_NV`', '`Ma_NV`', 200, -1, FALSE, '`Ma_NV`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// hoVaTen
		$this->hoVaTen = new DbField('tbl_staff', 'tbl_staff', 'x_hoVaTen', 'hoVaTen', '`hoVaTen`', '`hoVaTen`', 200, -1, FALSE, '`hoVaTen`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->hoVaTen->Sortable = TRUE; // Allow sort
		$this->fields['hoVaTen'] = &$this->hoVaTen;

		// gioiTinh
		$this->gioiTinh = new DbField('tbl_staff', 'tbl_staff', 'x_gioiTinh', 'gioiTinh', '`gioiTinh`', '`gioiTinh`', 200, -1, FALSE, '`gioiTinh`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->gioiTinh->Lookup = new Lookup('gioiTinh', 'tbl_staff', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
		$this->gioiTinh->OptionCount = 2;
		$this->fields['gioiTinh'] = &$this->gioiTinh;

		// ngaySinh
		$this->ngaySinh = new DbField('tbl_staff', 'tbl_staff', 'x_ngaySinh', 'ngaySinh', '`ngaySinh`', CastDateFieldForLike('`ngaySinh`', 7, "DB"), 133, 7, FALSE, '`ngaySinh`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// emailCaNhan
		$this->emailCaNhan = new DbField('tbl_staff', 'tbl_staff', 'x_emailCaNhan', 'emailCaNhan', '`emailCaNhan`', '`emailCaNhan`', 200, -1, FALSE, '`emailCaNhan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->emailCaNhan->Sortable = TRUE; // Allow sort
		$this->fields['emailCaNhan'] = &$this->emailCaNhan;

		// TD_ID
		$this->TD_ID = new DbField('tbl_staff', 'tbl_staff', 'x_TD_ID', 'TD_ID', '`TD_ID`', '`TD_ID`', 3, -1, FALSE, '`EV__TD_ID`', TRUE, TRUE, TRUE, 'FORMATTED TEXT', 'TEXT');
		$this->TD_ID->Sortable = TRUE; // Allow sort
		$this->TD_ID->Lookup = new Lookup('TD_ID', 'tbl_group', FALSE, 'TD_ID', ["TD_Tendd","","",""], [], [], [], [], [], [], '', '');
		$this->TD_ID->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['TD_ID'] = &$this->TD_ID;

		// PB_ID
		$this->PB_ID = new DbField('tbl_staff', 'tbl_staff', 'x_PB_ID', 'PB_ID', '`PB_ID`', '`PB_ID`', 3, -1, FALSE, '`EV__PB_ID`', TRUE, TRUE, TRUE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`tbl_staff`";
	}
	...
	public function getSqlSelectList() // Select for List page
	{
		$select = "";
		$select = "SELECT * FROM (" .
			"SELECT *, (SELECT `TD_Tendd` FROM `tbl_group` `TMP_LOOKUPTABLE` WHERE `TMP_LOOKUPTABLE`.`TD_ID` = `tbl_staff`.`TD_ID` LIMIT 1) AS `EV__TD_ID`, (SELECT `PB_Tendd` FROM `tbl_department` `TMP_LOOKUPTABLE` WHERE `TMP_LOOKUPTABLE`.`PB_ID` = `tbl_staff`.`PB_ID` LIMIT 1) AS `EV__PB_ID` FROM `tbl_staff`" .
			") `TMP_TABLE`";
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "tbl_staffedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "tbl_staffadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("tbl_staffview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("tbl_staffview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "tbl_staffadd.php?" . $this->getUrlParm($parm);
		else
			$url = "tbl_staffadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("tbl_staffedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("tbl_staffadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("tbl_staffdelete.php", $this->getUrlParm());
	}
