 ...
 * Page class
 */
class tbl_staff_delete extends tbl_staff
{
	...
	// Page object name
	public $PageObjName = "tbl_staff_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("tbl_stafflist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("tbl_stafflist.php"); // Return to list
			}
		}
	}
