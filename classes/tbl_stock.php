...
/**
 * Table class for tbl_stock
 */
class tbl_stock extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'tbl_stock';
		$this->TableName = 'tbl_stock';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`tbl_stock`";
		$this->Dbid = 'DB';
		...
		// ID_Stock
		$this->ID_Stock = new DbField('tbl_stock', 'tbl_stock', 'x_ID_Stock', 'ID_Stock', '`ID_Stock`', '`ID_Stock`', 3, -1, FALSE, '`ID_Stock`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->ID_Stock->IsAutoIncrement = TRUE; // Autoincrement field
		$this->ID_Stock->IsPrimaryKey = TRUE; // Primary key field
		...
		// PalletID
		$this->PalletID = new DbField('tbl_stock', 'tbl_stock', 'x_PalletID', 'PalletID', '`PalletID`', '`PalletID`', 200, -1, FALSE, '`PalletID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PalletID->Sortable = TRUE; // Allow sort
		$this->fields['PalletID'] = &$this->PalletID;

		// Code
		$this->Code = new DbField('tbl_stock', 'tbl_stock', 'x_Code', 'Code', '`Code`', '`Code`', 200, -1, FALSE, '`Code`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Code->Required = TRUE; // Required field
		$this->Code->Sortable = TRUE; // Allow sort
		$this->fields['Code'] = &$this->Code;

		// IdType
		$this->IdType = new DbField('tbl_stock', 'tbl_stock', 'x_IdType', 'IdType', '`IdType`', '`IdType`', 200, -1, FALSE, '`IdType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// ID_Location
		$this->ID_Location = new DbField('tbl_stock', 'tbl_stock', 'x_ID_Location', 'ID_Location', '`ID_Location`', '`ID_Location`', 3, -1, FALSE, '`EV__ID_Location`', TRUE, TRUE, TRUE, 'FORMATTED TEXT', 'TEXT');
		...
		// Pcs_RemainPicking
		$this->Pcs_RemainPicking = new DbField('tbl_stock', 'tbl_stock', 'x_Pcs_RemainPicking', 'Pcs_RemainPicking', '`Pcs_RemainPicking`', '`Pcs_RemainPicking`', 3, -1, FALSE, '`Pcs_RemainPicking`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PCS
		$this->PCS = new DbField('tbl_stock', 'tbl_stock', 'x_PCS', 'PCS', '`PCS`', '`PCS`', 3, -1, FALSE, '`PCS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PCS->Required = TRUE; // Required field
		$this->PCS->Sortable = FALSE; // Allow sort
		$this->PCS->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['PCS'] = &$this->PCS;

		// MFG
		$this->MFG = new DbField('tbl_stock', 'tbl_stock', 'x_MFG', 'MFG', '`MFG`', CastDateFieldForLike('`MFG`', 7, "DB"), 133, 7, FALSE, '`MFG`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DateIn
		$this->DateIn = new DbField('tbl_stock', 'tbl_stock', 'x_DateIn', 'DateIn', '`DateIn`', CastDateFieldForLike('`DateIn`', 11, "DB"), 135, 11, FALSE, '`DateIn`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DateIn->Required = TRUE; // Required field
		...
		// Imp_id
		$this->Imp_id = new DbField('tbl_stock', 'tbl_stock', 'x_Imp_id', 'Imp_id', '`Imp_id`', '`Imp_id`', 200, -1, FALSE, '`Imp_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Imp_id->Sortable = FALSE; // Allow sort
		$this->fields['Imp_id'] = &$this->Imp_id;

		// User_ID
		$this->User_ID = new DbField('tbl_stock', 'tbl_stock', 'x_User_ID', 'User_ID', '`User_ID`', '`User_ID`', 200, -1, FALSE, '`User_ID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->User_ID->Sortable = FALSE; // Allow sort
		$this->fields['User_ID'] = &$this->User_ID;

		// Note_PalletId
		$this->Note_PalletId = new DbField('tbl_stock', 'tbl_stock', 'x_Note_PalletId', 'Note_PalletId', '`Note_PalletId`', '`Note_PalletId`', 200, -1, FALSE, '`Note_PalletId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Note_PalletId->Sortable = TRUE; // Allow sort
		$this->fields['Note_PalletId'] = &$this->Note_PalletId;

		// CreateUser
		$this->CreateUser = new DbField('tbl_stock', 'tbl_stock', 'x_CreateUser', 'CreateUser', '`CreateUser`', '`CreateUser`', 200, -1, FALSE, '`CreateUser`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CreateUser->Sortable = TRUE; // Allow sort
		$this->fields['CreateUser'] = &$this->CreateUser;

		// CreateDate
		$this->CreateDate = new DbField('tbl_stock', 'tbl_stock', 'x_CreateDate', 'CreateDate', '`CreateDate`', CastDateFieldForLike('`CreateDate`', 11, "DB"), 135, 11, FALSE, '`CreateDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// UpdateUser
		$this->UpdateUser = new DbField('tbl_stock', 'tbl_stock', 'x_UpdateUser', 'UpdateUser', '`UpdateUser`', '`UpdateUser`', 200, -1, FALSE, '`UpdateUser`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->UpdateUser->Sortable = FALSE; // Allow sort
		$this->fields['UpdateUser'] = &$this->UpdateUser;

		// UpdateDate
		$this->UpdateDate = new DbField('tbl_stock', 'tbl_stock', 'x_UpdateDate', 'UpdateDate', '`UpdateDate`', CastDateFieldForLike('`UpdateDate`', 0, "DB"), 135, 0, FALSE, '`UpdateDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// StatusPicking
		$this->StatusPicking = new DbField('tbl_stock', 'tbl_stock', 'x_StatusPicking', 'StatusPicking', '`StatusPicking`', '`StatusPicking`', 16, -1, FALSE, '`StatusPicking`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->StatusPicking->Sortable = FALSE; // Allow sort
		$this->StatusPicking->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->StatusPicking->PleaseSelectText = $Language->phrase("PleaseSelect"); // PleaseSelect text
		$this->StatusPicking->Lookup = new Lookup('StatusPicking', 'tbl_stock', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
		$this->StatusPicking->OptionCount = 2;
		$this->StatusPicking->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->StatusPicking->AdvancedSearch->SearchValueDefault = 0;
		$this->StatusPicking->AdvancedSearch->SearchOperatorDefault = "=";
		$this->StatusPicking->AdvancedSearch->SearchOperatorDefault2 = "";
		$this->StatusPicking->AdvancedSearch->SearchConditionDefault = "AND";
		$this->fields['StatusPicking'] = &$this->StatusPicking;
	}
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`tbl_stock`";
	}
	...
	public function getSqlSelectList() // Select for List page
	{
		$select = "";
		$select = "SELECT * FROM (" .
			"SELECT *, (SELECT `Location` FROM `tbl_location` `TMP_LOOKUPTABLE` WHERE `TMP_LOOKUPTABLE`.`ID_Location` = `tbl_stock`.`ID_Location` LIMIT 1) AS `EV__ID_Location` FROM `tbl_stock`" .
			") `TMP_TABLE`";
	...
	public function getSqlWhere() // Where
	{
		...
		$this->TableFilter = "`Pcs_RemainPicking`!=0";
	...
	{
		return ($this->SqlOrderBy <> "") ? $this->SqlOrderBy : "`DateIn` DESC,`ID_Location` ASC";
	}
	...
	public function insert(&$rs)
	{
		...
		if ($success) {
			...
			$this->ID_Stock->setDbValue($conn->insert_ID());
			$rs['ID_Stock'] = $this->ID_Stock->DbValue;
	...
	protected function deleteSql(&$rs, $where = "", $curfilter = TRUE)
	{
		...
		if (is_array($where))
			$where = $this->arrayToFilter($where);
		if ($rs) {
			if (array_key_exists('ID_Stock', $rs))
				AddFilter($where, QuotedName('ID_Stock', $this->Dbid) . '=' . QuotedValue($rs['ID_Stock'], $this->ID_Stock->DataType, $this->Dbid));
		}
		$filter = ($curfilter) ? $this->CurrentFilter : "";
		AddFilter($filter, $where);
		if ($filter <> "")
	...
	protected function loadDbValues(&$rs)
	{
		...
		$this->StatusPicking->DbValue = $row['StatusPicking'];
	}
	...
	public function getRecordFilter($row = NULL)
	{
		...
		$val = is_array($row) ? (array_key_exists('ID_Stock', $row) ? $row['ID_Stock'] : NULL) : $this->ID_Stock->CurrentValue;
		if (!is_numeric($val))
			return "0=1"; // Invalid key
		if ($val == NULL)
			return "0=1"; // Invalid key
		else
			$keyFilter = str_replace("@ID_Stock@", AdjustSql($val, $this->Dbid), $keyFilter); // Replace key value
		return $keyFilter;
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "tbl_stockedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "tbl_stockadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("tbl_stockview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("tbl_stockview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "tbl_stockadd.php?" . $this->getUrlParm($parm);
		else
			$url = "tbl_stockadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("tbl_stockedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("tbl_stockadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("tbl_stockdelete.php", $this->getUrlParm());
	}
	...
	{
		$json = "";
		$json .= "ID_Stock:" . JsonEncode($this->ID_Stock->CurrentValue, "number");
		$json = "{" . $json . "}";
		if ($htmlEncode)
	...
	public function keyUrl($url, $parm = "")
	{
		...
		if ($parm <> "")
			$url .= $parm . "&";
		if ($this->ID_Stock->CurrentValue != NULL) {
			$url .= "ID_Stock=" . urlencode($this->ID_Stock->CurrentValue);
		} else {
	...
	public function getRecordKeys()
	{
		...
		if (Param("key_m") !== NULL) {
			...
			if (Param("ID_Stock") !== NULL)
				$arKeys[] = Param("ID_Stock");
	...
	public function getFilterFromRecordKeys()
	{
		...
		foreach ($arKeys as $key) {
			...
			$this->ID_Stock->CurrentValue = $key;
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->StatusPicking->setDbValue($rs->fields('StatusPicking'));
	}
	...
	public function renderListRow()
	{
		...
		// StatusPicking
		if (strval($this->StatusPicking->CurrentValue) <> "") {
			$this->StatusPicking->ViewValue = $this->StatusPicking->optionCaption($this->StatusPicking->CurrentValue);
		} else {
			$this->StatusPicking->ViewValue = NULL;
		}
		$this->StatusPicking->CellCssStyle .= "text-align: center;";
		$this->StatusPicking->ViewCustomAttributes = "";
		...
		// StatusPicking
		$this->StatusPicking->LinkCustomAttributes = "";
		$this->StatusPicking->HrefValue = "";
		$this->StatusPicking->TooltipValue = "";
	...
	public function renderEditRow()
	{
		...
		// StatusPicking
		$this->StatusPicking->EditAttrs["class"] = "form-control";
		$this->StatusPicking->EditCustomAttributes = "";
		$this->StatusPicking->EditValue = $this->StatusPicking->options(TRUE);
	...
	public function exportDocument($doc, $recordset, $startRec = 1, $stopRec = 1, $exportPageType = "")
	{
		...
		if ($doc->Horizontal) {
			...
			if (!$doc->ExportCustom) {
				...
				$doc->exportAggregate($this->IdType, '');
