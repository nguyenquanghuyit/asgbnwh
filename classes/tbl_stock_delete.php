 ...
 * Page class
 */
class tbl_stock_delete extends tbl_stock
{
	...
	// Page object name
	public $PageObjName = "tbl_stock_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("tbl_stocklist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("tbl_stocklist.php"); // Return to list
			}
		}
	}
