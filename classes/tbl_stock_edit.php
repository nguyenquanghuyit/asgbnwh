 ...
 * Page class
 */
class tbl_stock_edit extends tbl_stock
{
	...
	// Page object name
	public $PageObjName = "tbl_stock_edit";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			// Load key from Form
			if ($CurrentForm->hasValue("x_ID_Stock")) {
				$this->ID_Stock->setFormValue($CurrentForm->getValue("x_ID_Stock"));
			}
		} else {
