 ...
 * Page class
 */
class tbl_unload_delete extends tbl_unload
{
	...
	// Page object name
	public $PageObjName = "tbl_unload_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("tbl_unloadlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("tbl_unloadlist.php"); // Return to list
			}
		}
	}
