 ...
 * Page class
 */
class tbl_unload_edit extends tbl_unload
{
	...
	// Page object name
	public $PageObjName = "tbl_unload_edit";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			// Load key from Form
			if ($CurrentForm->hasValue("x_ID_Unload")) {
				$this->ID_Unload->setFormValue($CurrentForm->getValue("x_ID_Unload"));
			}
		} else {
