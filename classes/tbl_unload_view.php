 ...
 * Page class
 */
class tbl_unload_view extends tbl_unload
{
	...
	// Page object name
	public $PageObjName = "tbl_unload_view";
	...
	public function __construct()
	{
		...
		if (Get("ID_Unload") !== NULL) {
			$this->RecKey["ID_Unload"] = Get("ID_Unload");
			$keyUrl .= "&amp;ID_Unload=" . urlencode($this->RecKey["ID_Unload"]);
		}
	...
	public function run()
	{
		...
		$this->UserUnload->setVisibility();
		$this->DateTime_Insert->setVisibility();
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("ID_Unload") !== NULL) {
				...
				$this->RecKey["ID_Unload"] = $this->ID_Unload->QueryStringValue;
			} elseif (IsApi() && Key(0) != NULL) {
				$this->ID_Unload->setQueryStringValue(Key(0));
				$this->RecKey["ID_Unload"] = $this->ID_Unload->QueryStringValue;
			} elseif (Post("ID_Unload") !== NULL) {
				$this->ID_Unload->setFormValue(Post("ID_Unload"));
				$this->RecKey["ID_Unload"] = $this->ID_Unload->FormValue;
			} elseif (IsApi() && Route(2) != NULL) {
				$this->ID_Unload->setFormValue(Route(2));
				$this->RecKey["ID_Unload"] = $this->ID_Unload->FormValue;
			} else {
				$returnUrl = "tbl_unloadlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "tbl_unloadlist.php"; // No matching record, return to list
					}
			}
			...
			$returnUrl = "tbl_unloadlist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"ew.export(document.ftbl_unloadview,'" . $this->ExportExcelUrl . "','excel',true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"ew.export(document.ftbl_unloadview,'" . $this->ExportWordUrl . "','word',true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"ew.export(document.ftbl_unloadview,'" . $this->ExportPdfUrl . "','pdf',true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
