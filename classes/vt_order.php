...
/**
 * Table class for vt_order
 */
class vt_order extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'vt_order';
		$this->TableName = 'vt_order';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`vt_order`";
		$this->Dbid = 'DB';
		...
		// ID_Order
		$this->ID_Order = new DbField('vt_order', 'vt_order', 'x_ID_Order', 'ID_Order', '`ID_Order`', '`ID_Order`', 3, -1, FALSE, '`ID_Order`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// OrderDate
		$this->OrderDate = new DbField('vt_order', 'vt_order', 'x_OrderDate', 'OrderDate', '`OrderDate`', CastDateFieldForLike('`OrderDate`', 7, "DB"), 135, 7, FALSE, '`OrderDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ContactName
		$this->ContactName = new DbField('vt_order', 'vt_order', 'x_ContactName', 'ContactName', '`ContactName`', '`ContactName`', 200, -1, FALSE, '`ContactName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ContactName->Sortable = TRUE; // Allow sort
		$this->fields['ContactName'] = &$this->ContactName;

		// Address
		$this->Address = new DbField('vt_order', 'vt_order', 'x_Address', 'Address', '`Address`', '`Address`', 200, -1, FALSE, '`Address`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Address->Sortable = TRUE; // Allow sort
		$this->fields['Address'] = &$this->Address;

		// CompanyName
		$this->CompanyName = new DbField('vt_order', 'vt_order', 'x_CompanyName', 'CompanyName', '`CompanyName`', '`CompanyName`', 200, -1, FALSE, '`CompanyName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CompanyName->Sortable = TRUE; // Allow sort
		$this->fields['CompanyName'] = &$this->CompanyName;

		// ContactEmail
		$this->ContactEmail = new DbField('vt_order', 'vt_order', 'x_ContactEmail', 'ContactEmail', '`ContactEmail`', '`ContactEmail`', 200, -1, FALSE, '`ContactEmail`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ContactEmail->Sortable = TRUE; // Allow sort
		$this->fields['ContactEmail'] = &$this->ContactEmail;

		// ContactPhone
		$this->ContactPhone = new DbField('vt_order', 'vt_order', 'x_ContactPhone', 'ContactPhone', '`ContactPhone`', '`ContactPhone`', 200, -1, FALSE, '`ContactPhone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getDetailUrl()
	{
		...
		// Detail url
		$detailUrl = "";
		if ($this->getCurrentDetailTable() == "vt_orderguide") {
			$detailUrl = $GLOBALS["vt_orderguide"]->getListUrl() . "?" . TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$detailUrl .= "&fk_ID_Order=" . urlencode($this->ID_Order->CurrentValue);
		}
		if ($detailUrl == "")
			$detailUrl = "vt_orderlist.php";
		return $detailUrl;
	}
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`vt_order`";
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "vt_orderedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "vt_orderadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("vt_orderview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("vt_orderview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "vt_orderadd.php?" . $this->getUrlParm($parm);
		else
			$url = "vt_orderadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("vt_orderedit.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("vt_orderedit.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
		return $this->addMasterUrl($url);
	}
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("vt_orderadd.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("vt_orderadd.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("vt_orderdelete.php", $this->getUrlParm());
	}
