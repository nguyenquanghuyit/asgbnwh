 ...
 * Page class
 */
class vt_orderguide_grid extends vt_orderguide
{
	...
	// Page object name
	public $PageObjName = "vt_orderguide_grid";

	// Grid form hidden field names
	public $FormName = "fvt_orderguidegrid";
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	protected function loadDefaultValues()
	{
		...
		$this->Pcs_Guide->CurrentValue = NULL;
		$this->Pcs_Guide->OldValue = $this->Pcs_Guide->CurrentValue;
	...
	protected function newRow()
	{
		...
		$row['Pcs_Guide'] = $this->Pcs_Guide->CurrentValue;
	...
	protected function validateForm()
	{
		...
		if ($this->Pcs_Guide->Required) {
			if (!$this->Pcs_Guide->IsDetailKey && $this->Pcs_Guide->FormValue != NULL && $this->Pcs_Guide->FormValue == "") {
				AddMessage($FormError, str_replace("%s", $this->Pcs_Guide->caption(), $this->Pcs_Guide->RequiredErrorMessage));
			}
		}
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "vt_order") {
			$this->ID_Order->Visible = FALSE;
			if ($GLOBALS["vt_order"]->EventCancelled)
