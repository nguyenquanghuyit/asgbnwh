 ...
 * Page class
 */
class vt_orderguide_preview extends vt_orderguide
{
	...
	// Page object name
	public $PageObjName = "vt_orderguide_preview";
	...
	public function run()
	{
		...
		if (!$validRequest) {
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'vt_orderguide');
			if ($Security->isLoggedIn())
	...
	protected function masterKeyUrl()
	{
		...
		if ($masterTblVar == "vt_order") {
			$url = "" . TABLE_SHOW_MASTER . "=vt_order&fk_ID_Order=" . urlencode(strval($this->ID_Order->QueryStringValue)) . "";
		}
		return $url;
	}
