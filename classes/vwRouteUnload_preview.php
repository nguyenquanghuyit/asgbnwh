 ...
 * Page class
 */
class vwRouteUnload_preview extends vwRouteUnload
{
	...
	// Page object name
	public $PageObjName = "vwRouteUnload_preview";
	...
	public function run()
	{
		...
		if (!$validRequest) {
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'vwRouteUnload');
			if ($Security->isLoggedIn())
	...
	protected function masterKeyUrl()
	{
		...
		if ($masterTblVar == "tbl_route") {
			$url = "" . TABLE_SHOW_MASTER . "=tbl_route&fk_ID_Route=" . urlencode(strval($this->ID_Route->QueryStringValue)) . "";
		}
		return $url;
	}
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("vwRouteUnloadlist.php"), "", $this->TableVar, TRUE);
		$pageId = "preview";
