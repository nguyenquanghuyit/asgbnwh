...
/**
 * Table class for vwcode_type
 */
class vwcode_type extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'vwcode_type';
		$this->TableName = 'vwcode_type';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`vwcode_type`";
		$this->Dbid = 'DB';
		...
		// ProductName
		$this->ProductName = new DbField('vwcode_type', 'vwcode_type', 'x_ProductName', 'ProductName', '`ProductName`', '`ProductName`', 200, -1, FALSE, '`ProductName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ProductName->Sortable = TRUE; // Allow sort
		$this->fields['ProductName'] = &$this->ProductName;

		// TypeName
		$this->TypeName = new DbField('vwcode_type', 'vwcode_type', 'x_TypeName', 'TypeName', '`TypeName`', '`TypeName`', 200, -1, FALSE, '`TypeName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TypeName->Sortable = TRUE; // Allow sort
		$this->fields['TypeName'] = &$this->TypeName;

		// Code
		$this->Code = new DbField('vwcode_type', 'vwcode_type', 'x_Code', 'Code', '`Code`', '`Code`', 200, -1, FALSE, '`Code`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// IdType
		$this->IdType = new DbField('vwcode_type', 'vwcode_type', 'x_IdType', 'IdType', '`IdType`', '`IdType`', 200, -1, FALSE, '`IdType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`vwcode_type`";
	}
	...
	{
		global $Language;
		if ($pageName == "vwcode_typeview.php")
			return $Language->phrase("View");
		elseif ($pageName == "vwcode_typeedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "vwcode_typeadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("vwcode_typeview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("vwcode_typeview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "vwcode_typeadd.php?" . $this->getUrlParm($parm);
		else
			$url = "vwcode_typeadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("vwcode_typeedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("vwcode_typeadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("vwcode_typedelete.php", $this->getUrlParm());
	}
