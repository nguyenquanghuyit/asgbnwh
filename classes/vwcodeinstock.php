...
/**
 * Table class for vwcodeinstock
 */
class vwcodeinstock extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'vwcodeinstock';
		$this->TableName = 'vwcodeinstock';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`vwcodeinstock`";
		$this->Dbid = 'DB';
		...
		// Code
		$this->Code = new DbField('vwcodeinstock', 'vwcodeinstock', 'x_Code', 'Code', '`Code`', '`Code`', 200, -1, FALSE, '`Code`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Code->Sortable = TRUE; // Allow sort
		$this->fields['Code'] = &$this->Code;

		// PCS
		$this->PCS = new DbField('vwcodeinstock', 'vwcodeinstock', 'x_PCS', 'PCS', '`PCS`', '`PCS`', 131, -1, FALSE, '`PCS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PCS->Sortable = TRUE; // Allow sort
		$this->PCS->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['PCS'] = &$this->PCS;

		// ProductName
		$this->ProductName = new DbField('vwcodeinstock', 'vwcodeinstock', 'x_ProductName', 'ProductName', '`ProductName`', '`ProductName`', 200, -1, FALSE, '`ProductName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ProductName->Sortable = TRUE; // Allow sort
		$this->fields['ProductName'] = &$this->ProductName;

		// Product
		$this->Product = new DbField('vwcodeinstock', 'vwcodeinstock', 'x_Product', 'Product', '`Product`', '`Product`', 201, -1, FALSE, '`Product`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`vwcodeinstock`";
	}
	...
	{
		global $Language;
		if ($pageName == "vwcodeinstockview.php")
			return $Language->phrase("View");
		elseif ($pageName == "vwcodeinstockedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "vwcodeinstockadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("vwcodeinstockview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("vwcodeinstockview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "vwcodeinstockadd.php?" . $this->getUrlParm($parm);
		else
			$url = "vwcodeinstockadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("vwcodeinstockedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("vwcodeinstockadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("vwcodeinstockdelete.php", $this->getUrlParm());
	}
