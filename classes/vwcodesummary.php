...
/**
 * Table class for vwcodesummary
 */
class vwcodesummary extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'vwcodesummary';
		$this->TableName = 'vwcodesummary';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`vwcodesummary`";
		$this->Dbid = 'DB';
		...
		// Code
		$this->Code = new DbField('vwcodesummary', 'vwcodesummary', 'x_Code', 'Code', '`Code`', '`Code`', 200, -1, FALSE, '`Code`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Code->IsPrimaryKey = TRUE; // Primary key field
		$this->Code->Sortable = TRUE; // Allow sort
		$this->fields['Code'] = &$this->Code;

		// ProductName
		$this->ProductName = new DbField('vwcodesummary', 'vwcodesummary', 'x_ProductName', 'ProductName', '`ProductName`', '`ProductName`', 200, -1, FALSE, '`ProductName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ProductName->Sortable = TRUE; // Allow sort
		$this->fields['ProductName'] = &$this->ProductName;

		// VnName
		$this->VnName = new DbField('vwcodesummary', 'vwcodesummary', 'x_VnName', 'VnName', '`VnName`', '`VnName`', 200, -1, FALSE, '`VnName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->VnName->Sortable = TRUE; // Allow sort
		$this->fields['VnName'] = &$this->VnName;

		// Model
		$this->Model = new DbField('vwcodesummary', 'vwcodesummary', 'x_Model', 'Model', '`Model`', '`Model`', 200, -1, FALSE, '`Model`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Model->Sortable = TRUE; // Allow sort
		$this->fields['Model'] = &$this->Model;

		// PCS
		$this->PCS = new DbField('vwcodesummary', 'vwcodesummary', 'x_PCS', 'PCS', '`PCS`', '`PCS`', 131, -1, FALSE, '`PCS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`vwcodesummary`";
	}
	...
	{
		global $Language;
		if ($pageName == "vwcodesummaryview.php")
			return $Language->phrase("View");
		elseif ($pageName == "vwcodesummaryedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "vwcodesummaryadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("vwcodesummaryview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("vwcodesummaryview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "vwcodesummaryadd.php?" . $this->getUrlParm($parm);
		else
			$url = "vwcodesummaryadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("vwcodesummaryedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("vwcodesummaryadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("vwcodesummarydelete.php", $this->getUrlParm());
	}
