 ...
 * Page class
 */
class vwhistoryPicking_preview extends vwhistoryPicking
{
	...
	// Page object name
	public $PageObjName = "vwhistoryPicking_preview";
	...
	public function run()
	{
		...
		if (!$validRequest) {
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'vwhistoryPicking');
			if ($Security->isLoggedIn())
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("vwhistoryPickinglist.php"), "", $this->TableVar, TRUE);
		$pageId = "preview";
