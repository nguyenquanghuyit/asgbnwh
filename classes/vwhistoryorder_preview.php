 ...
 * Page class
 */
class vwhistoryorder_preview extends vwhistoryorder
{
	...
	// Page object name
	public $PageObjName = "vwhistoryorder_preview";
	...
	public function run()
	{
		...
		if (!$validRequest) {
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'vwhistoryorder');
			if ($Security->isLoggedIn())
	...
	protected function masterKeyUrl()
	{
		...
		if ($masterTblVar == "vwpickingbyorder") {
			$url = "" . TABLE_SHOW_MASTER . "=vwpickingbyorder&fk_ID_Order=" . urlencode(strval($this->ID_Order->QueryStringValue)) . "";
		}
		return $url;
	}
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("vwhistoryorderlist.php"), "", $this->TableVar, TRUE);
		$pageId = "preview";
