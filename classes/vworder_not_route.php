...
/**
 * Table class for vworder_not_route
 */
class vworder_not_route extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'vworder_not_route';
		$this->TableName = 'vworder_not_route';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`vworder_not_route`";
		$this->Dbid = 'DB';
		...
		// ID_Order
		$this->ID_Order = new DbField('vworder_not_route', 'vworder_not_route', 'x_ID_Order', 'ID_Order', '`ID_Order`', '`ID_Order`', 3, -1, FALSE, '`ID_Order`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// CusomterOrderNo
		$this->CusomterOrderNo = new DbField('vworder_not_route', 'vworder_not_route', 'x_CusomterOrderNo', 'CusomterOrderNo', '`CusomterOrderNo`', '`CusomterOrderNo`', 200, -1, FALSE, '`CusomterOrderNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`vworder_not_route`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "vworder_not_routelist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "vworder_not_routeview.php")
			return $Language->phrase("View");
		elseif ($pageName == "vworder_not_routeedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "vworder_not_routeadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("vworder_not_routeview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("vworder_not_routeview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "vworder_not_routeadd.php?" . $this->getUrlParm($parm);
		else
			$url = "vworder_not_routeadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("vworder_not_routeedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("vworder_not_routeadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("vworder_not_routedelete.php", $this->getUrlParm());
	}
