...
/**
 * Table class for vworderdetail
 */
class vworderdetail extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'vworderdetail';
		$this->TableName = 'vworderdetail';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`vworderdetail`";
		$this->Dbid = 'DB';
		...
		// ID_Detail
		$this->ID_Detail = new DbField('vworderdetail', 'vworderdetail', 'x_ID_Detail', 'ID_Detail', '`ID_Detail`', '`ID_Detail`', 3, -1, FALSE, '`ID_Detail`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// ID_Order
		$this->ID_Order = new DbField('vworderdetail', 'vworderdetail', 'x_ID_Order', 'ID_Order', '`ID_Order`', '`ID_Order`', 3, -1, FALSE, '`ID_Order`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Code
		$this->Code = new DbField('vworderdetail', 'vworderdetail', 'x_Code', 'Code', '`Code`', '`Code`', 200, -1, FALSE, '`Code`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Code->Sortable = TRUE; // Allow sort
		$this->fields['Code'] = &$this->Code;

		// PCS
		$this->PCS = new DbField('vworderdetail', 'vworderdetail', 'x_PCS', 'PCS', '`PCS`', '`PCS`', 3, -1, FALSE, '`PCS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PCS->Sortable = TRUE; // Allow sort
		$this->PCS->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['PCS'] = &$this->PCS;

		// StatusPickUp
		$this->StatusPickUp = new DbField('vworderdetail', 'vworderdetail', 'x_StatusPickUp', 'StatusPickUp', '`StatusPickUp`', '`StatusPickUp`', 16, -1, FALSE, '`StatusPickUp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->StatusPickUp->Sortable = TRUE; // Allow sort
		...
		$this->StatusPickUp->Lookup = new Lookup('StatusPickUp', 'vworderdetail', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
		...
		// CreateUser
		$this->CreateUser = new DbField('vworderdetail', 'vworderdetail', 'x_CreateUser', 'CreateUser', '`CreateUser`', '`CreateUser`', 200, -1, FALSE, '`CreateUser`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CreateUser->Sortable = TRUE; // Allow sort
		$this->fields['CreateUser'] = &$this->CreateUser;

		// CreateDate
		$this->CreateDate = new DbField('vworderdetail', 'vworderdetail', 'x_CreateDate', 'CreateDate', '`CreateDate`', CastDateFieldForLike('`CreateDate`', 11, "DB"), 135, 11, FALSE, '`CreateDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// UpdateUser
		$this->UpdateUser = new DbField('vworderdetail', 'vworderdetail', 'x_UpdateUser', 'UpdateUser', '`UpdateUser`', '`UpdateUser`', 200, -1, FALSE, '`UpdateUser`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->UpdateUser->Sortable = TRUE; // Allow sort
		$this->fields['UpdateUser'] = &$this->UpdateUser;

		// UpdateDate
		$this->UpdateDate = new DbField('vworderdetail', 'vworderdetail', 'x_UpdateDate', 'UpdateDate', '`UpdateDate`', CastDateFieldForLike('`UpdateDate`', 0, "DB"), 135, 0, FALSE, '`UpdateDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`vworderdetail`";
	}
	...
	{
		return ($this->SqlOrderBy <> "") ? $this->SqlOrderBy : "`ID_Detail` ASC";
	}
	...
	{
		global $Language;
		if ($pageName == "vworderdetailview.php")
			return $Language->phrase("View");
		elseif ($pageName == "vworderdetailedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "vworderdetailadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("vworderdetailview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("vworderdetailview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "vworderdetailadd.php?" . $this->getUrlParm($parm);
		else
			$url = "vworderdetailadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("vworderdetailedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("vworderdetailadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("vworderdetaildelete.php", $this->getUrlParm());
	}
