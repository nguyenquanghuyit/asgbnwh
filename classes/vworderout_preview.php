 ...
 * Page class
 */
class vworderout_preview extends vworderout
{
	...
	// Page object name
	public $PageObjName = "vworderout_preview";
	...
	public function run()
	{
		...
		if (!$validRequest) {
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'vworderout');
			if ($Security->isLoggedIn())
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("vworderoutlist.php"), "", $this->TableVar, TRUE);
		$pageId = "preview";
