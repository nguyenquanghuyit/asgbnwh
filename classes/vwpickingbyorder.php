...
/**
 * Table class for vwpickingbyorder
 */
class vwpickingbyorder extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'vwpickingbyorder';
		$this->TableName = 'vwpickingbyorder';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`vwpickingbyorder`";
		$this->Dbid = 'DB';
		...
		// ID_Order
		$this->ID_Order = new DbField('vwpickingbyorder', 'vwpickingbyorder', 'x_ID_Order', 'ID_Order', '`ID_Order`', '`ID_Order`', 3, -1, FALSE, '`ID_Order`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// TypeName
		$this->TypeName = new DbField('vwpickingbyorder', 'vwpickingbyorder', 'x_TypeName', 'TypeName', '`TypeName`', '`TypeName`', 200, -1, FALSE, '`TypeName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->TypeName->Lookup = new Lookup('TypeName', 'vwpickingbyorder', TRUE, 'TypeName', ["TypeName","","",""], [], [], [], [], [], [], '', '');
		$this->fields['TypeName'] = &$this->TypeName;

		// OrderDate
		$this->OrderDate = new DbField('vwpickingbyorder', 'vwpickingbyorder', 'x_OrderDate', 'OrderDate', '`OrderDate`', CastDateFieldForLike('`OrderDate`', 7, "DB"), 135, 7, FALSE, '`OrderDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ContactName
		$this->ContactName = new DbField('vwpickingbyorder', 'vwpickingbyorder', 'x_ContactName', 'ContactName', '`ContactName`', '`ContactName`', 200, -1, FALSE, '`ContactName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ContactName->Sortable = TRUE; // Allow sort
		$this->fields['ContactName'] = &$this->ContactName;

		// ContactPhone
		$this->ContactPhone = new DbField('vwpickingbyorder', 'vwpickingbyorder', 'x_ContactPhone', 'ContactPhone', '`ContactPhone`', '`ContactPhone`', 200, -1, FALSE, '`ContactPhone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ContactPhone->Sortable = TRUE; // Allow sort
		$this->fields['ContactPhone'] = &$this->ContactPhone;

		// CompanyName
		$this->CompanyName = new DbField('vwpickingbyorder', 'vwpickingbyorder', 'x_CompanyName', 'CompanyName', '`CompanyName`', '`CompanyName`', 200, -1, FALSE, '`CompanyName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CompanyName->Sortable = TRUE; // Allow sort
		$this->fields['CompanyName'] = &$this->CompanyName;

		// StatusLoad
		$this->StatusLoad = new DbField('vwpickingbyorder', 'vwpickingbyorder', 'x_StatusLoad', 'StatusLoad', '`StatusLoad`', '`StatusLoad`', 16, -1, FALSE, '`StatusLoad`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->StatusLoad->Lookup = new Lookup('StatusLoad', 'vwpickingbyorder', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
		...
		// StatusFinishOrder
		$this->StatusFinishOrder = new DbField('vwpickingbyorder', 'vwpickingbyorder', 'x_StatusFinishOrder', 'StatusFinishOrder', '`StatusFinishOrder`', '`StatusFinishOrder`', 16, -1, FALSE, '`StatusFinishOrder`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->StatusFinishOrder->Sortable = FALSE; // Allow sort
		...
		$this->StatusFinishOrder->Lookup = new Lookup('StatusFinishOrder', 'vwpickingbyorder', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
	...
	public function getDetailUrl()
	{
		...
		// Detail url
		$detailUrl = "";
		if ($this->getCurrentDetailTable() == "vworderdetail") {
			$detailUrl = $GLOBALS["vworderdetail"]->getListUrl() . "?" . TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$detailUrl .= "&fk_ID_Order=" . urlencode($this->ID_Order->CurrentValue);
		}
		if ($this->getCurrentDetailTable() == "tbl_history_pick") {
			$detailUrl = $GLOBALS["tbl_history_pick"]->getListUrl() . "?" . TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$detailUrl .= "&fk_ID_Order=" . urlencode($this->ID_Order->CurrentValue);
		}
		if ($detailUrl == "")
			$detailUrl = "vwpickingbyorderlist.php";
		return $detailUrl;
	}
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`vwpickingbyorder`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "vwpickingbyorderlist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "vwpickingbyorderview.php")
			return $Language->phrase("View");
		elseif ($pageName == "vwpickingbyorderedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "vwpickingbyorderadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("vwpickingbyorderview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("vwpickingbyorderview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "vwpickingbyorderadd.php?" . $this->getUrlParm($parm);
		else
			$url = "vwpickingbyorderadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("vwpickingbyorderedit.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("vwpickingbyorderedit.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
		return $this->addMasterUrl($url);
	}
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("vwpickingbyorderadd.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("vwpickingbyorderadd.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("vwpickingbyorderdelete.php", $this->getUrlParm());
	}
