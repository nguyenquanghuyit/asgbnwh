 ...
 * Page class
 */
class vwrouteout_delete extends vwrouteout
{
	...
	// Page object name
	public $PageObjName = "vwrouteout_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("vwrouteoutlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("vwrouteoutlist.php"); // Return to list
			}
		}
	}
