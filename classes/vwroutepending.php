...
/**
 * Table class for vwroutepending
 */
class vwroutepending extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'vwroutepending';
		$this->TableName = 'vwroutepending';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`vwroutepending`";
		$this->Dbid = 'DB';
		...
		// Code
		$this->Code = new DbField('vwroutepending', 'vwroutepending', 'x_Code', 'Code', '`Code`', '`Code`', 200, -1, FALSE, '`Code`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PCS
		$this->PCS = new DbField('vwroutepending', 'vwroutepending', 'x_PCS', 'PCS', '`PCS`', '`PCS`', 3, -1, FALSE, '`PCS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// TruckNo
		$this->TruckNo = new DbField('vwroutepending', 'vwroutepending', 'x_TruckNo', 'TruckNo', '`TruckNo`', '`TruckNo`', 200, -1, FALSE, '`TruckNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ID_Route
		$this->ID_Route = new DbField('vwroutepending', 'vwroutepending', 'x_ID_Route', 'ID_Route', '`ID_Route`', '`ID_Route`', 3, -1, FALSE, '`ID_Route`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// RouteName
		$this->RouteName = new DbField('vwroutepending', 'vwroutepending', 'x_RouteName', 'RouteName', '`RouteName`', '`RouteName`', 200, -1, FALSE, '`RouteName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`vwroutepending`";
	}
	...
	{
		global $Language;
		if ($pageName == "vwroutependingview.php")
			return $Language->phrase("View");
		elseif ($pageName == "vwroutependingedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "vwroutependingadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("vwroutependingview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("vwroutependingview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "vwroutependingadd.php?" . $this->getUrlParm($parm);
		else
			$url = "vwroutependingadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("vwroutependingedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("vwroutependingadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("vwroutependingdelete.php", $this->getUrlParm());
	}
	...
	public function renderEditRow()
	{
		...
		if (REMOVE_XSS)
			$this->RouteName->CurrentValue = HtmlDecode($this->RouteName->CurrentValue);
		$this->RouteName->EditValue = $this->RouteName->CurrentValue;
		$this->RouteName->PlaceHolder = RemoveHtml($this->RouteName->caption());
