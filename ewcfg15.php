...
define(PROJECT_NAMESPACE . "PROJECT_NAME", "asgbn_wh"); // Project name
define(PROJECT_NAMESPACE . "CONFIG_FILE_FOLDER", PROJECT_NAME); // Config file name
define(PROJECT_NAMESPACE . "RANDOM_KEY", 'kzgoPZONWs1K39tB'); // Random key for encryption
define(PROJECT_NAMESPACE . "ENCRYPTION_KEY", ''); // Encryption key for data protection
define(PROJECT_NAMESPACE . "PROJECT_STYLESHEET_FILENAME", "phpcss/asgbn_wh.css"); // Project stylesheet file name
...
$PROJECT_ID = "{004E2122-9CCA-46AA-835C-0778C5A080BC}"; // Project ID (GUID)
$RELATED_PROJECT_ID = "";
...
$SIDEBAR_CLASS = "main-sidebar sidebar-dark-info";
...
$CONNECTIONS["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "18.139.16.74", "port" => 3306, "user" => "trantienhoa", "pass" => "abc@123", "db" => "asgbn", "qs" => "`", "qe" => "`");
...
define(PROJECT_NAMESPACE . "USER_LEVEL_TABLE", "`userlevels`");
...
define(PROJECT_NAMESPACE . "USER_LEVEL_PRIV_TABLE", "`userlevelpermissions`");
...
define(PROJECT_NAMESPACE . "USER_TABLE_NAME", "tbl_user");
define(PROJECT_NAMESPACE . "LOGIN_USERNAME_FIELD_NAME", "user_Name");
define(PROJECT_NAMESPACE . "LOGIN_PASSWORD_FIELD_NAME", "pass");
define(PROJECT_NAMESPACE . "USER_ID_FIELD_NAME", "id_User");
...
define(PROJECT_NAMESPACE . "USER_TABLE", "`tbl_user`");
define(PROJECT_NAMESPACE . "USER_NAME_FILTER", "(`user_Name` = '%u')");
define(PROJECT_NAMESPACE . "USER_ID_FILTER", "(`id_User` = %u)");
