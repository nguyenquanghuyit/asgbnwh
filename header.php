...
<?php } ?>
<link rel="shortcut icon" type="image/x-icon" href="<?php echo $RELATIVE_PATH ?>favicon.ico"><link rel="icon" type="image/x-icon" href="<?php echo $RELATIVE_PATH ?>favicon.ico">
...
<div class="wrapper ew-layout">
	...
	<nav class="<?php echo $NAVBAR_CLASS ?>">
		...
		<ul id="ew-navbar" class="navbar-nav">
			<a class="navbar-brand d-none d-md-block" href="http://asg.net.vn/gioithieu/chi-nhanh-cong-ty-co%CC%89-phan-di%CC%A3ch-vu%CC%A3-san-bay-ta%CC%A3i-bac-ninh-asgbn/">
				<img src="<?php echo $RELATIVE_PATH ?>phpimages/favicon.png" alt="" class="brand-image ew-brand-image">
			</a>
	...
	<aside class="<?php echo $SIDEBAR_CLASS ?>">
		...
		<a href="http://asg.net.vn/gioithieu/chi-nhanh-cong-ty-co%CC%89-phan-di%CC%A3ch-vu%CC%A3-san-bay-ta%CC%A3i-bac-ninh-asgbn/" class="brand-link">
			<img src="<?php echo $RELATIVE_PATH ?>phpimages/favicon.png" alt="" class="brand-image ew-brand-image">
		</a>
		<!-- Sidebar -->
		<div class="sidebar">
