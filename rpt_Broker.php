...
header("Content-Disposition: attachment; filename=Broker_".date('d/m/Y').".xls");
?>
<head>
<meta http-equiv=Content-Type content="text/html; charset=utf-8">
<meta name=ProgId content=Excel.Sheet>
<meta name=Generator content="Microsoft Excel 15">
<link rel=File-List href="rpt_Broker_files/filelist.xml">
<style id="vwbroker_7222_Styles">
<!--
...
<div id="vwbroker_7222" align=center x:publishsource="Excel">

<table border=0 cellpadding=0 cellspacing=0 width=1471 class=xl637222
 style='border-collapse:collapse;table-layout:fixed;width:1106pt'>
 <col class=xl637222 width=46 style='mso-width-source:userset;mso-width-alt:
 1308;width:35pt'>
 <col class=xl637222 width=114 span=2 style='mso-width-source:userset;
 mso-width-alt:3242;width:86pt'>
 <col class=xl637222 width=274 style='mso-width-source:userset;mso-width-alt:
 7793;width:206pt'>
 <col class=xl637222 width=414 style='mso-width-source:userset;mso-width-alt:
 11776;width:311pt'>
 <col class=xl637222 width=83 style='mso-width-source:userset;mso-width-alt:
 2360;width:62pt'>
 <col class=xl637222 width=183 style='mso-width-source:userset;mso-width-alt:
 5205;width:137pt'>
 <col class=xl637222 width=70 style='mso-width-source:userset;mso-width-alt:
 1991;width:53pt'>
 <col class=xl637222 width=71 style='mso-width-source:userset;mso-width-alt:
 2019;width:53pt'>
 <col class=xl637222 width=102 style='mso-width-source:userset;mso-width-alt:
 2901;width:77pt'>
 <tr class=xl687222 height=44 style='mso-height-source:userset;height:33.0pt'>
  <td height=44 class=xl677222 width=46 style='height:33.0pt;width:35pt'>&nbsp;</td>
  <td class=xl677222 width=114 style='border-left:none;width:86pt'>Customer's
  Order</td>
  <td class=xl677222 width=114 style='border-left:none;width:86pt'>CodeContact</td>
  <td class=xl677222 width=274 style='border-left:none;width:206pt'>CompanyName</td>
  <td class=xl677222 width=414 style='border-left:none;width:311pt'>Address</td>
  <td class=xl677222 width=83 style='border-left:none;width:62pt'>Code</td>
  <td class=xl677222 width=183 style='border-left:none;width:137pt'>ProductName</td>
  <td class=xl677222 width=70 style='border-left:none;width:53pt'>Model</td>
  <td class=xl677222 width=71 style='border-left:none;width:53pt'>PCS</td>
  <td class=xl677222 width=102 style='border-left:none;width:77pt'>Truck date</td>
 </tr>
...
for($x=0;$x<count($mang);$x++)
 {	
 	list($id,$code)=explode(",",$mang[$x]);	
	$strTim="SELECT ID_Order,CodeContact,CompanyName,Address,Code,ProductName,Model,PCS,CreateDate FROM vwbroker v WHERE v.ID_Order='".$id."' and v.Code='".$code."'";
 ...
 <tr height=23 style='height:17.25pt'>
  <td height=23 class=xl647222 style='height:17.25pt;border-top:none'><?php echo $stt;?></td>
  <td class=xl647222 style='border-top:none;border-left:none'><?php echo $row["CodeContact"];?></td>
  <td class=xl647222 style='border-top:none;border-left:none'><?php echo $row["CodeContact"];?></td>
  <td class=xl657222 style='border-top:none;border-left:none'><?php echo $row["CompanyName"];?></td>
  <td class=xl657222 style='border-top:none;border-left:none'><?php echo $row["Address"];?></td>
  <td class=xl657222 style='border-top:none;border-left:none'><?php echo $row["Code"];?></td>
  <td class=xl657222 style='border-top:none;border-left:none'><?php echo $row["ProductName"];?></td>
  <td class=xl647222 style='border-top:none;border-left:none'><?php echo $row["Model"];?></td>
  <td class=xl667222 style='border-top:none;border-left:none'><?php echo $row["PCS"];?></td>
  <td class=xl717222 style='border-top:none;border-left:none'><?php echo $row["CreateDate"];?></td>
 </tr>
 <?php }?>
 <tr class=xl637222 height=23 style='height:17.25pt'>
  <td height=23 class=xl697222 width=46 style='height:17.25pt;border-top:none;
  width:35pt'>&nbsp;</td>
  <td class=xl697222 width=114 style='border-top:none;border-left:none;
  width:86pt'>&nbsp;</td>
  <td class=xl697222 width=114 style='border-top:none;border-left:none;
  width:86pt'>&nbsp;</td>
  <td class=xl697222 width=274 style='border-top:none;border-left:none;
  width:206pt'>&nbsp;</td>
  <td class=xl697222 width=414 style='border-top:none;border-left:none;
  width:311pt'>&nbsp;</td>
  <td class=xl697222 width=83 style='border-top:none;border-left:none;
  width:62pt'>&nbsp;</td>
  <td class=xl697222 width=183 style='border-top:none;border-left:none;
  width:137pt'>&nbsp;</td>
  <td class=xl697222 width=70 style='border-top:none;border-left:none;
  width:53pt'>&nbsp;</td>
  <td class=xl707222 width=71 style='border-top:none;border-left:none;
  width:53pt'>Total: <?php echo $tongPCS;?></td>
  <td class=xl697222 width=102 style='border-top:none;border-left:none;
  width:77pt'>&nbsp;</td>
 </tr>
