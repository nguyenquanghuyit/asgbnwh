...
header("Content-Disposition: attachment; filename=DeleiveryReport_".date('d/m/Y').".xls");	
?>
<head>
<meta http-equiv=Content-Type content="text/html; charset=utf-8">
<meta name=ProgId content=Excel.Sheet>
<meta name=Generator content="Microsoft Excel 15">
<link rel=File-List href="rpt_Delivery_files/filelist.xml">
<style id="vwoutboudsumary_31062_Styles">
<!--
...
<div id="vwoutboudsumary_31062" align=center x:publishsource="Excel">

<table border=0 cellpadding=0 cellspacing=0 width=735 class=xl6431062
 style='border-collapse:collapse;table-layout:fixed;width:552pt'>
 <col class=xl6431062 width=49 span=2 style='mso-width-source:userset;
 mso-width-alt:1393;width:37pt'>
 <col class=xl6431062 width=63 style='mso-width-source:userset;mso-width-alt:
 1792;width:47pt'>
 <col class=xl6431062 width=97 style='mso-width-source:userset;mso-width-alt:
 2759;width:73pt'>
 <col class=xl6431062 width=96 style='mso-width-source:userset;mso-width-alt:
 2730;width:72pt'>
 <col class=xl6431062 width=298 style='mso-width-source:userset;mso-width-alt:
 8476;width:224pt'>
 <col class=xl6431062 width=83 style='mso-width-source:userset;mso-width-alt:
 2360;width:62pt'>
 <tr height=32 style='mso-height-source:userset;height:24.0pt'>
  <td height=32 class=xl6331062 width=49 style='height:24.0pt;width:37pt'>&nbsp;</td>
  <td class=xl6331062 width=49 style='border-left:none;width:37pt'>Year</td>
  <td class=xl6331062 width=63 style='border-left:none;width:47pt'>Month</td>
  <td class=xl6331062 width=97 style='border-left:none;width:73pt'>Truck No</td>
  <td class=xl6331062 width=96 style='border-left:none;width:72pt'>Code</td>
  <td class=xl6331062 width=298 style='border-left:none;width:224pt'>Product
  Name</td>
  <td class=xl6331062 width=83 style='border-left:none;width:62pt'>PCS</td>
 </tr>
 <?php
...
for($x=0;$x<count($mang);$x++)
 {	
	...
	$strTim="SELECT  TruckNo,Code,ProductName,Nam,Thang,PCS FROM vwoutboudsumary v WHERE v.Nam=".$nam." AND v.Thang=".$thang." AND v.Code='".$code."' AND v.TruckNo='".$bks."'";	
	//echo $strTim;
 ...
 <tr height=23 style='height:17.25pt'>
  <td height=23 class=xl6531062 style='height:17.25pt;border-top:none'><?php echo $stt;?></td>
  <td class=xl6531062 style='border-top:none;border-left:none'><?php echo $nam;?></td>
  <td class=xl6531062 style='border-top:none;border-left:none'><?php echo $thang;?></td>
  <td class=xl6631062 style='border-top:none;border-left:none'><?php echo $bks;?></td>
  <td class=xl6631062 style='border-top:none;border-left:none'><?php echo $code;?></td>
  <td class=xl6631062 style='border-top:none;border-left:none'><?php echo $row["ProductName"];?></td>
  <td class=xl6731062 style='border-top:none;border-left:none'><?php echo $row["PCS"];?></td>
 </tr>
 <?php
 }
 ?>
 <tr class=xl6431062 height=23 style='height:17.25pt'>
  <td height=23 class=xl6831062 width=49 style='height:17.25pt;border-top:none;
  width:37pt'>&nbsp;</td>
  <td class=xl6831062 width=49 style='border-top:none;border-left:none;
  width:37pt'>&nbsp;</td>
  <td class=xl6831062 width=63 style='border-top:none;border-left:none;
  width:47pt'>&nbsp;</td>
  <td class=xl6831062 width=97 style='border-top:none;border-left:none;
  width:73pt'>&nbsp;</td>
  <td class=xl6831062 width=96 style='border-top:none;border-left:none;
  width:72pt'>&nbsp;</td>
  <td class=xl6831062 width=298 style='border-top:none;border-left:none;
  width:224pt'>&nbsp;</td>
  <td class=xl6931062 width=83 style='border-top:none;border-left:none;
  width:62pt'>Total: <?php echo $tongPCS;?></td>
 </tr>
