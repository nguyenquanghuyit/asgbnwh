...
header("Content-Disposition: attachment; filename=InventoryReport_".date('d/m/Y').".xls");	
?>
<head>
<meta http-equiv=Content-Type content="text/html; charset=utf-8">
<meta name=ProgId content=Excel.Sheet>
<meta name=Generator content="Microsoft Excel 15">
<link rel=File-List href="rpt_InventoryReport_files/filelist.xml">
<style id="vwinventory_4851_Styles">
<!--
...
<div id="vwinventory_4851" align=center x:publishsource="Excel">

<table border=0 cellpadding=0 cellspacing=0 width=969 class=xl654851
 style='border-collapse:collapse;table-layout:fixed;width:727pt'>
 <col class=xl654851 width=36 style='mso-width-source:userset;mso-width-alt:
 1024;width:27pt'>
 <col class=xl654851 width=92 style='mso-width-source:userset;mso-width-alt:
 2616;width:69pt'>
 <col class=xl654851 width=275 style='mso-width-source:userset;mso-width-alt:
 7822;width:206pt'>
 <col class=xl654851 width=180 style='mso-width-source:userset;mso-width-alt:
 5120;width:135pt'>
 <col class=xl654851 width=119 style='mso-width-source:userset;mso-width-alt:
 3384;width:89pt'>
 <col class=xl654851 width=89 span=3 style='mso-width-source:userset;
 mso-width-alt:2531;width:67pt'>
 <tr class=xl704851 height=44 style='mso-height-source:userset;height:33.0pt'>
  <td height=44 class=xl694851 width=36 style='height:33.0pt;width:27pt'>&nbsp;</td>
  <td class=xl694851 width=92 style='border-left:none;width:69pt'>Code</td>
  <td class=xl694851 width=275 style='border-left:none;width:206pt'>Product
  Name</td>
  <td class=xl694851 width=180 style='border-left:none;width:135pt'>VnName</td>
  <td class=xl694851 width=119 style='border-left:none;width:89pt'>Model</td>
  <td class=xl694851 width=89 style='border-left:none;width:67pt'>PCS<br>
    IN</td>
  <td class=xl694851 width=89 style='border-left:none;width:67pt'>PCS<br>
    OUT</td>
  <td class=xl694851 width=89 style='border-left:none;width:67pt'>PCS</td>
 </tr>
<?php
...
for($x=0;$x<count($mang);$x++)
 {	
	$strTim="SELECT  ProductName,VnName,Model,PCS_IN,PCS_OUT,PCS,v.Code from vwinventory v WHERE Code='".$mang[$x]."'";	
	//echo $strTim;
	...
	$tongPCS+=$row["PCS"];
 ?>
 <tr class=xl704851 height=30 style='mso-height-source:userset;height:22.5pt'>
  <td height=30 class=xl714851 style='height:22.5pt;border-top:none'><?php echo $stt;?></td>
  <td class=xl714851 style='border-top:none;border-left:none'><?php echo $row["Code"]?></td>
  <td class=xl724851 style='border-top:none;border-left:none'><?php echo $row["ProductName"]?></td>
  <td class=xl724851 style='border-top:none;border-left:none'><?php echo $row["VnName"]?></td>
  <td class=xl724851 style='border-top:none;border-left:none'><?php echo $row["Model"]?></td>
  <td class=xl714851 style='border-top:none;border-left:none'><?php echo $row["PCS_IN"]?></td>
  <td class=xl714851 style='border-top:none;border-left:none'><?php echo $row["PCS_OUT"]?></td>
  <td class=xl714851 style='border-top:none;border-left:none'><?php echo $row["PCS"]?></td>
 </tr>
  <?php
 }
 ?>
 <tr height=23 style='height:17.25pt'>
  <td height=23 class=xl664851 width=36 style='height:17.25pt;border-top:none;
  width:27pt'>&nbsp;</td>
  <td class=xl664851 width=92 style='border-top:none;border-left:none;
  width:69pt'>&nbsp;</td>
  <td class=xl664851 width=275 style='border-top:none;border-left:none;
  width:206pt'>&nbsp;</td>
  <td class=xl664851 width=180 style='border-top:none;border-left:none;
  width:135pt'>&nbsp;</td>
  <td class=xl664851 width=119 style='border-top:none;border-left:none;
  width:89pt'>&nbsp;</td>
  <td class=xl674851 width=89 style='border-top:none;border-left:none;
  width:67pt'>Total: <?php echo $tongPCS_IN; ?></td>
  <td class=xl674851 width=89 style='border-top:none;border-left:none;
  width:67pt'>Total:  <?php echo $tongPCS_OUT; ?></td>
  <td class=xl674851 width=89 style='border-top:none;border-left:none;
  width:67pt'>Total:  <?php echo $tongPCS; ?></td>
 </tr>
