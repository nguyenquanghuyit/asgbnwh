...
xmlns="http://www.w3.org/TR/REC-html40"><?php
header("Content-Type:   application/vnd.ms-excel; charset=utf-8");
header("Content-Disposition: attachment; filename=Opening_ClosingStock_".date('d/m/Y').".xls");
?>
<head>
<meta http-equiv=Content-Type content="text/html; charset=utf-8">
<meta name=ProgId content=Excel.Sheet>
<meta name=Generator content="Microsoft Excel 15">
<link rel=File-List href="rpt_OpeningClosing_files/filelist.xml">
<style id="tbl_inventory_1326_Styles">
<!--
...
<div id="tbl_inventory_1326" align=center x:publishsource="Excel">

<table border=0 cellpadding=0 cellspacing=0 width=844 class=xl631326
 style='border-collapse:collapse;table-layout:fixed;width:634pt'>
 <col class=xl631326 width=39 style='mso-width-source:userset;mso-width-alt:
 1109;width:29pt'>
 <col class=xl631326 width=50 style='mso-width-source:userset;mso-width-alt:
 1422;width:38pt'>
 <col class=xl631326 width=87 style='mso-width-source:userset;mso-width-alt:
 2474;width:65pt'>
 <col class=xl631326 width=100 style='mso-width-source:userset;mso-width-alt:
 2844;width:75pt'>
 <col class=xl631326 width=298 style='mso-width-source:userset;mso-width-alt:
 8476;width:224pt'>
 <col class=xl631326 width=66 style='mso-width-source:userset;mso-width-alt:
 1877;width:50pt'>
 <col class=xl631326 width=71 style='mso-width-source:userset;mso-width-alt:
 2019;width:53pt'>
 <col class=xl631326 width=62 style='mso-width-source:userset;mso-width-alt:
 1763;width:47pt'>
 <col class=xl631326 width=71 style='mso-width-source:userset;mso-width-alt:
 2019;width:53pt'>
 <tr height=45 style='height:33.75pt'>
  <td height=45 class=xl671326 width=39 style='height:33.75pt;width:29pt'>&nbsp;</td>
  <td class=xl671326 width=50 style='border-left:none;width:38pt'>Year</td>
  <td class=xl671326 width=87 style='border-left:none;width:65pt'>Month</td>
  <td class=xl671326 width=100 style='border-left:none;width:75pt'>Code</td>
  <td class=xl671326 width=298 style='border-left:none;width:224pt'>Product
  Name</td>
  <td class=xl671326 width=66 style='border-left:none;width:50pt'>Opening<br>
    Stock</td>
  <td class=xl671326 width=71 style='border-left:none;width:53pt'>PCS <br>
    IN</td>
  <td class=xl671326 width=62 style='border-left:none;width:47pt'>PCS <br>
    OUT</td>
  <td class=xl671326 width=71 style='border-left:none;width:53pt'>Closing<br>
    Stock</td>
 </tr>
...
for($x=0;$x<count($mang);$x++)
 {	
	...
	$strTim="SELECT v.In_Year,v.In_Month,v.Code,v.ProductName,v.OpeningStock,v.PCS_IN,v.PCS_OUT,v.ClosingStock FROM tbl_inventory v WHERE v.ID_Delivery=".$mang[$x];

	$kq=mysqli_query($cnn,$strTim);
	$row=mysqli_fetch_assoc($kq);
	$stt+=1;

	$tongOpeningStock+=$row["OpeningStock"];
	$tongPCS_IN+=$row["PCS_IN"];
	$tongPCS_OUT+=$row["PCS_OUT"];
	$tongClosingStock+=$row["ClosingStock"];
	
	
 ?>
 <tr class=xl701326 height=27 style='mso-height-source:userset;height:20.25pt'>
  <td height=27 class=xl641326 style='height:20.25pt;border-top:none'><?php echo $stt;?></td>
  <td class=xl641326 style='border-top:none;border-left:none'><?php echo $row["In_Year"]?></td>
  <td class=xl641326 style='border-top:none;border-left:none'><?php echo $row["In_Month"]?></td>
  <td class=xl681326 style='border-top:none;border-left:none'><?php echo $row["Code"]?></td>
  <td class=xl681326 style='border-top:none;border-left:none'><?php echo $row["ProductName"]?></td>
  <td class=xl691326 style='border-top:none;border-left:none'><?php echo $row["OpeningStock"]?></td>
  <td class=xl691326 style='border-top:none;border-left:none'><?php echo $row["PCS_IN"]?></td>
  <td class=xl691326 style='border-top:none;border-left:none'><?php echo $row["PCS_OUT"]?></td>
  <td class=xl691326 style='border-top:none;border-left:none'><?php echo $row["ClosingStock"]?></td>
 </tr>
 <?php }?>
 <tr class=xl631326 height=23 style='height:17.25pt'>
  <td height=23 class=xl651326 width=39 style='height:17.25pt;border-top:none;
  width:29pt'>&nbsp;</td>
  <td class=xl651326 width=50 style='border-top:none;border-left:none;
  width:38pt'>&nbsp;</td>
  <td class=xl651326 width=87 style='border-top:none;border-left:none;
  width:65pt'>&nbsp;</td>
  <td class=xl651326 width=100 style='border-top:none;border-left:none;
  width:75pt'>&nbsp;</td>
  <td class=xl651326 width=298 style='border-top:none;border-left:none;
  width:224pt'>&nbsp;</td>
  <td class=xl661326 width=66 style='border-top:none;border-left:none;
  width:50pt'>Total: <?php echo $tongOpeningStock;?></td>
  <td class=xl661326 width=71 style='border-top:none;border-left:none;
  width:53pt'>Total: <?php echo $tongPCS_IN;?></td>
  <td class=xl661326 width=62 style='border-top:none;border-left:none;
  width:47pt'>Total: <?php echo $tongPCS_OUT;?></td>
  <td class=xl661326 width=71 style='border-top:none;border-left:none;
  width:53pt'>Total: <?php echo $tongClosingStock;?></td>
 </tr>
