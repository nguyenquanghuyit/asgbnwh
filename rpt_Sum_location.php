...
header("Content-Disposition: attachment; filename=SumbyLocation_".date('d/m/Y').".xls");	
?>
<head>
<meta http-equiv=Content-Type content="text/html; charset=utf-8">
<meta name=ProgId content=Excel.Sheet>
<meta name=Generator content="Microsoft Excel 15">
<link rel=File-List href="rpt_Sum_location_files/filelist.xml">
<style id="vwsumpcs_location_8935_Styles">
<!--
...
<div id="vwsumpcs_location_8935" align=center x:publishsource="Excel">

<table border=0 cellpadding=0 cellspacing=0 width=765 class=xl658935
 style='border-collapse:collapse;table-layout:fixed;width:574pt'>
 <col class=xl658935 width=36 style='mso-width-source:userset;mso-width-alt:
 1024;width:27pt'>
 <col class=xl658935 width=89 style='mso-width-source:userset;mso-width-alt:
 2531;width:67pt'>
 <col class=xl658935 width=118 style='mso-width-source:userset;mso-width-alt:
 3356;width:89pt'>
 <col class=xl658935 width=320 style='mso-width-source:userset;mso-width-alt:
 9102;width:240pt'>
 <col class=xl658935 width=119 style='mso-width-source:userset;mso-width-alt:
 3384;width:89pt'>
 <col class=xl658935 width=83 style='mso-width-source:userset;mso-width-alt:
 2360;width:62pt'>
 <tr class=xl648935 height=36 style='mso-height-source:userset;height:27.0pt'>
  <td height=36 class=xl638935 width=36 style='height:27.0pt;width:27pt'>&nbsp;</td>
  <td class=xl638935 width=89 style='border-left:none;width:67pt'>Location</td>
  <td class=xl638935 width=118 style='border-left:none;width:89pt'>Code</td>
  <td class=xl638935 width=320 style='border-left:none;width:240pt'>ProductName</td>
  <td class=xl638935 width=119 style='border-left:none;width:89pt'>Model</td>
  <td class=xl638935 width=83 style='border-left:none;width:62pt'>PCS</td>
 </tr>
 <?php
...
for($x=0;$x<count($mang);$x++)
 {	
 	list($location,$coce)=explode(",",$mang[$x]);
	$strTim="SELECT v.Location,v.code,v.ProductName,v.Model,v.PCS FROM vwsumpcs_location v WHERE Code='".$coce."' and Location='".$location."'";	
 ...
 <tr height=29 style='mso-height-source:userset;height:21.75pt'>
  <td height=29 class=xl698935 style='height:21.75pt;border-top:none'><?php echo $stt;?></td>
  <td class=xl688935 style='border-top:none;border-left:none'><?php echo $row["Location"];?></td>
  <td class=xl688935 style='border-top:none;border-left:none'><?php echo $row["code"];?></td>
  <td class=xl688935 style='border-top:none;border-left:none'><?php echo $row["ProductName"];?></td>
  <td class=xl688935 style='border-top:none;border-left:none'><?php echo $row["Model"];?></td>
  <td class=xl708935 style='border-top:none;border-left:none'><?php echo $row["PCS"];?></td>
 </tr>
 <?php
 }
 ?>
 <tr class=xl658935 height=23 style='height:17.25pt'>
  <td height=23 class=xl668935 width=36 style='height:17.25pt;border-top:none;
  width:27pt'>&nbsp;</td>
  <td class=xl668935 width=89 style='border-top:none;border-left:none;
  width:67pt'>&nbsp;</td>
  <td class=xl668935 width=118 style='border-top:none;border-left:none;
  width:89pt'>&nbsp;</td>
  <td class=xl668935 width=320 style='border-top:none;border-left:none;
  width:240pt'>&nbsp;</td>
  <td class=xl668935 width=119 style='border-top:none;border-left:none;
  width:89pt'>&nbsp;</td>
  <td class=xl678935 width=83 style='border-top:none;border-left:none;
