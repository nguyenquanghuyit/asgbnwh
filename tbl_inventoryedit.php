...
var ftbl_inventoryedit = currentForm = new ew.Form("ftbl_inventoryedit", "edit");
...
ftbl_inventoryedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($tbl_inventory_edit->ID_Delivery->Required) { ?>
			elm = this.getElements("x" + infix + "_ID_Delivery");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $tbl_inventory->ID_Delivery->caption(), $tbl_inventory->ID_Delivery->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($tbl_inventory_edit->In_Year->Required) { ?>
		...
		<?php if ($tbl_inventory_edit->In_Month->Required) { ?>
		...
		<?php if ($tbl_inventory_edit->Code->Required) { ?>
		...
		<?php } ?>
		<?php if ($tbl_inventory_edit->ProductName->Required) { ?>
		...
		<?php } ?>
		<?php if ($tbl_inventory_edit->OpeningStock->Required) { ?>
		...
		<?php if ($tbl_inventory_edit->PCS_IN->Required) { ?>
		...
		<?php if ($tbl_inventory_edit->PCS_OUT->Required) { ?>
		...
		<?php if ($tbl_inventory_edit->ClosingStock->Required) { ?>
		...
		<?php if ($tbl_inventory_edit->LockStock->Required) { ?>
...
ftbl_inventoryedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php if ($tbl_inventory_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $tbl_inventory_edit->Token ?>">
<?php } ?>
...
<?php if ($tbl_inventory->ID_Delivery->Visible) { // ID_Delivery ?>
	<div id="r_ID_Delivery" class="form-group row">
		<label id="elh_tbl_inventory_ID_Delivery" class="<?php echo $tbl_inventory_edit->LeftColumnClass ?>"><?php echo $tbl_inventory->ID_Delivery->caption() ?><?php echo ($tbl_inventory->ID_Delivery->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tbl_inventory_edit->RightColumnClass ?>"><div<?php echo $tbl_inventory->ID_Delivery->cellAttributes() ?>>
<span id="el_tbl_inventory_ID_Delivery">
<span<?php echo $tbl_inventory->ID_Delivery->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($tbl_inventory->ID_Delivery->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="tbl_inventory" data-field="x_ID_Delivery" name="x_ID_Delivery" id="x_ID_Delivery" value="<?php echo HtmlEncode($tbl_inventory->ID_Delivery->CurrentValue) ?>">
<?php echo $tbl_inventory->ID_Delivery->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($tbl_inventory->In_Year->Visible) { // In_Year ?>
	<div id="r_In_Year" class="form-group row">
		<label id="elh_tbl_inventory_In_Year" for="x_In_Year" class="<?php echo $tbl_inventory_edit->LeftColumnClass ?>"><?php echo $tbl_inventory->In_Year->caption() ?><?php echo ($tbl_inventory->In_Year->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tbl_inventory_edit->RightColumnClass ?>"><div<?php echo $tbl_inventory->In_Year->cellAttributes() ?>>
...
<?php if ($tbl_inventory->In_Month->Visible) { // In_Month ?>
	<div id="r_In_Month" class="form-group row">
		<label id="elh_tbl_inventory_In_Month" for="x_In_Month" class="<?php echo $tbl_inventory_edit->LeftColumnClass ?>"><?php echo $tbl_inventory->In_Month->caption() ?><?php echo ($tbl_inventory->In_Month->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tbl_inventory_edit->RightColumnClass ?>"><div<?php echo $tbl_inventory->In_Month->cellAttributes() ?>>
...
<?php if ($tbl_inventory->Code->Visible) { // Code ?>
	<div id="r_Code" class="form-group row">
		<label id="elh_tbl_inventory_Code" for="x_Code" class="<?php echo $tbl_inventory_edit->LeftColumnClass ?>"><?php echo $tbl_inventory->Code->caption() ?><?php echo ($tbl_inventory->Code->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tbl_inventory_edit->RightColumnClass ?>"><div<?php echo $tbl_inventory->Code->cellAttributes() ?>>
...
<?php if ($tbl_inventory->ProductName->Visible) { // ProductName ?>
	<div id="r_ProductName" class="form-group row">
		<label id="elh_tbl_inventory_ProductName" for="x_ProductName" class="<?php echo $tbl_inventory_edit->LeftColumnClass ?>"><?php echo $tbl_inventory->ProductName->caption() ?><?php echo ($tbl_inventory->ProductName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tbl_inventory_edit->RightColumnClass ?>"><div<?php echo $tbl_inventory->ProductName->cellAttributes() ?>>
...
<?php if ($tbl_inventory->OpeningStock->Visible) { // OpeningStock ?>
	<div id="r_OpeningStock" class="form-group row">
		<label id="elh_tbl_inventory_OpeningStock" for="x_OpeningStock" class="<?php echo $tbl_inventory_edit->LeftColumnClass ?>"><?php echo $tbl_inventory->OpeningStock->caption() ?><?php echo ($tbl_inventory->OpeningStock->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tbl_inventory_edit->RightColumnClass ?>"><div<?php echo $tbl_inventory->OpeningStock->cellAttributes() ?>>
...
<?php if ($tbl_inventory->PCS_IN->Visible) { // PCS_IN ?>
	<div id="r_PCS_IN" class="form-group row">
		<label id="elh_tbl_inventory_PCS_IN" for="x_PCS_IN" class="<?php echo $tbl_inventory_edit->LeftColumnClass ?>"><?php echo $tbl_inventory->PCS_IN->caption() ?><?php echo ($tbl_inventory->PCS_IN->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tbl_inventory_edit->RightColumnClass ?>"><div<?php echo $tbl_inventory->PCS_IN->cellAttributes() ?>>
...
<?php if ($tbl_inventory->PCS_OUT->Visible) { // PCS_OUT ?>
	<div id="r_PCS_OUT" class="form-group row">
		<label id="elh_tbl_inventory_PCS_OUT" for="x_PCS_OUT" class="<?php echo $tbl_inventory_edit->LeftColumnClass ?>"><?php echo $tbl_inventory->PCS_OUT->caption() ?><?php echo ($tbl_inventory->PCS_OUT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tbl_inventory_edit->RightColumnClass ?>"><div<?php echo $tbl_inventory->PCS_OUT->cellAttributes() ?>>
...
<?php if ($tbl_inventory->ClosingStock->Visible) { // ClosingStock ?>
	<div id="r_ClosingStock" class="form-group row">
		<label id="elh_tbl_inventory_ClosingStock" for="x_ClosingStock" class="<?php echo $tbl_inventory_edit->LeftColumnClass ?>"><?php echo $tbl_inventory->ClosingStock->caption() ?><?php echo ($tbl_inventory->ClosingStock->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tbl_inventory_edit->RightColumnClass ?>"><div<?php echo $tbl_inventory->ClosingStock->cellAttributes() ?>>
...
<?php if ($tbl_inventory->LockStock->Visible) { // LockStock ?>
	<div id="r_LockStock" class="form-group row">
		<label id="elh_tbl_inventory_LockStock" for="x_LockStock" class="<?php echo $tbl_inventory_edit->LeftColumnClass ?>"><?php echo $tbl_inventory->LockStock->caption() ?><?php echo ($tbl_inventory->LockStock->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tbl_inventory_edit->RightColumnClass ?>"><div<?php echo $tbl_inventory->LockStock->cellAttributes() ?>>
