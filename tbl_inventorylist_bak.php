...
<?php } ?>
<a href="#endpage" class="btn btn-warning"><img src="images/reddown.png" width="15px' height="15px"> End page</a>
<div id="homePage" class="ew-list-other-options">
...
<?php } ?>
<div class="ew-list-other-options"><a href="#homePage" class="btn btn-warning"><img src="images/redUp.png" width="20px" height="20px"> Home page</a>
<?php $tbl_inventory_list->OtherOptions->render("body", "bottom") ?>
</div>
<div id="endpage" class="clearfix"></div>
</div>
<?php } ?>
</div><!-- /.ew-grid -->
<?php } ?>
...
?>
<?php if (!$tbl_inventory->isExport()) { ?>
<script src="phpjs/js_enventory.js"></script>
<script>
