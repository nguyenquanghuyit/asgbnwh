...
ftbl_order_po_invlist.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php } ?>
		<?php if ($tbl_order_po_inv_list->IdType->Required) { ?>
			elm = this.getElements("x" + infix + "_IdType");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $tbl_order_po_inv->IdType->caption(), $tbl_order_po_inv->IdType->RequiredErrorMessage)) ?>");
		<?php } ?>
...
ftbl_order_po_invlist.lists["x_IdType"] = <?php echo $tbl_order_po_inv_list->IdType->Lookup->toClientList() ?>;
ftbl_order_po_invlist.lists["x_IdType"].options = <?php echo JsonEncode($tbl_order_po_inv_list->IdType->lookupOptions()) ?>;
...
// Dynamic selection lists
ftbl_order_po_invlistsrch.lists["x_IdType"] = <?php echo $tbl_order_po_inv_list->IdType->Lookup->toClientList() ?>;
ftbl_order_po_invlistsrch.lists["x_IdType"].options = <?php echo JsonEncode($tbl_order_po_inv_list->IdType->lookupOptions()) ?>;
...
<?php if ($tbl_order_po_inv->IdType->Visible) { // IdType ?>
	<div id="xsc_IdType" class="ew-cell form-group">
		<label for="x_IdType" class="ew-search-caption ew-label"><?php echo $tbl_order_po_inv->IdType->caption() ?></label>
...
<div class="input-group">
	<select class="custom-select ew-custom-select" data-table="tbl_order_po_inv" data-field="x_IdType" data-value-separator="<?php echo $tbl_order_po_inv->IdType->displayValueSeparatorAttribute() ?>" id="x_IdType" name="x_IdType"<?php echo $tbl_order_po_inv->IdType->editAttributes() ?>>
		<?php echo $tbl_order_po_inv->IdType->selectOptionListHtml("x_IdType") ?>
	</select>
</div>
<?php echo $tbl_order_po_inv->IdType->Lookup->getParamTag("p_x_IdType") ?>
</span>
	</div>
<?php } ?>
</div>
...
<?php } ?>
<?php if ($tbl_order_po_inv->IdType->Visible) { // IdType ?>
	<?php if ($tbl_order_po_inv->sortUrl($tbl_order_po_inv->IdType) == "") { ?>
		<th data-name="IdType" class="<?php echo $tbl_order_po_inv->IdType->headerCellClass() ?>"><div id="elh_tbl_order_po_inv_IdType" class="tbl_order_po_inv_IdType"><div class="ew-table-header-caption"><?php echo $tbl_order_po_inv->IdType->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="IdType" class="<?php echo $tbl_order_po_inv->IdType->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event,'<?php echo $tbl_order_po_inv->SortUrl($tbl_order_po_inv->IdType) ?>',2);"><div id="elh_tbl_order_po_inv_IdType" class="tbl_order_po_inv_IdType">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $tbl_order_po_inv->IdType->caption() ?></span><span class="ew-table-header-sort"><?php if ($tbl_order_po_inv->IdType->getSort() == "ASC") { ?><i class="fa fa-sort-up"></i><?php } elseif ($tbl_order_po_inv->IdType->getSort() == "DESC") { ?><i class="fa fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
<?php } ?>
	...
	<?php } ?>
	<?php if ($tbl_order_po_inv->IdType->Visible) { // IdType ?>
		<td data-name="IdType"<?php echo $tbl_order_po_inv->IdType->cellAttributes() ?>>
<?php if ($tbl_order_po_inv->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $tbl_order_po_inv_list->RowCnt ?>_tbl_order_po_inv_IdType" class="form-group tbl_order_po_inv_IdType">
<div class="input-group">
	<select class="custom-select ew-custom-select" data-table="tbl_order_po_inv" data-field="x_IdType" data-value-separator="<?php echo $tbl_order_po_inv->IdType->displayValueSeparatorAttribute() ?>" id="x<?php echo $tbl_order_po_inv_list->RowIndex ?>_IdType" name="x<?php echo $tbl_order_po_inv_list->RowIndex ?>_IdType"<?php echo $tbl_order_po_inv->IdType->editAttributes() ?>>
		<?php echo $tbl_order_po_inv->IdType->selectOptionListHtml("x<?php echo $tbl_order_po_inv_list->RowIndex ?>_IdType") ?>
	</select>
</div>
<?php echo $tbl_order_po_inv->IdType->Lookup->getParamTag("p_x" . $tbl_order_po_inv_list->RowIndex . "_IdType") ?>
</span>
<input type="hidden" data-table="tbl_order_po_inv" data-field="x_IdType" name="o<?php echo $tbl_order_po_inv_list->RowIndex ?>_IdType" id="o<?php echo $tbl_order_po_inv_list->RowIndex ?>_IdType" value="<?php echo HtmlEncode($tbl_order_po_inv->IdType->OldValue) ?>">
<?php } ?>
<?php if ($tbl_order_po_inv->RowType == ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $tbl_order_po_inv_list->RowCnt ?>_tbl_order_po_inv_IdType" class="form-group tbl_order_po_inv_IdType">
<div class="input-group">
...
<?php } ?>
<?php if ($tbl_order_po_inv->RowType == ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $tbl_order_po_inv_list->RowCnt ?>_tbl_order_po_inv_IdType" class="tbl_order_po_inv_IdType">
<span<?php echo $tbl_order_po_inv->IdType->viewAttributes() ?>>
<?php echo $tbl_order_po_inv->IdType->getViewValue() ?></span>
</span>
<?php } ?>
</td>
	<?php } ?>
...
<input type="hidden" data-table="tbl_order_po_inv" data-field="x_Code" name="o<?php echo $tbl_order_po_inv_list->RowIndex ?>_Code" id="o<?php echo $tbl_order_po_inv_list->RowIndex ?>_Code" value="<?php echo HtmlEncode($tbl_order_po_inv->Code->OldValue) ?>">
	...
	<?php if ($tbl_order_po_inv->IdType->Visible) { // IdType ?>
		<td data-name="IdType">
<span id="el$rowindex$_tbl_order_po_inv_IdType" class="form-group tbl_order_po_inv_IdType">
<div class="input-group">
	<select class="custom-select ew-custom-select" data-table="tbl_order_po_inv" data-field="x_IdType" data-value-separator="<?php echo $tbl_order_po_inv->IdType->displayValueSeparatorAttribute() ?>" id="x<?php echo $tbl_order_po_inv_list->RowIndex ?>_IdType" name="x<?php echo $tbl_order_po_inv_list->RowIndex ?>_IdType"<?php echo $tbl_order_po_inv->IdType->editAttributes() ?>>
		<?php echo $tbl_order_po_inv->IdType->selectOptionListHtml("x<?php echo $tbl_order_po_inv_list->RowIndex ?>_IdType") ?>
	</select>
