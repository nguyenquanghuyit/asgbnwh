...
// Create page object
$tbl_pallet_add = new tbl_pallet_add();
...
var ftbl_palletadd = currentForm = new ew.Form("ftbl_palletadd", "add");

// Validate form
ftbl_palletadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($tbl_pallet_add->ID_Route->Required) { ?>
		...
		<?php } ?>
		<?php if ($tbl_pallet_add->PalletID->Required) { ?>
		...
		<?php } ?>
		<?php if ($tbl_pallet_add->Code->Required) { ?>
		...
		<?php } ?>
		<?php if ($tbl_pallet_add->Id_Type->Required) { ?>
		...
		<?php } ?>
		<?php if ($tbl_pallet_add->PCS->Required) { ?>
		...
		<?php if ($tbl_pallet_add->ExistStatus->Required) { ?>
		...
		<?php } ?>
		<?php if ($tbl_pallet_add->CreateUser->Required) { ?>
		...
		<?php } ?>
		<?php if ($tbl_pallet_add->CreateDate->Required) { ?>
		...
		<?php } ?>
		<?php if ($tbl_pallet_add->PenddingStatus->Required) { ?>
		...
		<?php } ?>
		<?php if ($tbl_pallet_add->UserFinishPendding->Required) { ?>
		...
		<?php } ?>
		<?php if ($tbl_pallet_add->DateTimeFinishPedding->Required) { ?>
...
ftbl_palletadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
ftbl_palletadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
ftbl_palletadd.lists["x_ID_Route"] = <?php echo $tbl_pallet_add->ID_Route->Lookup->toClientList() ?>;
ftbl_palletadd.lists["x_ID_Route"].options = <?php echo JsonEncode($tbl_pallet_add->ID_Route->lookupOptions()) ?>;
ftbl_palletadd.lists["x_Id_Type"] = <?php echo $tbl_pallet_add->Id_Type->Lookup->toClientList() ?>;
ftbl_palletadd.lists["x_Id_Type"].options = <?php echo JsonEncode($tbl_pallet_add->Id_Type->lookupOptions()) ?>;
ftbl_palletadd.lists["x_ExistStatus"] = <?php echo $tbl_pallet_add->ExistStatus->Lookup->toClientList() ?>;
ftbl_palletadd.lists["x_ExistStatus"].options = <?php echo JsonEncode($tbl_pallet_add->ExistStatus->options(FALSE, TRUE)) ?>;
ftbl_palletadd.lists["x_PenddingStatus"] = <?php echo $tbl_pallet_add->PenddingStatus->Lookup->toClientList() ?>;
ftbl_palletadd.lists["x_PenddingStatus"].options = <?php echo JsonEncode($tbl_pallet_add->PenddingStatus->options(FALSE, TRUE)) ?>;
...
<?php $tbl_pallet_add->showPageHeader(); ?>
<?php
$tbl_pallet_add->showMessage();
?>
<form name="ftbl_palletadd" id="ftbl_palletadd" class="<?php echo $tbl_pallet_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($tbl_pallet_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $tbl_pallet_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="tbl_pallet">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$tbl_pallet_add->IsModal ?>">
<div class="ew-add-div"><!-- page* -->
<?php if ($tbl_pallet->ID_Route->Visible) { // ID_Route ?>
	<div id="r_ID_Route" class="form-group row">
		<label id="elh_tbl_pallet_ID_Route" for="x_ID_Route" class="<?php echo $tbl_pallet_add->LeftColumnClass ?>"><?php echo $tbl_pallet->ID_Route->caption() ?><?php echo ($tbl_pallet->ID_Route->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tbl_pallet_add->RightColumnClass ?>"><div<?php echo $tbl_pallet->ID_Route->cellAttributes() ?>>
...
<?php if ($tbl_pallet->PalletID->Visible) { // PalletID ?>
	<div id="r_PalletID" class="form-group row">
		<label id="elh_tbl_pallet_PalletID" for="x_PalletID" class="<?php echo $tbl_pallet_add->LeftColumnClass ?>"><?php echo $tbl_pallet->PalletID->caption() ?><?php echo ($tbl_pallet->PalletID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tbl_pallet_add->RightColumnClass ?>"><div<?php echo $tbl_pallet->PalletID->cellAttributes() ?>>
...
<?php if ($tbl_pallet->Code->Visible) { // Code ?>
	<div id="r_Code" class="form-group row">
		<label id="elh_tbl_pallet_Code" for="x_Code" class="<?php echo $tbl_pallet_add->LeftColumnClass ?>"><?php echo $tbl_pallet->Code->caption() ?><?php echo ($tbl_pallet->Code->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tbl_pallet_add->RightColumnClass ?>"><div<?php echo $tbl_pallet->Code->cellAttributes() ?>>
...
<?php if ($tbl_pallet->Id_Type->Visible) { // Id_Type ?>
	<div id="r_Id_Type" class="form-group row">
		<label id="elh_tbl_pallet_Id_Type" for="x_Id_Type" class="<?php echo $tbl_pallet_add->LeftColumnClass ?>"><?php echo $tbl_pallet->Id_Type->caption() ?><?php echo ($tbl_pallet->Id_Type->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tbl_pallet_add->RightColumnClass ?>"><div<?php echo $tbl_pallet->Id_Type->cellAttributes() ?>>
...
<?php if ($tbl_pallet->PCS->Visible) { // PCS ?>
	<div id="r_PCS" class="form-group row">
		<label id="elh_tbl_pallet_PCS" for="x_PCS" class="<?php echo $tbl_pallet_add->LeftColumnClass ?>"><?php echo $tbl_pallet->PCS->caption() ?><?php echo ($tbl_pallet->PCS->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tbl_pallet_add->RightColumnClass ?>"><div<?php echo $tbl_pallet->PCS->cellAttributes() ?>>
...
<?php if ($tbl_pallet->ExistStatus->Visible) { // ExistStatus ?>
	<div id="r_ExistStatus" class="form-group row">
		<label id="elh_tbl_pallet_ExistStatus" for="x_ExistStatus" class="<?php echo $tbl_pallet_add->LeftColumnClass ?>"><?php echo $tbl_pallet->ExistStatus->caption() ?><?php echo ($tbl_pallet->ExistStatus->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tbl_pallet_add->RightColumnClass ?>"><div<?php echo $tbl_pallet->ExistStatus->cellAttributes() ?>>
...
<?php if ($tbl_pallet->PenddingStatus->Visible) { // PenddingStatus ?>
	<div id="r_PenddingStatus" class="form-group row">
		<label id="elh_tbl_pallet_PenddingStatus" for="x_PenddingStatus" class="<?php echo $tbl_pallet_add->LeftColumnClass ?>"><?php echo $tbl_pallet->PenddingStatus->caption() ?><?php echo ($tbl_pallet->PenddingStatus->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tbl_pallet_add->RightColumnClass ?>"><div<?php echo $tbl_pallet->PenddingStatus->cellAttributes() ?>>
...
<?php if (!$tbl_pallet_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $tbl_pallet_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $tbl_pallet_add->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$tbl_pallet_add->showPageFooter();
if (DEBUG_ENABLED)
