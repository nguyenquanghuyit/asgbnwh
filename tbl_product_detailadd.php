...
// Create page object
$tbl_product_detail_add = new tbl_product_detail_add();

// Run the page
$tbl_product_detail_add->run();
...
$tbl_product_detail_add->Page_Render();
?>
...
var ftbl_product_detailadd = currentForm = new ew.Form("ftbl_product_detailadd", "add");

// Validate form
ftbl_product_detailadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($tbl_product_detail_add->CODE->Required) { ?>
		...
		<?php } ?>
		<?php if ($tbl_product_detail_add->PackingQty->Required) { ?>
		...
		<?php if ($tbl_product_detail_add->IdUnit->Required) { ?>
		...
		<?php } ?>
		<?php if ($tbl_product_detail_add->DefaultCode->Required) { ?>
...
ftbl_product_detailadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
ftbl_product_detailadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
ftbl_product_detailadd.lists["x_IdUnit"] = <?php echo $tbl_product_detail_add->IdUnit->Lookup->toClientList() ?>;
ftbl_product_detailadd.lists["x_IdUnit"].options = <?php echo JsonEncode($tbl_product_detail_add->IdUnit->lookupOptions()) ?>;
ftbl_product_detailadd.lists["x_DefaultCode"] = <?php echo $tbl_product_detail_add->DefaultCode->Lookup->toClientList() ?>;
ftbl_product_detailadd.lists["x_DefaultCode"].options = <?php echo JsonEncode($tbl_product_detail_add->DefaultCode->options(FALSE, TRUE)) ?>;
...
<?php $tbl_product_detail_add->showPageHeader(); ?>
<?php
$tbl_product_detail_add->showMessage();
?>
<form name="ftbl_product_detailadd" id="ftbl_product_detailadd" class="<?php echo $tbl_product_detail_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($tbl_product_detail_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $tbl_product_detail_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="tbl_product_detail">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$tbl_product_detail_add->IsModal ?>">
...
<?php if ($tbl_product_detail->CODE->Visible) { // CODE ?>
	<div id="r_CODE" class="form-group row">
		<label id="elh_tbl_product_detail_CODE" for="x_CODE" class="<?php echo $tbl_product_detail_add->LeftColumnClass ?>"><?php echo $tbl_product_detail->CODE->caption() ?><?php echo ($tbl_product_detail->CODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tbl_product_detail_add->RightColumnClass ?>"><div<?php echo $tbl_product_detail->CODE->cellAttributes() ?>>
...
<?php if ($tbl_product_detail->PackingQty->Visible) { // PackingQty ?>
	<div id="r_PackingQty" class="form-group row">
		<label id="elh_tbl_product_detail_PackingQty" for="x_PackingQty" class="<?php echo $tbl_product_detail_add->LeftColumnClass ?>"><?php echo $tbl_product_detail->PackingQty->caption() ?><?php echo ($tbl_product_detail->PackingQty->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tbl_product_detail_add->RightColumnClass ?>"><div<?php echo $tbl_product_detail->PackingQty->cellAttributes() ?>>
...
<?php if ($tbl_product_detail->IdUnit->Visible) { // IdUnit ?>
	<div id="r_IdUnit" class="form-group row">
		<label id="elh_tbl_product_detail_IdUnit" for="x_IdUnit" class="<?php echo $tbl_product_detail_add->LeftColumnClass ?>"><?php echo $tbl_product_detail->IdUnit->caption() ?><?php echo ($tbl_product_detail->IdUnit->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tbl_product_detail_add->RightColumnClass ?>"><div<?php echo $tbl_product_detail->IdUnit->cellAttributes() ?>>
...
<?php if ($tbl_product_detail->DefaultCode->Visible) { // DefaultCode ?>
	<div id="r_DefaultCode" class="form-group row">
		<label id="elh_tbl_product_detail_DefaultCode" class="<?php echo $tbl_product_detail_add->LeftColumnClass ?>"><?php echo $tbl_product_detail->DefaultCode->caption() ?><?php echo ($tbl_product_detail->DefaultCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tbl_product_detail_add->RightColumnClass ?>"><div<?php echo $tbl_product_detail->DefaultCode->cellAttributes() ?>>
...
<?php if (!$tbl_product_detail_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $tbl_product_detail_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $tbl_product_detail_add->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$tbl_product_detail_add->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$tbl_product_detail_add->terminate();
?>