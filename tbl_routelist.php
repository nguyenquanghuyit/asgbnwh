...
<?php if ($tbl_route->LoadingID->Visible) { // LoadingID ?>
	<?php if ($tbl_route->sortUrl($tbl_route->LoadingID) == "") { ?>
		<th data-name="LoadingID" class="<?php echo $tbl_route->LoadingID->headerCellClass() ?>"><div id="elh_tbl_route_LoadingID" class="tbl_route_LoadingID"><div class="ew-table-header-caption"><?php echo $tbl_route->LoadingID->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="LoadingID" class="<?php echo $tbl_route->LoadingID->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event,'<?php echo $tbl_route->SortUrl($tbl_route->LoadingID) ?>',2);"><div id="elh_tbl_route_LoadingID" class="tbl_route_LoadingID">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $tbl_route->LoadingID->caption() ?><?php echo $Language->phrase("SrchLegend") ?></span><span class="ew-table-header-sort"><?php if ($tbl_route->LoadingID->getSort() == "ASC") { ?><i class="fa fa-sort-up"></i><?php } elseif ($tbl_route->LoadingID->getSort() == "DESC") { ?><i class="fa fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($tbl_route->Id_Type->Visible) { // Id_Type ?>
	<?php if ($tbl_route->sortUrl($tbl_route->Id_Type) == "") { ?>
		<th data-name="Id_Type" class="<?php echo $tbl_route->Id_Type->headerCellClass() ?>"><div id="elh_tbl_route_Id_Type" class="tbl_route_Id_Type"><div class="ew-table-header-caption"><?php echo $tbl_route->Id_Type->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="Id_Type" class="<?php echo $tbl_route->Id_Type->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event,'<?php echo $tbl_route->SortUrl($tbl_route->Id_Type) ?>',2);"><div id="elh_tbl_route_Id_Type" class="tbl_route_Id_Type">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $tbl_route->Id_Type->caption() ?><?php echo $Language->phrase("SrchLegend") ?></span><span class="ew-table-header-sort"><?php if ($tbl_route->Id_Type->getSort() == "ASC") { ?><i class="fa fa-sort-up"></i><?php } elseif ($tbl_route->Id_Type->getSort() == "DESC") { ?><i class="fa fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
<?php echo GetFileViewTag($tbl_route->AttachFile, $tbl_route->AttachFile->getViewValue()) ?>
	...
	<?php } ?>
	<?php if ($tbl_route->LoadingID->Visible) { // LoadingID ?>
		<td data-name="LoadingID"<?php echo $tbl_route->LoadingID->cellAttributes() ?>>
<span id="el<?php echo $tbl_route_list->RowCnt ?>_tbl_route_LoadingID" class="tbl_route_LoadingID">
...
<?php echo $tbl_route->LoadingID->getViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($tbl_route->Id_Type->Visible) { // Id_Type ?>
		<td data-name="Id_Type"<?php echo $tbl_route->Id_Type->cellAttributes() ?>>
<span id="el<?php echo $tbl_route_list->RowCnt ?>_tbl_route_Id_Type" class="tbl_route_Id_Type">
