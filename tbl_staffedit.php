...
// Create page object
$tbl_staff_edit = new tbl_staff_edit();
...
var ftbl_staffedit = currentForm = new ew.Form("ftbl_staffedit", "edit");

// Validate form
ftbl_staffedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($tbl_staff_edit->Ma_NV->Required) { ?>
		...
		<?php } ?>
		<?php if ($tbl_staff_edit->hoVaTen->Required) { ?>
		...
		<?php } ?>
		<?php if ($tbl_staff_edit->gioiTinh->Required) { ?>
		...
		<?php } ?>
		<?php if ($tbl_staff_edit->ngaySinh->Required) { ?>
		...
		<?php if ($tbl_staff_edit->emailCaNhan->Required) { ?>
		...
		<?php } ?>
		<?php if ($tbl_staff_edit->CD_ID->Required) { ?>
		...
		<?php if ($tbl_staff_edit->TD_ID->Required) { ?>
		...
		<?php if ($tbl_staff_edit->PB_ID->Required) { ?>
...
ftbl_staffedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
ftbl_staffedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $tbl_staff_edit->showPageHeader(); ?>
<?php
$tbl_staff_edit->showMessage();
?>
<form name="ftbl_staffedit" id="ftbl_staffedit" class="<?php echo $tbl_staff_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($tbl_staff_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $tbl_staff_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="tbl_staff">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$tbl_staff_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($tbl_staff->Ma_NV->Visible) { // Ma_NV ?>
	<div id="r_Ma_NV" class="form-group row">
		<label id="elh_tbl_staff_Ma_NV" for="x_Ma_NV" class="<?php echo $tbl_staff_edit->LeftColumnClass ?>"><?php echo $tbl_staff->Ma_NV->caption() ?><?php echo ($tbl_staff->Ma_NV->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tbl_staff_edit->RightColumnClass ?>"><div<?php echo $tbl_staff->Ma_NV->cellAttributes() ?>>
<span id="el_tbl_staff_Ma_NV">
<span<?php echo $tbl_staff->Ma_NV->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($tbl_staff->Ma_NV->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="tbl_staff" data-field="x_Ma_NV" name="x_Ma_NV" id="x_Ma_NV" value="<?php echo HtmlEncode($tbl_staff->Ma_NV->CurrentValue) ?>">
<?php echo $tbl_staff->Ma_NV->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($tbl_staff->hoVaTen->Visible) { // hoVaTen ?>
	<div id="r_hoVaTen" class="form-group row">
		<label id="elh_tbl_staff_hoVaTen" for="x_hoVaTen" class="<?php echo $tbl_staff_edit->LeftColumnClass ?>"><?php echo $tbl_staff->hoVaTen->caption() ?><?php echo ($tbl_staff->hoVaTen->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tbl_staff_edit->RightColumnClass ?>"><div<?php echo $tbl_staff->hoVaTen->cellAttributes() ?>>
...
<?php if ($tbl_staff->gioiTinh->Visible) { // gioiTinh ?>
	<div id="r_gioiTinh" class="form-group row">
		<label id="elh_tbl_staff_gioiTinh" for="x_gioiTinh" class="<?php echo $tbl_staff_edit->LeftColumnClass ?>"><?php echo $tbl_staff->gioiTinh->caption() ?><?php echo ($tbl_staff->gioiTinh->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tbl_staff_edit->RightColumnClass ?>"><div<?php echo $tbl_staff->gioiTinh->cellAttributes() ?>>
...
<?php if ($tbl_staff->ngaySinh->Visible) { // ngaySinh ?>
	<div id="r_ngaySinh" class="form-group row">
		<label id="elh_tbl_staff_ngaySinh" for="x_ngaySinh" class="<?php echo $tbl_staff_edit->LeftColumnClass ?>"><?php echo $tbl_staff->ngaySinh->caption() ?><?php echo ($tbl_staff->ngaySinh->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tbl_staff_edit->RightColumnClass ?>"><div<?php echo $tbl_staff->ngaySinh->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("ftbl_staffedit", "x_ngaySinh", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($tbl_staff->emailCaNhan->Visible) { // emailCaNhan ?>
	<div id="r_emailCaNhan" class="form-group row">
		<label id="elh_tbl_staff_emailCaNhan" for="x_emailCaNhan" class="<?php echo $tbl_staff_edit->LeftColumnClass ?>"><?php echo $tbl_staff->emailCaNhan->caption() ?><?php echo ($tbl_staff->emailCaNhan->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tbl_staff_edit->RightColumnClass ?>"><div<?php echo $tbl_staff->emailCaNhan->cellAttributes() ?>>
...
<?php if ($tbl_staff->CD_ID->Visible) { // CD_ID ?>
	<div id="r_CD_ID" class="form-group row">
		<label id="elh_tbl_staff_CD_ID" for="x_CD_ID" class="<?php echo $tbl_staff_edit->LeftColumnClass ?>"><?php echo $tbl_staff->CD_ID->caption() ?><?php echo ($tbl_staff->CD_ID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tbl_staff_edit->RightColumnClass ?>"><div<?php echo $tbl_staff->CD_ID->cellAttributes() ?>>
...
<?php if ($tbl_staff->TD_ID->Visible) { // TD_ID ?>
	<div id="r_TD_ID" class="form-group row">
		<label id="elh_tbl_staff_TD_ID" for="x_TD_ID" class="<?php echo $tbl_staff_edit->LeftColumnClass ?>"><?php echo $tbl_staff->TD_ID->caption() ?><?php echo ($tbl_staff->TD_ID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tbl_staff_edit->RightColumnClass ?>"><div<?php echo $tbl_staff->TD_ID->cellAttributes() ?>>
...
<?php if ($tbl_staff->PB_ID->Visible) { // PB_ID ?>
	<div id="r_PB_ID" class="form-group row">
		<label id="elh_tbl_staff_PB_ID" for="x_PB_ID" class="<?php echo $tbl_staff_edit->LeftColumnClass ?>"><?php echo $tbl_staff->PB_ID->caption() ?><?php echo ($tbl_staff->PB_ID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tbl_staff_edit->RightColumnClass ?>"><div<?php echo $tbl_staff->PB_ID->cellAttributes() ?>>
...
<?php if (!$tbl_staff_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $tbl_staff_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $tbl_staff_edit->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$tbl_staff_edit->showPageFooter();
if (DEBUG_ENABLED)
