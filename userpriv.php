...
<div class="card-header">
	<h3 class="card-title"><?php echo $Language->Phrase("UserLevel") ?><?php echo $Security->getUserLevelName($userlevels->userlevelid->CurrentValue) ?> (<?php echo $userlevels->userlevelid->CurrentValue ?>)</h3>
