...
// Create page object
$vwrouteout_edit = new vwrouteout_edit();
...
var fvwrouteoutedit = currentForm = new ew.Form("fvwrouteoutedit", "edit");

// Validate form
fvwrouteoutedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($vwrouteout_edit->RouteName->Required) { ?>
		...
		<?php } ?>
		<?php if ($vwrouteout_edit->TruckNo->Required) { ?>
		...
		<?php } ?>
		<?php if ($vwrouteout_edit->DriverName->Required) { ?>
		...
		<?php } ?>
		<?php if ($vwrouteout_edit->DriverMobile->Required) { ?>
		...
		<?php } ?>
		<?php if ($vwrouteout_edit->InvoiceNo->Required) { ?>
		...
		<?php } ?>
		<?php if ($vwrouteout_edit->InvoiceDate->Required) { ?>
		...
		<?php if ($vwrouteout_edit->CreateUser->Required) { ?>
		...
		<?php } ?>
		<?php if ($vwrouteout_edit->CreateDate->Required) { ?>
		...
		<?php if ($vwrouteout_edit->SealNo->Required) { ?>
...
fvwrouteoutedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fvwrouteoutedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fvwrouteoutedit.lists["x_RouteName"] = <?php echo $vwrouteout_edit->RouteName->Lookup->toClientList() ?>;
fvwrouteoutedit.lists["x_RouteName"].options = <?php echo JsonEncode($vwrouteout_edit->RouteName->options(FALSE, TRUE)) ?>;
...
<?php $vwrouteout_edit->showPageHeader(); ?>
<?php
$vwrouteout_edit->showMessage();
?>
<form name="fvwrouteoutedit" id="fvwrouteoutedit" class="<?php echo $vwrouteout_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($vwrouteout_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $vwrouteout_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="vwrouteout">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$vwrouteout_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($vwrouteout->RouteName->Visible) { // RouteName ?>
	<div id="r_RouteName" class="form-group row">
		<label id="elh_vwrouteout_RouteName" for="x_RouteName" class="<?php echo $vwrouteout_edit->LeftColumnClass ?>"><?php echo $vwrouteout->RouteName->caption() ?><?php echo ($vwrouteout->RouteName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $vwrouteout_edit->RightColumnClass ?>"><div<?php echo $vwrouteout->RouteName->cellAttributes() ?>>
...
<?php if ($vwrouteout->TruckNo->Visible) { // TruckNo ?>
	<div id="r_TruckNo" class="form-group row">
		<label id="elh_vwrouteout_TruckNo" for="x_TruckNo" class="<?php echo $vwrouteout_edit->LeftColumnClass ?>"><?php echo $vwrouteout->TruckNo->caption() ?><?php echo ($vwrouteout->TruckNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $vwrouteout_edit->RightColumnClass ?>"><div<?php echo $vwrouteout->TruckNo->cellAttributes() ?>>
...
<?php if ($vwrouteout->DriverName->Visible) { // DriverName ?>
	<div id="r_DriverName" class="form-group row">
		<label id="elh_vwrouteout_DriverName" for="x_DriverName" class="<?php echo $vwrouteout_edit->LeftColumnClass ?>"><?php echo $vwrouteout->DriverName->caption() ?><?php echo ($vwrouteout->DriverName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $vwrouteout_edit->RightColumnClass ?>"><div<?php echo $vwrouteout->DriverName->cellAttributes() ?>>
...
<?php if ($vwrouteout->DriverMobile->Visible) { // DriverMobile ?>
	<div id="r_DriverMobile" class="form-group row">
		<label id="elh_vwrouteout_DriverMobile" for="x_DriverMobile" class="<?php echo $vwrouteout_edit->LeftColumnClass ?>"><?php echo $vwrouteout->DriverMobile->caption() ?><?php echo ($vwrouteout->DriverMobile->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $vwrouteout_edit->RightColumnClass ?>"><div<?php echo $vwrouteout->DriverMobile->cellAttributes() ?>>
...
<?php if ($vwrouteout->InvoiceNo->Visible) { // InvoiceNo ?>
	<div id="r_InvoiceNo" class="form-group row">
		<label id="elh_vwrouteout_InvoiceNo" for="x_InvoiceNo" class="<?php echo $vwrouteout_edit->LeftColumnClass ?>"><?php echo $vwrouteout->InvoiceNo->caption() ?><?php echo ($vwrouteout->InvoiceNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $vwrouteout_edit->RightColumnClass ?>"><div<?php echo $vwrouteout->InvoiceNo->cellAttributes() ?>>
...
<?php if ($vwrouteout->InvoiceDate->Visible) { // InvoiceDate ?>
	<div id="r_InvoiceDate" class="form-group row">
		<label id="elh_vwrouteout_InvoiceDate" for="x_InvoiceDate" class="<?php echo $vwrouteout_edit->LeftColumnClass ?>"><?php echo $vwrouteout->InvoiceDate->caption() ?><?php echo ($vwrouteout->InvoiceDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $vwrouteout_edit->RightColumnClass ?>"><div<?php echo $vwrouteout->InvoiceDate->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fvwrouteoutedit", "x_InvoiceDate", {"ignoreReadonly":true,"useCurrent":false,"format":7});
</script>
<?php } ?>
</span>
...
<?php if ($vwrouteout->CreateUser->Visible) { // CreateUser ?>
	<div id="r_CreateUser" class="form-group row">
		<label id="elh_vwrouteout_CreateUser" for="x_CreateUser" class="<?php echo $vwrouteout_edit->LeftColumnClass ?>"><?php echo $vwrouteout->CreateUser->caption() ?><?php echo ($vwrouteout->CreateUser->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $vwrouteout_edit->RightColumnClass ?>"><div<?php echo $vwrouteout->CreateUser->cellAttributes() ?>>
...
<?php if ($vwrouteout->CreateDate->Visible) { // CreateDate ?>
	<div id="r_CreateDate" class="form-group row">
		<label id="elh_vwrouteout_CreateDate" for="x_CreateDate" class="<?php echo $vwrouteout_edit->LeftColumnClass ?>"><?php echo $vwrouteout->CreateDate->caption() ?><?php echo ($vwrouteout->CreateDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $vwrouteout_edit->RightColumnClass ?>"><div<?php echo $vwrouteout->CreateDate->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fvwrouteoutedit", "x_CreateDate", {"ignoreReadonly":true,"useCurrent":false,"format":11});
</script>
<?php } ?>
</span>
...
<?php if ($vwrouteout->SealNo->Visible) { // SealNo ?>
	<div id="r_SealNo" class="form-group row">
		<label id="elh_vwrouteout_SealNo" for="x_SealNo" class="<?php echo $vwrouteout_edit->LeftColumnClass ?>"><?php echo $vwrouteout->SealNo->caption() ?><?php echo ($vwrouteout->SealNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $vwrouteout_edit->RightColumnClass ?>"><div<?php echo $vwrouteout->SealNo->cellAttributes() ?>>
...
<?php } ?>
	...
	<input type="hidden" data-table="vwrouteout" data-field="x_ID_Route" name="x_ID_Route" id="x_ID_Route" value="<?php echo HtmlEncode($vwrouteout->ID_Route->CurrentValue) ?>">
<?php
	if (in_array("tbl_loading", explode(",", $vwrouteout->getCurrentDetailTable())) && $tbl_loading->DetailEdit) {
?>
...
<?php } ?>
<?php if (!$vwrouteout_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $vwrouteout_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $vwrouteout_edit->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$vwrouteout_edit->showPageFooter();
if (DEBUG_ENABLED)
